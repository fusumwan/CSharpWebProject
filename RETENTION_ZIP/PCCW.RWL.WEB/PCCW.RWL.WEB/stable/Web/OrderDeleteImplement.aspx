<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderDeleteImplement.aspx.cs" Inherits="OrderDeleteImplement" %>
...
<body>
    ...
    <div>
              ...
              <tr> 
                <td width="75%" height="235" class="row2" align="center"> <span class="gensmall"><asp:Literal ID="viewid" runat="server"></asp:Literal> Deleted!</span> 
                  <br />
