<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RebateGPViewImplement.aspx.cs" Inherits="RebateGPViewImplement" %>
...
function chk_del(id) {
	if(confirm("Are you sure you want to Delete?")==false){
		...
		document.location.href='rwl_rebate_gp_delC.aspx?id='+id;
	}
}
...
<body style="background-color:#ffffff">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr> 
                ...
                <td width="8%" class="row1"><span class="explaintitle" style="font-size:7pt">Rebate 
                  Group </span></td>
              ...
              <tr> 
                  ...
                  <td width="8%" nowrap="nowrap" class="row2"><asp:TextBox ID="txtREBATE_GROUP_ADD" 
                          runat="server" Text='' MaxLength="50" Width="150px" Font-Size="7pt"></asp:TextBox></td>
                 <td width="8%" nowrap="nowrap" class="row2" >
                  <asp:DropDownList ID="drpPROGRAM_ADD" runat="server"  Font-Size="7pt" >
                  </asp:DropDownList>
                  </td>
...
<EW:RepeaterEx ID="RWL_REBATE_RP" runat="Server" onitemcommand="RWL_REBATE_RP_ItemCommand" onitemdatabound="RWL_REBATE_RP_ItemDataBound"  >
<ItemTemplate>
<tr>
<td width="3%" nowrap="nowrap" class="row2"><asp:Label ID="RebateNum" runat="server"></asp:Label><asp:Label ID="txtmid" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "mid")%>' Visible="false"></asp:Label></td>
<td width="8%" nowrap="nowrap" class="row2" align="center">
<asp:DropDownList ID="drpREBATE_GP" runat="server"  Font-Size="7pt"  DataTextField="gp" DataValueField="gp" >
</asp:DropDownList><asp:Label ID="txtREBATE_GP" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "gp") %>'  runat="server" Visible="false"></asp:Label></td>
<td width="8%" nowrap="nowrap" class="row2" align="center">
<asp:DropDownList ID="drpREBATE_PROGRAM" runat="server"  Font-Size="7pt" DataTextField="program" DataValueField="program"  >
</asp:DropDownList><asp:Label ID="txtREBATE_PROGRAM" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "program") %>'  runat="server" Visible="false" ></asp:Label></td>
