<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckWebLogAORecord.aspx.cs" Inherits="Web_IMEIManagement_CheckWebLogAORecord" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr>
					...
					<td height="10" class="row2" align="center"><span class="explaintitle" style="font-size:8pt">Search web log ao record by record id number</span></td>
					<td height="10" class="row2">&nbsp;</td>
		      </tr>
		      
              <tr>
				<td height="10" class="row1" align="center"><span class="explaintitle">SEARCH WEB AO RECORD:</span></td>
	 					 ...
	 					 <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
							...
							<tr>
							    <td height="10" width="25%" class="row1" align="center"><span class="explaintitle">
                                    <asp:Button ID="but_InsertAoCase" runat="server" Text="Insert Ao Case" 
                                        Enabled="false" CssClass="button" onclick="but_InsertAoCase_Click" /></span></td>
