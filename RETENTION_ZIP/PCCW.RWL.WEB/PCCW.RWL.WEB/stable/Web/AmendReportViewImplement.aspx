<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AmendReportViewImplement.aspx.cs" Inherits="AmendReportViewImplement" %>
...
<body>
    ...
    <div>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
                ...
                <tr> 
                  <td height="23" colspan="101" class="row2"> <p> 
                ...
                <tr> 
                  ...
                  <td class="row1"><span class="explaintitle" style="font-size:7pt">Amend Order Date <br />(MM/DD/YYYY HH:MM)</span></td>
                  <td class="row1"><span class="explaintitle" style="font-size:7pt">Re-Send ID<br /></span></td>
                  ...
                  <td class="row1"><span class="explaintitle" style="font-size:7pt">Retrieved Date (MM/DD/YYYY HH:MM)</span></td>
                  <td class="row1"><span class="explaintitle" style="font-size:7pt">Last Updated By</span></td>
                  <td class="row1"><span class="explaintitle" style="font-size:7pt">Last Update Date (MM/DD/YYYY HH:MM)</span></td>
