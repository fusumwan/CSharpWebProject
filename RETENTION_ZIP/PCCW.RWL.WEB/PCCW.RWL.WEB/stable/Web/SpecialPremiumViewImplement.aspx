<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecialPremiumViewImplement.aspx.cs" Inherits="SpecialPremiumViewImplement" %>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr> 
                <td height="40" colspan="26" class="row2"> <span class="gensmall"> 
				  ...
				  <asp:Button ID="reactive" Text="RE-ACTIVE PAGE" runat="server" CssClass="button" PostBackUrl="~/Web/SpecialPremiumReactiveImplement.aspx" />
				  <asp:Button ID="importexcel" Text="IMPORT SPECIAL-PREMIUM" runat="server" CssClass="button" PostBackUrl="~/Web/SpecialPremiumImportAction.aspx"/>
                </td>
              </tr>
              <tr> 
              ...
              <tr> 
                 ...
                 <td width="8%" nowrap="nowrap" class="row2" >
                  <asp:DropDownList ID="drpRATE_PLAN_ADD" runat="server"  Font-Size="7pt" Width="150" >
                  </asp:DropDownList>
                  </td>
                 <td width="8%" nowrap="nowrap" class="row2" >
                  <asp:DropDownList ID="drpCON_PER_ADD" runat="server"  Font-Size="7pt" Width="150" >
                  </asp:DropDownList>
                  </td>
                  <td width="8%" nowrap="nowrap" class="row2">
                  <asp:TextBox ID="txts_premium_ADD" runat="server" Text='' MaxLength="60" Width="200px" Font-Size="7pt"></asp:TextBox>
                  </td>
...
<asp:DropDownList ID="drps_premium_RATE_PLAN" runat="server"  Font-Size="7pt" Width="150" DataTextField="rate_plan" DataValueField="rate_plan">
...
<td width="8%" nowrap="nowrap" class="row2" align="center">
<asp:DropDownList ID="drps_premium_CON_PER" runat="server"  Font-Size="7pt" Width="150" DataTextField="con_per" DataValueField="con_per"   >
...
<td width="8%" nowrap="nowrap" class="row2" align="left"><asp:TextBox ID="txtSpecialPremium" Text='<%# DataBinder.Eval(Container.DataItem, "s_premium")%>' runat="server" Visible="true" Width="200" MaxLength="60"></asp:TextBox></td>
<td width="8%" nowrap="nowrap" class="row2" align="center"><asp:Button ID="SpecialPremiumbtn" runat="server" Text="Modify" CommandArgument="Modify" CssClass="button" CommandName="Modify" OnClientClick="return confirm('Are you sure you want to Save?');" /></td>
<td width="8%" nowrap="nowrap" class="row2" align="center"><asp:LinkButton ID="SpecialPremiumlink" CommandName="Delete" CommandArgument="Delete" runat="server" Text="x" OnClientClick="return confirm('Are you sure you want to Delete?');"></asp:LinkButton></td>
<td width="5%" nowrap="nowrap" class="row2" align="center"><span class="gensmall"></span></td>
</tr>
</ItemTemplate>
</EW:RepeaterEx>
