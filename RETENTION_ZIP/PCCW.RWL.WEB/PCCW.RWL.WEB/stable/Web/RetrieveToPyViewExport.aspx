<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetrieveToPyViewExport.aspx.cs" Inherits="Web_RetrieveToPyViewExport" %>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr>
                ...
                <td class="row1">Sent Date<br />(MM/DD/YYYY)</td>
                <td class="row1">Report Name</td>
                <td class="row1">Log Date<br />(MM/DD/YY HH:MM)</td>
                ...
                <td class="row1">Last Update Date<br />(MM/DD/YY HH:MM)</td>
