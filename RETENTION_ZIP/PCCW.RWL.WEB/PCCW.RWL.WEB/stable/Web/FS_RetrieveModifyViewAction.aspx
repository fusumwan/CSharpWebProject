<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FS_RetrieveModifyViewAction.aspx.cs" Inherits="RetrieveModifyViewAction" %>
...
if(RetrieveId==undefined) return false;
	...
	if(event.returnValue!=false){
		if(confirm("Are you sure ?")==false){
			...
			//myWindow=window.open('RetrieveModifyViewExport.aspx' ,'popup', 'toolbar=no, status=no, resizable=no, width=180, height=110, scrollbars=no, menu=no');
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr>
                ...
                <input name="submit22" type="button" class="button" value="BACK" onClick="history.go(-1);" style="font-size:7pt" />
                          ...
                          <asp:Button ID="submit2" Text="Export Selected to Excel" class="mainoption" style="font-size:7pt" OnClientClick="chk_save(this.form);" runat="server" PostBackUrl="~/Web/FS_RetrieveModifyViewExport.aspx" />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="row1"><span class="explaintitle" style="font-size:7pt">Retrieved Date<br />(MM/DD/YYYY HH:MM)</span></td>
                <td class="row1"><span class="explaintitle" style="font-size:7pt">Last Updated By</span></td>
                <td class="row1"><span class="explaintitle" style="font-size:7pt">Last Update Date<br />(MM/DD/YYYY HH:MM)</span></td>
