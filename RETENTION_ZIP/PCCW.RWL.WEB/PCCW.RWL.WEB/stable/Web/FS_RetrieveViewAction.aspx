<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FS_RetrieveViewAction.aspx.cs" Inherits="RetrieveViewAction" %>
...
if(RetrieveId==undefined) return false;
	...
	if(event.returnValue!=false){
		if(confirm("Are you sure ?")==false){
			...
			//myWindow=window.open('RetrieveViewExport.aspx' ,'popup', 'toolbar=no, status=no, resizable=no, width=180, height=110, scrollbars=no, menu=no');
     ...
     <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr>
                ...
                <input name="submit22" type="button" class="button" value="BACK" onClick="history.go(-1);" style="font-size:7pt" />
                      ...
                      <asp:Button ID="submit2" Text="Export Selected to Excel" class="mainoption" style="font-size:7pt" OnClientClick="chk_save(this.form);" runat="server" PostBackUrl="~/Web/FS_RetrieveViewExport.aspx" />
                </td>
              </tr>
