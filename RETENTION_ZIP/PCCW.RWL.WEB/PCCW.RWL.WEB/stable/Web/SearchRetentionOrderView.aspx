                ...
                <tr>
                                        ...
                                        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="form-simple" style="cursor: hand">
                                            <tr>
                                                <td height="0" colspan="6" style="background-color: #DDDDDD">
                                                    <span style="font-size: 10px; color: White">BASE SEARCH
                                                    </span>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <input type="checkbox" name="action_required2" id="action_required2" value="opt_out" disabled="disabled" onclick="en_action_opt();" />
                                            ...
                                            <tr>
                                                ...
                                                <td height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsLog_dateName %>" type="text" id="log_date" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" value="" onfocus="showCalendarControl(this,'');" />
                                                    (DD/MM/YYYY) TO 
                    <input name="log_date2" type="text" id="log_date2" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                            ...
                                            <tr>
                                                ...
                                                <td height="0">
                                                    <input name="<%=WebFunc.qsCon_eff_dateName %>" type="text" id="con_eff_date" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                                    (DD/MM/YYYY) TO 
                    <input name="con_eff_date2" type="text" id="con_eff_date2" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                            ...
                                            <tr>
                                                ...
                                                <td height="0">
                                                    <input name="<%=WebFunc.qsPlan_eff_dateName %>" type="text" id="plan_eff_date" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                                    (DD/MM/YYYY) TO 
                    <input name="plan_eff_date2" type="text" id="plan_eff_date2" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                            ...
                                            <tr>
                                                ...
                                                <td height="0">
                                                    <input name="<%=WebFunc.qsD_dateName %>" type="text" id="d_date" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                                    (DD/MM/YYYY) TO 
                    <input name="d_date2" type="text" id="d_date2" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                            ...
                                            <tr>
                                                ...
                                                <td height="0" width="75%" colspan="3">
                                                    <input name="<%=WebFunc.qsAction_eff_dateName %>" type="text" id="action_eff_date" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                                    (DD/MM/YYYY) TO 
                    <input name="action_eff_date2" type="text" id="action_eff_date2" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsOrder_idName %>" type="text" id="order_id" style="font-size: 10px" size="6" maxlength="6" onblur="isNum(this);" />
                                                    TO 
                    <input name="<%=WebFunc.qsOrder_id2Name %>" type="text" id="order_id2" style="font-size: 10px" size="6" maxlength="6" onblur="chg_upper(this);" /></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsCust_nameName %>" type="text" id="cust_name" style="font-size: 10px" size="50" maxlength="100" onblur="chg_upper(this);" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsHkidName %>" type="text" id="hkid" style="font-size: 10px" size="20" maxlength="21" onblur="chg_upper(this);" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsMrt_noName %>" type="text" id="mrt_no" style="font-size: 10px" size="10" maxlength="8" onblur="isNum(this);" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr id="ac_no_show" style="display: none">
                                                ...
                                                <td width="75%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsAc_noName %>" type="text" id="ac_no" style="font-size: 10px" size="10" maxlength="10" onblur="chg_upper(this);" /></td>
                                            </tr>

                                            <tr id="bill_medium_email_show" style="display: none">
                                                <td height="0"><span style="font-size: 10px">Bill Medium Email</span></td>
                                                <td width="75%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsBill_medium_emailName %>" type="text" id="bill_medium_email" style="font-size: 10px" size="10" maxlength="10" onblur="chg_upper(this);" /></td>
                                            </tr>
					...
					<select name="<%=WebFunc.qsExisting_contract_end_yearName %>" id="existing_contract_end_year" style="font-size: 10px">
                        ...
                        <option value="2012">2012</option>
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsStaff_noName %>" type="text" id="staff_no" style="font-size: 10px" size="12" maxlength="10" value="" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td height="0"><span style="font-size: 10px">Special Premium 1
                                                    <br>
                                                </span></td>
                                            ...
                                            <tr>
                                                <td height="0"><span style="font-size: 10px">Special Premium 2
                                                    <br>
                                                </span></td>
                                                <td height="0" colspan="3"><span style="font-size: 9px">
                            ...
                            <Panes>
                                ...
                                <cc1:AccordionPane ID="P2" runat="server">
                                    ...
                                    <Header>
                                        ...
                                        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="form-simple" style="cursor: hand">
                                            <tr>
                                                <td height="0" colspan="6" style="background-color: #DDDDDD"><span style="font-size: 10px; color: White">Other</span></td>
                                            </tr>
                                        </table>
                                    </Header>
                                    <Content>
                                        ...
                                        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="form-simple">
                                            ...
                                            <tr>
                                                <td height="0"><span style="font-size: 10px">PCD Paid Go Wireless<br>
                                                </span></td>
                                                <td height="0" colspan="3">
                                            ...
                                            <tr>
                                                ...
                                                <td height="0">
                                                    <input name="<%=WebFunc.qsVas_eff_dateName %>" type="text" id="vas_eff_date" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                                    (DD/MM/YYYY) TO 
                    <input name="vas_eff_date2" type="text" id="vas_eff_date2" style="font-size: 10px" size="12" maxlength="10" onblur="chk_date2(this,0,0);" onfocus="showCalendarControl(this,'');" />
                                            ...
                                            <tr>
                                                ...
                                                <td width="77%" height="0" colspan="3">
                                                    <input name="<%=WebFunc.qsPos_ref_noName %>" type="text" id="pos_ref_no" style="font-size: 10px" size="30" maxlength="30" onblur="chg_upper(this);" />
                                                </td>
                                            </tr>
                            ...
                            <Panes>
                                ...
                                <cc1:AccordionPane ID="P3" runat="server">
                                    ...
                                    <Header>
                                        ...
                                        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="form-simple" style="cursor: hand">
                                            <tr>
                                                <td height="0" colspan="6" style="background-color: #DDDDDD"><span style="font-size: 10px; color: White">VIEW METHOD 
                                                </span></td>
                                            </tr>
                                        </table>
