<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusinessTradeViewDetail.aspx.cs" Inherits="BusinessTradeViewDetail" %>
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
                ...
                <tr> 
                  <td height="23" colspan="4" class="row2"><span class="explaintitle"> 
                    ...
                    <asp:Button ID="modify" Text="MODIFY" runat="server" Font-Size="7pt" CssClass="mainoption"  />
                    <asp:Button ID="duplicate" Text="DUPLICATE" runat="server" Font-Size="7pt" CssClass="mainoption" />
              
                    </span><span class="gensmall">
                    <input name="submit223" type="button" class="mainoption" value="BACK" onclick="history.go(-1);" style="font-size:7pt" />
                ...
                <tr> 
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:Literal ID="premium_1" runat="server"></asp:Literal></span></td>
                </tr>
                <tr> 
                  <td height="27"  class="row2"><span class="explaintitle" style="font-size:7pt">Premium 2 
                    </span></td>
                  <td height="27" class="row1"><span class="gensmall" style="font-size:7pt"> 
                  <asp:Literal ID="premium_2" runat="server"></asp:Literal>
                  </span></td>
                </tr>
                <tr> 
                ...
                <tr> 
                 ...
                 <tr> 
                  <td height="28"  class="row2"><span class="explaintitle" style="font-size:7pt">Start 
                    Date</span></td>
                  <td height="28" class="row1"><span class="gensmall" style="font-size:7pt">
                  <asp:Literal ID="sdate" runat="server"></asp:Literal>(MM/dd/yyy)</span></td>
                </tr>
                <tr> 
                  <td height="28"  class="row2"><span class="explaintitle" style="font-size:7pt">End 
                    Date</span></td>
                  <td height="28" class="row1"><span class="gensmall" style="font-size:7pt">
                  <asp:Literal ID="edate" runat="server"></asp:Literal>(MM/dd/yyy)</span></td>
                </tr>
                ...
                <tr> 
                  <td height="28"  class="row2"><span class="explaintitle" style="font-size:7pt">Po  
                    Date</span></td>
                  <td height="28" class="row1"><span class="gensmall" style="font-size:7pt">
                  <asp:Literal ID="po_date" runat="server"></asp:Literal>(MM/dd/yyy)</span></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td height="28"  class="row2"><span class="explaintitle" style="font-size:7pt">  
                    remarks</span></td>
                  <td height="28" class="row1"><span class="gensmall" style="font-size:7pt">
                  <asp:Literal ID="remarks" runat="server"></asp:Literal></span></td>
                </tr>
                ...
                <tr>
                    ...
                    Active</span></td>
                  <td height="28" class="row1"><span class="gensmall" style="font-size:7pt">
                  <asp:Literal ID="active" runat="server"></asp:Literal></span></td>
                </tr>
                <tr> 
