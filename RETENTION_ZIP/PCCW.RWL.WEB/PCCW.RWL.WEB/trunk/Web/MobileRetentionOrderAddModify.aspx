<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MobileRetentionOrderAddModify.aspx.cs" Inherits="MobileRetentionOrderAddModify" %>
...
<user:MobileOrderScriptControl ID="MobileOrderScript" runat="server" OrderPageType="MobileRetentionOrderAddModifyScripts" />
...
<form id="form1" runat="server" name="newform">
<div id="page-header"><uc1:GlobalNavigation ID="GlobalNavigation1" runat="server" /></div>
    ...
    <input id="order_id" name="order_id" runat="server" type="hidden"/>
        <p>&nbsp;
            </p>

    	<cc1:ToolkitScriptManager ID="AddWebLogScriptManager" runat="server"  AsyncPostBackTimeout="900" EnablePageMethods="true">
...
<input type="hidden" id="Deli_flag" runat="server" />
<input type="hidden" id="Con_flag" runat="server" />
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
                ...
                <tr> 
                  <td height="23" colspan="2" class="row2"> <input type="button" name="submit23" value="Check MRT No" class="mainoption"  onclick="check_mrt()"  style="font-size:7pt;display:none"/> 
                    ...
                    <input type="button" name="submit2" value="SAVE" class="mainoption"  onclick="chk_save(this.form)"  style="font-size:7pt"/> 
                ...
                <td height="0" class ="row2"><span class="explaintitle"  style="font-size:7pt">Date 
                    Of Birth(DD/MM/YYYY)</span></td>
                ...
                <tr id="ac_no_show" runat="server" > 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Account 
                      No. 戶口號碼<br></span></td>
                ...
                <tr> 
                  ...
                  <td height="0" class="row1"> <input class="highlightrow" name="<%=WebFunc.qsMrt_noName %>" type="text" id="mrt_no" style="font-size:7pt" size="10" maxlength="8" onblur="chk_mobile(this);" runat="server" value="" readonly />                  </td>
                </tr>
                <tr> 
                ...
                <user:MobileOrderAddressUserControl ID="RegisteredAddressControl" TxtClass="explaintitle" runat="server" TableTagVisable="false" DrpClass="disablerow" Enabled="true" TitleNameLbl="Registered Address"
                 TitleFontSize=7  TdOneClass="row2" TdTwoClass="row1" RblClass="highlightrow" ToolkitScriptManagerID="AddWebLogScriptManager" 
                ...
                <user:MobileOrderAddressUserControl ID="BillingAddressControl" TxtClass="explaintitle"  TableTagVisable="false" runat="server"  DrpClass="disablerow" Enabled="true" TitleNameLbl=""
                 TitleFontSize="7"  TdOneClass="row2" TdTwoClass="row1" RblClass="highlightrow" ToolkitScriptManagerID="AddWebLogScriptManager" 
                 LoadingImgSrc="../Web/images/loading.gif" 
				...
				<tr id="vip_case_show" runat="server">
				  ...
				  <td height="0" class="row1"><asp:TextBox ID="vip_case"  Width="204px"  MaxLength="200" runat="server"></asp:TextBox></td>
				</tr>
               ...
               <tr id="action_required_show" runat="server"> 
                ...
                <tr id="waiving_show" runat="server" > 
                  ...
                  <td height="27" class="row1">
                    ...
                    <asp:RadioButtonList ID="waive" runat="server" AppendDataBoundItems="true" AutoPostBack="true" RepeatDirection="Horizontal">
                ...
                <tr id="cust_type_show"> 
                  <td height="0" class="row2">
                  <span class="explaintitle" style="font-size:7pt">Customer Type 客戶類別</span></td>
                ...
                <tr id="suspend_date_show" runat="server"> 
                  ...
                  <td height="0" class="row1"> <input name="<%=WebFunc.qsAction_eff_dateName %>" type="text" id="action_eff_date" style="font-size:7pt" size="12" maxlength="10" onchange="chk_date2(this,0,0);vaild_sup_date()"  class="disablerow" disabled onfocus="showCalendarControl(this,'vaild_sup_date();');"/> 
        ...
        PopupButtonID="UpgradeExistingContractEdateImageButton" Animated="False" /> 
                ...
                <td width="25%" height="0" class="row3">
                 ...
                 <td width="25%" height="0" class="row3">
                 <span   class="explaintitle"  style="font-size:7pt"></span>
                 </td>
                 <td>
                ...
                <user:MobileOrderMNPDetailUserControl ID="MobileOrderMNPDetailControl" TxtClass="explaintitle"  TableTagVisable="false" runat="server"  DrpClass="disablerow" Enabled="true" TitleNameLbl=""
     TitleFontSize="7"  TdOneClass="row2" TdTwoClass="row1" RblClass="highlightrow" ToolkitScriptManagerID="AddWebLogScriptManager" CalendarImgSrc="~/Resources/Images/calendar.png"/>
...
<tr id="org_mrt_show" style="display:none"  runat="server"> 
                ...
                <tr> 
                  ...
                  <asp:DropDownList ID="normal_rebate_type" AppendDataBoundItems="true" runat="server" onselectedindexchanged="normal_rebate_type_SelectedIndexChanged" Font-Size="8pt" DataTextField="normal_rebate_type" DataValueField="normal_rebate_type"  onchange="NormalPlanListLoad()" >
        ...
        <ContentTemplate>
                ...
                <tr id = "pcd_paid_go_wireless_show" style="display:none">                     
                  <td height="27"  ><span style="font-size:7pt">PCD PAID Go Wireless</span></td>
                  <td height="27" colspan="3" ><input type="checkbox" value="1" name="<%=WebFunc.qsPcd_paid_go_wirelessName %>" id="pcd_paid_go_wireless" onClick="click_pcd_paid_go_wireless();" runat="server"/></td>                    
                </tr>                
                ...
                <tr id="go_wireless_package_code_show" runat="server" > 
                  <td height="0" class="row2"><span  class="explaintitle" style="font-size:7pt">Go 
                      Wireless Package Code<br></span></td>
                ...
                <tr id="sku_item_code_show" runat="server"> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">SKU 
                      Item Code</span></td>
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px"> 
               ...
               <tr  id="monthly_rebate_amount_show" runat="server"> 
                  ...
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px"> 
                    ...
                    <input name="<%=WebFunc.qsM_rebate_amountName %>" type="text" id="m_rebate_amount" size="30" maxlength="30"  style="font-size:7pt" readonly/>
                    </span><span class="gensmall" style="font-size:9px"> 
               ...
               <tr id="hs_rebate_amount_show" runat="server">
                  ...
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px"> 
                    ...
                    <ContentTemplate>
                    <span class="gensmall" style="font-size:7pt"> 
                    <input name="<%=WebFunc.qsRebate_amountName %>" type="text" id="rebate_amount" size="30" maxlength="30"  style="font-size:7pt" readonly runat="server"/>
               ...
               <tr  id="retention_offer_show" runat="server"> 
                  ...
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px"> 
                    ...
                    <ContentTemplate>
                    <span class="gensmall" style="font-size:7pt"> 
                    <input name="<%=WebFunc.qsR_offerName %>" type="text" id="r_offer" size="30" maxlength="30"  style="font-size:7pt" readonly runat="server"/>
                    </span><span class="gensmall" style="font-size:9px"> 
                  ...
                  <asp:ListItem Text="" Value=""></asp:ListItem>
                    ...
                    </span><span  style="font-size:9px; color:Red">(HS Price + Prepayement)</span><span class="gensmall" style="font-size:7pt"> 
                ...
                <tr  id="exta_rebate_amount_show" runat="server"> 
                  ...
                  <span class="gensmall" style="font-size:9px"> 
                    ...
                    <ContentTemplate>
                    <input name="<%=WebFunc.qsExtra_rebate_amountName %>" type="text" id="extra_rebate_amount" size="30" maxlength="30"  style="font-size:7pt" readonly runat="server"/>
                ...
                <tr  id="register_address_show" runat="server"> 
                  <td height="27"  class="row2"><span class="explaintitle" style="font-size:7pt">Register Address</span></td>
                  <td height="27" colspan="3" class="row1"> 
                ...
                <tr  id="free_gift_description_show" runat="server">  
                  <td height="27" class="row2">
                  <span class="explaintitle" style="font-size:7pt">Free Gift Description 免費禮品評術</span></td>
                  <td height="27" colspan="3" class="row1"> 
                ...
                <tr  style="display:none" > 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Free Gift Description3 免費禮品評術3</span></td>
                  <td height="0" colspan="3" class="row1"> 
                ...
                <tr  style="display:none" > 
                  <td height="0" class="row2">
                  <span class="explaintitle" style="font-size:7pt">Free Gift Code3 免費禮品條碼3</span></td>
                  <td height="0" class="row1"> 
                ...
                <tr id="aig_gift_show" runat="server" style="display:none"> 
              ...
              <tr>
               ...
               <tr id="contract_effective_date_show" runat="server"> 
                  ...
                  <span class="gensmall" style="font-size:9px">(DD/MM/YYYY)</span>
                    ...
                    <td height="0" colspan="1" class="row1"><div id="div_next_bill" runat="server"><span class="gensmall" style="font-size:7pt;"> 
                ...
                <tr id="bill_cut_show" runat="server"> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Bill 
                      Cut Date<br></span></td>
                  <td height="0" colspan="1" class="row1" nowrap="nowrap"> 
				  ...
				  <input class="highlightrow" name="bill_cut_date" type="text" id="bill_cut_date" size="12" maxlength="10" readonly="readonly" onchange="ValidBillCutDate();" runat="server"/> 
                    ...
                    <td height="0" class="row1"  colspan="2">
                    <div id="div1">
                    <span> 
				...
				<tr id="cooling_offer_show" runat="server"> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Cooling 
                      Offer</span></td>
                  <td height="0" colspan="3" class="row1"> <span class="gensmall" style="font-size:7pt"> 
                    <input type="checkbox" name="<%=WebFunc.qsCooling_offerName %>" id="cooling_offer" value="YES" onClick="click_cooling()" runat="server"/>YES
                    </span> </td>
                </tr>
				<tr id="snd_contract_effective_show" style="display:none" runat="server" > 
                  <td height="0" class="row2"><span  class="explaintitle" style="font-size:10pt">2nd 
                ...
                <td width="25%" height="0" class="row3" colspan="4"><span class="explaintitle" style="font-size:7pt">
                    MONTHLY PAYMENT METHOD </span></td>
                </tr>
                ...
                <td  height="0" class="row2">
                <span class="explaintitle" style="font-size:8pt">Prepayment</span>
                </td>
                ...
                <tr id="credit_card_type_show" runat="server"> 
                  ...
                  <td height="0" class="row1"><span class="gensmall" style="font-size:9px"> 
					...
					<!--
					<input runat="server" name="m_card_no1" type="text" id="m_card_no1" size="5" maxlength="4" class="disablerow" disabled="disabled" onkeyup="if (this.value.length==4) {document.getElementById('form1').m_card_no2.focus();document.getElementById('form1').m_card_no2.select();}"  style="font-size:7pt" />
                    <input runat="server"  name="m_card_no2" type="text" id="m_card_no2" size="5" maxlength="4" class="disablerow" disabled="disabled" onkeyup="if (this.value.length==4) {document.getElementById('form1').m_card_no3.focus();document.getElementById('form1').m_card_no3.select();};"  style="font-size:7pt" />
                    <input  runat="server" name="m_card_no3" type="text" id="m_card_no3" size="5" maxlength="4" class="disablerow" disabled="disabled" onkeyup="if (this.value.length==4) {document.getElementById('form1').m_card_no4.focus();document.getElementById('form1').m_card_no4.select();};"  style="font-size:7pt" />
                    <input runat="server"  name="m_card_no4" type="text" id="m_card_no4" size="5" maxlength="4" class="disablerow" disabled="disabled" onblur="testCreditCard1();" style="font-size:7pt"/>
     				-->
					<asp:TextBox ID="m_card_no" runat="server" Text="" CssClass="m_card_no" OnBlur="if(!checkCreditCard(document.getElementById('m_card_no').value,document.getElementById('m_card_type').value)){alert('Invalid token!');}"  disabled="disabled"  />
                      ...
                      <span class="explaintitle" style="font-size:7pt">
                          <table border="0" cellpadding="0" cellspacing="0" runat="server">
                              <tr>
                                  ...
                                  <td align="center">
                                    <input id="monthly_bank_account_no" size="10" maxlength="10" runat="server" type="text" />
                                  </td>
                              </tr>
                              <tr>
                                  <td>
                ...
                <tr> 
                  <td width="25%" height="0" class="row3" colspan="4">
                  <span class="explaintitle" style="font-size:7pt">
            ...
            <table border="0" id="TBL4" width="100%" style="margin:0px 0px 0px 0px;">
              <tr>
                ...
                <tr> 
                  <td height="0" class="row3" colspan="4"><span class="explaintitle" style="font-size:7pt">
                      DELIVERY INFORMATION 送貨資料</span></td>
                </tr>
                <tr>                
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">
                      Delivery Address 送貨地址<br>
                    </span>
                ...
                <tr> 
                  ...
                  <asp:TextBox id="d_date"  runat="server" onfocus="showCalendarControl(this,'vaild_sup_date_by_calendar();');"  onchange="chk_date2(this,0,0);vaild_sup_date()" ></asp:TextBox>
                ...
                <user:MobileOrderThreePartyUserControl ID="MobileOrderThreePartyControl"  TxtClass="explaintitle" TableTagVisable="false" runat="server"  DrpClass="disablerow" Enabled="true" TitleNameLbl=""
                    TitleFontSize="7"  TdOneClass="row2" TdTwoClass="row1"  RblClass="highlightrow" ToolkitScriptManagerID="AddWebLogScriptManager"/>
                ...
                <tr> 
                  ...
                  <asp:DropDownList runat="server" ID="card_type"  AppendDataBoundItems="true" AutoPostBack="false" Font-Size="7pt" CssClass="disablerow card_type" Enabled=false >
                  <asp:ListItem Text="" Value=""></asp:ListItem>
                 ...
                 <asp:ListItem Text="American Express" Value="AmEx"></asp:ListItem>
                  ...
                  <td height="0" class="row1"><span class="gensmall" style="font-size:9px"> 
					...
					<!--
				    <input runat="server" name="<%=WebFunc.qsCard_no1Name %>" type="text" id="card_no1" size="5" maxlength="4" class="disablerow" disabled onKeyUp="if (this.value.length==4) {document.getElementById('form1').card_no2.focus();document.getElementById('form1').card_no2.select();}"  style="font-size:7pt" />
                    <input runat="server"  name="<%=WebFunc.qsCard_no2Name %>" type="text" id="card_no2" size="5" maxlength="4" class="disablerow" disabled onKeyUp="if (this.value.length==4) {document.getElementById('form1').card_no3.focus();document.getElementById('form1').card_no3.select();};"  style="font-size:7pt" />
                    <input runat="server" name="<%=WebFunc.qsCard_no3Name %>" type="text" id="card_no3" size="5" maxlength="4" class="disablerow" disabled onKeyUp="if (this.value.length==4) {document.getElementById('form1').card_no4.focus();document.getElementById('form1').card_no4.select();};"  style="font-size:7pt" />
                    <input runat="server" name="<%=WebFunc.qsCard_no4Name %>" type="text" id="card_no4" size="5" maxlength="4" class="disablerow" disabled onblur="testCreditCard();" style="font-size:7pt"/>
     				-->
                ...
                <tr> 
                  ...
                  <td height="0" class="row1"><span class="gensmall" style="font-size:9px"> 
                    ...
                    <input runat="server"  name="<%=WebFunc.qsCard_holderName %>" type="text" id="card_holder" class="disablerow" disabled="disabled" onblur="chg_upper(this);chk_cc(this)" size="30" maxlength="100"  style="font-size:7pt" />
                  ...
                  <td height="0" class="row1"><span class="gensmall" style="font-size:9px"> 
                    ...
                    <asp:DropDownList ID="card_exp_month" runat="server" CssClass="disablerow" Enabled=false onblur="valid_thur(this.form.card_exp_month.value,this.form.card_exp_year.value);" Font-Size="7pt">
                    <asp:ListItem Text="" Value=""></asp:ListItem>
                    ...
                    <asp:DropDownList ID="card_exp_year" runat="server" CssClass="disablerow" Enabled=false onblur="valid_thur(this.form.card_exp_month.value,this.form.card_exp_year.value);" Font-Size="7pt">
                    <asp:ListItem Text="" Value=""></asp:ListItem>
                ...
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Bank 
                      Name 銀行名稱<br>
                    </span></td>
                  <td height="0" class="row1" colspan="3"><span class="gensmall" style="font-size:9px"> 
                ...
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">HS Amount 手機總額
                    </span></td>
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px"> 
                      $ 
                    <input type="text" name="<%=WebFunc.qsAmountName %>" id="amount" size="5" maxlength="6" style="font-size:7pt"  onblur="isNum(this);" value="0" readonly="readonly" runat="server"/>
                    </span></td>
                </tr>
				
				<tr id="first_month_fee_show"> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">First month fee
                    </span></td>
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px"> 
                      $ 
                    <input type="text" name="<%=WebFunc.qsFirst_month_feeName %>" id="first_month_fee" size="5" maxlength="6" style="font-size:7pt"  onblur="isNum(this);" value="0" readonly="readonly" runat="server"/>
                    </span></td>
                </tr>
				
				<tr id="first_month_license_fee_show"> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">First month license fee
                    </span></td>
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px"> 
                      $ 
                    <input type="text" name="<%=WebFunc.qsFirst_month_license_feeName %>" id="first_month_license_fee" size="5" maxlength="6" style="font-size:7pt"  onblur="isNum(this);" value="0" readonly="readonly" runat="server"/>
                    </span></td>
                </tr>
				
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Amount 
                      總額<br>
                    </span></td>
                  <td height="0" colspan="3" class="row1"><span class="gensmall" style="font-size:9px">
                      $ 
                    <input runat="server" type="text" name="total_amount" id="total_amount" value="0" size="5" maxlength="6" style="font-size:7pt"  onblur="isNum(this);" readonly/>
                    </span>
				  </td>
                </tr>
                </table>
			...
			<ContentTemplate>              
              <table  id="no_opt_out" width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
                <tr> 
                  <td height="0" class="row3" colspan="3"><span id="Span1" runat="server"  class="explaintitle" style="font-size:7pt">
                      &nbsp;</span></td>
                </tr>
                <tr> 
                  <td width="22%" height="0" class="row2"><span id="Span2" runat="server"  class="explaintitle" style="font-size:7pt">
                      Remarks 備註<br>
                  </span></td>
                  <td height="0" colspan="2" class="row1"><textarea runat="server"  name="<%=WebFunc.qsRemarksName %>" cols="50" rows="2" id="remarks" onblur="chg_upper(this);chk_cc(this)"></textarea>                  </td>
                </tr>
                 <tr id="remarks2edf_show" runat="server"> 
                  <td width="22%" height="0" class="row2"><span id="Span3" runat="server"  class="explaintitle" style="font-size:7pt">
                      Remarks to EDF<br>
                   </span></td>
                  <td height="0" colspan="2" class="row1">

                  <textarea runat="server" name="<%=WebFunc.qsRemarks2EDFName %>" cols="50" rows="2" id="remarks2EDF" onblur="chg_upper(this);chk_cc(this)" class="disablerow" disabled></textarea>                  

                  
                  </td>
                </tr>
                <tr id="show_remarks_to_py_operation"  class="show_remarks_to_py_operation"> 
                  <td width="22%" height="0" class="row2"><span class="explaintitle" style="font-size:7pt">
                      Remarks to PY Operation<br>
                  </span></td>
                  <td height="0" colspan="2" class="row1">
               ...
               <tr> 
                  <td height="25" class="row2"><span class="explaintitle" style="font-size:7pt">Staff 
                      No </span></td>
                  <td  width="49%" height="25" class="row1"> 
                    <input runat="server"  name="<%=WebFunc.qsStaff_noName %>" type="text" id="staff_no" style="font-size:7pt" size="12" maxlength="10" value="" />
                    <span class="gensmall" style="font-size:7pt">
                    <input runat="server" name="ch_cust_button" id="ch_cust_button" type="button" class="button"  value="Change Staff Info" onclick="get_name(document.getElementById('form1').staff_no.value)" />
					</span> </td>
                  <td width="51%" height="25" colspan="1" class="row1"> <span class="explaintitle" style="font-size:7pt">
                      Referrer Staff ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="explaintitle" style="font-size:7pt">
                    <input runat="server" name="<%=WebFunc.qsRef_staff_noName %>" type="text" id="ref_staff_no" style="font-size:7pt" size="12" maxlength="10"  />
                    </span>
                ...
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Staff 
                      Name</span></td>
                  <td height="0" width="49%" class="row1"> <input runat="server"  name="<%=WebFunc.qsStaff_nameName %>" type="text" id="staff_name" style="font-size:7pt" size="50" maxlength="100" value="" readonly="readonly"  runat="server"/>                  </td>
                  <td width="51%" height="25" colspan="1" class="row1"><span class="explaintitle" style="font-size:7pt">
					  Referrer Salesmancode <span class="explaintitle" style="font-size:7pt">
					

					<input name="<%=WebFunc.qsRef_salesmancodeName %>" type="text" id="ref_salesmancode" style="font-size:7pt" size="10" maxlength="10" value="" readonly="readonly" runat="server"/>
                ...
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">
                      Teamcode</span></td>
                  <td height="0" colspan="2" class="row1"> <input name="<%=WebFunc.qsTeamcodeName %>" type="text" id="teamcode" style="font-size:7pt" size="12" maxlength="10" value="NONE" readonly runat="server"/>                  </td>
                </tr>
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Team 
                      Leader</span></td>
                  <td height="0" colspan="2" class="row1"> <input name="<%=WebFunc.qsTl_nameName %>" type="text" id="tl_name" style="font-size:7pt" size="50" maxlength="100" value="" readonly runat="server"/>                  </td>
                </tr>
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Channel</span></td>
                  <td height="0" colspan="2" class="row1"> <input name="<%=WebFunc.qsChannelName %>" type="text" id="channel" style="font-size:7pt" size="5" maxlength="4" value="" readonly runat="server"/>                  </td>
                </tr>
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">
                      Salesman Code </span></td>
                  <td height="0" colspan="2" class="row1"> <input  name="<%=WebFunc.qsSalesmancodeName %>" type="text" id="salesmancode" style="font-size:7pt" size="5" maxlength="4" value="" readonly runat="server"/>                  </td>
                </tr>
             
                <tr> 
                  <td height="0" class="row2"><span class="explaintitle" style="font-size:7pt">Extn</span></td>
                  <td height="0" colspan="2" class="row1"> <input runat="server" name="<%=WebFunc.qsExtnName %>" type="text" id="extn" style="font-size:7pt" size="9" maxlength="8" value="" readonly/>                  </td>
                </tr>
