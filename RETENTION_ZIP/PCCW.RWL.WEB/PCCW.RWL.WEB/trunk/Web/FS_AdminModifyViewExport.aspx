<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FS_AdminModifyViewExport.aspx.cs" Inherits="AdminModifyViewExport" %>
  ...
  <tr> 
    ...
    <ItemTemplate>
         <tr> 
             ...
             <td nowrap ><%# DataBinder.Eval(Container.DataItem, "gender")%></td>
             <td nowrap ><%# DataBinder.Eval(Container.DataItem, "family_name") +" "+DataBinder.Eval(Container.DataItem, "given_name")%></td>
             <td nowrap ><%# DataBinder.Eval(Container.DataItem, "date_of_birth")%></td>
            ...
            <td nowrap ><%# DataBinder.Eval(Container.DataItem, "edf_no")%></td>
            <td nowrap ><%# DataBinder.Eval(Container.DataItem, "d_date")%></td>
            <td nowrap ><%# DataBinder.Eval(Container.DataItem, "bill_cut_num")%></td>
            <td nowrap ><%# DataBinder.Eval(Container.DataItem, "prepayment_waived")%></td>
              </tr>
