<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FS_RetrieveOrderViewAction.aspx.cs" Inherits="Web_RetrieveOrderViewAction" %>
...
<tr>
              ...
              <tr>
                ...
                <input name="submit22" type="button" class="button" value="BACK" onClick="history.go(-1);" style="font-size:7pt" />
                          ...
                          <asp:Button ID="submit2" Text="Export Selected to Excel" class="mainoption" style="font-size:7pt" OnClientClick="chk_save(this.form);" runat="server" PostBackUrl="~/Web/FS_RetrieveOrderViewExport.aspx" />
