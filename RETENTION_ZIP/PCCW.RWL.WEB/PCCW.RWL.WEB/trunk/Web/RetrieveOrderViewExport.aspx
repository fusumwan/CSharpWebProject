<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetrieveOrderViewExport.aspx.cs" Inherits="Web_RetrieveOrderViewExport" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
                <tr> 
                  ...
                  <td class="row1">Program</td>
                  <td class="row1">Normal Rebate Type</td>
				  ...
				  <td class="row1">Cooling offer</td>
				  <td class="row1">2nd Contract Effective date(MM/DD/YYYY)</td>
				...
				<td class="row1">Redemption Notice Option</td>
                <td class="row1">Payment Method</td>
                <td class="row1">Expect Delivery Date</td>
                <td class="row1">IMEI Number</td>
