<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetrieveSuViewAction.aspx.cs" Inherits="RetrieveSuViewAction" %>
...
if(RetrieveId==undefined) return false;
	...
	if(event.returnValue!=false){
		...
		//myWindow=window.open('RetrieveSuViewExport.aspx' ,'popup', 'toolbar=no, status=no, resizable=no, width=180, height=110, scrollbars=no, menu=no');
...
<body>
    ...
    <form action="RetrieveSuViewExport.aspx" method="post" name="form1" id="form1" runat="server">
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
                ...
                <tr> 
                  <td height="23" colspan="100" class="row2"> <p> 
                      ...
                      <asp:Button ID="submit2" Text="Export Selected to Excel" class="mainoption" style="font-size:7pt" OnClientClick="chk_save(this.form);" runat="server" PostBackUrl="~/Web/RetrieveSuViewExport.aspx" />
                    </p></td>
                </tr>
                <tr> 
                  <td class="row1"></td>
