...
function export_file() {
    window.open('ProfileTeamExport.aspx', 'ProfileTeamExport', 'height=1, width=1, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
    return false;
}
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr> 
                <td height="40" colspan="26" class="row2"><span class="gensmall" id="rc"><br />
                  <asp:Button ID="BACKBUT" Text="BACK" runat="server" CssClass="button" PostBackUrl="~/Web/AccessRight/AccessPageManagement.aspx" />
                  <asp:Button ID="HISTORYBUT" Text="HISTORY" runat="server" CssClass="button" value="HISTORY" PostBackUrl="~/Web/AccessRight/ProfileTeamStatusHistory.aspx" />
                  <asp:Button ID="EXPORTBUT" Text="EXPORT" runat="server" CssClass="button" OnClientClick="export_file()" />
                  </span>
                </td>
              </tr>
              ...
              <tr>
              <td>
<EW:GridViewEx ID="ProfileTeamRecordGV" CssClass="table-report" EmptyShowHeader="true"  AllowSorting="true"
...
AutoGenerateColumns="False" onrowcommand="ProfileTeamRecordGV_RowCommand" 
                      ...
                      onpageindexchanging="ProfileTeamRecordGV_PageIndexChanging" 
                      onsorting="ProfileTeamRecordGV_Sorting"  >
<Columns>
...
<asp:TemplateField Visible="true"  HeaderText="STAFF NO." SortExpression="staff_no">
<ItemTemplate>
...
<asp:TemplateField Visible="true" HeaderText="CREATED BY"  SortExpression="cid">
<ItemTemplate>
...
<InsertItemTemplate>
<asp:TextBox ID="cid" runat="server" Text='<%# Bind(Container.DataItem,"cid") %>'></asp:TextBox>
</InsertItemTemplate>
</asp:TemplateField>


<asp:TemplateField Visible="true" HeaderText="CREATE DATE" SortExpression="cdate">
<ItemTemplate>
<asp:Literal ID="cdate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"cdate","{0:dd/MM/yyyy HH:mm:ss}") %>'></asp:Literal>
</ItemTemplate>
<EditItemTemplate>
<asp:Literal ID="cdate" runat="server" Text='<%# Bind(Container.DataItem,"cdate","{0:dd/MM/yyyy HH:mm:ss}") %>'></asp:Literal>
</EditItemTemplate>
<InsertItemTemplate>
<asp:TextBox ID="cdate" runat="server" Text='<%# Bind(Container.DataItem,"cdate","{0:dd/MM/yyyy HH:mm:ss}") %>'></asp:TextBox>
</InsertItemTemplate>
</asp:TemplateField>


<asp:TemplateField Visible="true"  HeaderText="SALESMAN CODE" SortExpression="salesman_code">
<ItemTemplate>
...
<asp:TemplateField Visible="true"  HeaderText="START DATE" SortExpression="sdate">
<ItemTemplate>
...
<asp:TemplateField Visible="true"  HeaderText="END DATE" SortExpression="edate">
<ItemTemplate>
...
<asp:TemplateField Visible="true" HeaderText="ACTIVE" SortExpression="active">
<ItemTemplate>
