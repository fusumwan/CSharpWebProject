<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerAccountSearch.aspx.cs" Inherits="CustomerAccountSearch" %>
...
function chk_save(ThisForm){
	...
	if(event.returnValue!=false){
		...
		document.getElementById("form1").action="CustomerAccountAdd.aspx";
		ThisForm.submit()
	}
}
...
<body>
    ...
    <form id="form1" action="CustomerAccountAdd.aspx" runat="server">
