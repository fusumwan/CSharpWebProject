<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusinessTradeModify.aspx.cs" Inherits="BusinessTradeModify" %>
        ...
        <asp:ScriptManager ID="AddWebLogScriptManager" runat="server"></asp:ScriptManager>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
                ...
                <tr> 
                  ...
                  <asp:Button Text="SAVE" ID="SubmitTradeMode" CssClass="mainoption" runat="server" Font-Size="7pt" UseSubmitBehavior="False" />
                ...
                <tr> 
                  <td height="27"  class="row2"><span class="explaintitle" style="font-size:7pt">Plan Fee</span></td>
                  <td height="27" class="row1"><span class="gensmall" style="font-size:7pt"> 
