<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetrieveToPyViewAction.aspx.cs" Inherits="RetrieveToPyViewAction" %>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
              ...
              <tr>
                ...
                <input name="submit22" type="button" class="button" value="BACK" onClick="history.go(-1);" style="font-size:7pt" />
                      ...
                      <asp:Button ID="submit2" Text="Export Selected to Excel" class="mainoption" style="font-size:7pt" OnClientClick="chk_save(this.form);" runat="server" PostBackUrl="~/Web/RetrieveToPyViewExport.aspx" />
                </td>
              </tr>
