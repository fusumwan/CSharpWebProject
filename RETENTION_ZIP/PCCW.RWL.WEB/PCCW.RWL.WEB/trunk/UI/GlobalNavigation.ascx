<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GlobalNavigation.ascx.cs" Inherits="UI_GlobalNavigation" %>
        ...
        <li id="global-navigation-account" class="toplevel"><a href="#" class="toplevel">
          ...
          <ul class="sublevel vertical">
            <li id="LogoutLI" runat="server">
              <asp:HyperLink  ID="Logout" runat="server" NavigateUrl="../../chk_login.asp">Logout</asp:HyperLink>
            </li>
          </ul>
        </li>
  </ul>
