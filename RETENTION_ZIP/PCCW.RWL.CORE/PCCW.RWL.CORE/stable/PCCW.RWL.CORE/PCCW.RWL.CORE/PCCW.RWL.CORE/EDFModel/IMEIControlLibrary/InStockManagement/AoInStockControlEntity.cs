...
///-- Description:	<Description,Class :AoInStockControlEntity, Data Entity>
///-- =============================================
namespace PCCW.RWL.CORE
{

    public class AoInStockControlEntity
    {
        protected string n_sCreateDate = string.Empty;
        #region m_sCreateDate
        protected virtual string m_sCreateDate
        {
            get
            {
                return this.n_sCreateDate;
            }
            set
            {
                this.n_sCreateDate = value;
            }
        }
        #endregion m_sCreateDate
        ...
        #region m_sRefNo
        protected virtual string m_sRefNo
        {
            get
            {
