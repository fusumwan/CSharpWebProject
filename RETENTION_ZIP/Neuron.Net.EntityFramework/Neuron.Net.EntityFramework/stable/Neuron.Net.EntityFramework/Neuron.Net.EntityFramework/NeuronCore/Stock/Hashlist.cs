...
namespace NEURON.ENTITY.FRAMEWORK.STOCK
{
    ...
    public abstract class Hashlist : IDictionary, IEnumerable
    {
        ...
        public object KeyFind(int x_iIndex)
        {
            if (x_iIndex < m_oKeys.Count)
                return m_oKeys[x_iIndex];
            return null;
        }

        public object ValueFind(int x_iIndex)
        {
            if (x_iIndex < m_oKeys.Count)
            {
                if (m_oValues.ContainsKey(m_oKeys[x_iIndex]))
                    return m_oValues[m_oKeys[x_iIndex]];
            }
            return null;
        }
        /// <summary>
        ...
        public object this[int Index]
        {
            ...
            set { m_oValues[m_oKeys[Index]] = value; }
        }
        #endregion
