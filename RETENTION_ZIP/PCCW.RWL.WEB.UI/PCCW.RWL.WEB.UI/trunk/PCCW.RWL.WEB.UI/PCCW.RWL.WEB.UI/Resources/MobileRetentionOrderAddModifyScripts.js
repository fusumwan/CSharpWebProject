    ...
    try {
        if (i == "yes") {
            ...
            */
            ...
            if (document.getElementById('d_address') != undefined) document.getElementById('form1').d_address.background = "#FFFFbb";
            ...
            */
            ...
            if (document.getElementById('d_address') != undefined) document.getElementById('form1').d_address.background = "#DDDDDD";
...
function c_all() {
    document.getElementById('form1').program.value = ""
    if (document.getElementById('normal_rebate_type') != undefined) document.getElementById('normal_rebate_type').selectedIndex = 0;

    document.getElementById('form1').rate_plan.value = ""
    document.getElementById('form1').accept_0.checked = false
    document.getElementById('form1').accept_1.checked = false
    document.getElementById('form1').con_per.value = ""
    document.getElementById('form1').rebate.value = ""
    document.getElementById('form1').free_mon.value = ""
    document.getElementById('form1').lob.value = ""
    document.getElementById('form1').lob_ac.value = ""
    document.getElementById('form1').go_wireless_package_code.value = ""
    document.getElementById('form1').hs_model.value = ""
    document.getElementById('form1').premium.value = ""
    document.getElementById('form1').sku.value = ""

    document.getElementById('form1').sim_item_name1.value = ""
    document.getElementById('form1').trade_field.value = ""
    document.getElementById('form1').bundle_name.value = ""
    document.getElementById('form1').m_rebate_amount.value = ""
    document.getElementById('form1').rebate_amount.value = ""
    document.getElementById('form1').r_offer.value = ""
    document.getElementById('form1').extra_rebate_amount.value = ""
    document.getElementById('form1').extra_rebate.value = ""
    document.getElementById('form1').cancel_renew_0.checked = false
    document.getElementById('form1').cancel_renew_1.checked = false
    document.getElementById('form1').gift_desc.value = ""
    document.getElementById('form1').gift_code.value = ""
    document.getElementById('form1').gift_imei.value = ""
    document.getElementById('form1').gift_desc2.value = ""
    document.getElementById('form1').gift_code2.value = ""
    document.getElementById('form1').gift_imei2.value = ""
    document.getElementById('form1').accessory_desc.value = ""
    document.getElementById('form1').accessory_code.value = ""
    document.getElementById('form1').accessory_imei.value = ""
    document.getElementById('form1').accessory_price.value = ""
    document.getElementById('form1').now_vas.value = "NO"
    document.getElementById('form1').foot_vas.value = "NO"
    document.getElementById('form1').fin_vas.value = "NO"
    document.getElementById('form1').horse_vas.value = "NO"
    document.getElementById('form1').moov_vas.value = "NO"
    document.getElementById('form1').gprs_vas[0].value = "NO"
    document.getElementById('form1').gprs_vas[1].value = ""
    document.getElementById('form1').wifi_vas.value = "NO"
    document.getElementById('form1').sms_vas[0].value = "NO"
    document.getElementById('form1').sms_vas[1].value = ""
    document.getElementById('form1').msn_vas.value = "NO"
    document.getElementById('form1').ct_vas.value = "NO"
    document.getElementById('form1').min_vas.value = "NO"
    document.getElementById('form1').license_waiver.value = "NO"
    document.getElementById('form1').fast_start.checked = false
    document.getElementById('form1').pcd_paid_go_wireless.checked = false

    document.getElementById('form1').plan_eff_date.value = ""
    document.getElementById('form1').con_eff_date.value = ""
    document.getElementById('form1').pos_ref_no.value = ""
    document.getElementById('form1').ord_place_by.value = ""
    document.getElementById('form1').ord_place_rel.value = ""
    document.getElementById('form1').ord_place_id_type.value = ""
    document.getElementById('form1').ord_place_hkid.value = ""
    document.getElementById('form1').ord_place_hkid2.value = ""
    document.getElementById('form1').ord_place_tel.value = ""
    document.getElementById('form1').d_time.value = ""
    document.getElementById('form1').contact_person.value = ""
    document.getElementById('form1').contact_no.value = ""
    document.getElementById('form1').ext_place_tel.value = ""
    document.getElementById('form1').pay_method.value = ""
    document.getElementById('form1').card_type.value = ""
    document.getElementById('form1').card_holder.value = ""
    document.getElementById('form1').bank_code.value = ""
    document.getElementById('form1').amount.value = ""
    document.getElementById('form1').total_amount.value = ""
    document.getElementById('form1').card_exp_month.value = ""
    document.getElementById('form1').card_exp_year.value = ""

    document.getElementById('form1').card_no.value = "";
    document.getElementById('form1').extra_d_charge.value = ""
    document.getElementById('form1').d_address.value = ""
...
function c_all_opt() {
    ...
    document.getElementById('form1').premium.value = ""
    document.getElementById('form1').sku.value = ""
    //	document.getElementById('form1').imei_no.value = ""
    document.getElementById('form1').sim_item_name1.value = ""
    document.getElementById('form1').sim_item_name.value = ""
    document.getElementById('form1').sim_item_code.value = ""
    document.getElementById('form1').sim_item_number.value = ""
    document.getElementById('form1').trade_field.value = ""
    document.getElementById('form1').bundle_name.value = ""
    document.getElementById('form1').m_rebate_amount.value = ""
    document.getElementById('form1').rebate_amount.value = ""
    ...
    document.getElementById('form1').fast_start.checked = false
    document.getElementById('form1').pcd_paid_go_wireless.checked = false
    //	document.getElementById('form1').vas_eff_date.value = ""
    document.getElementById('form1').plan_eff_date.value = ""
    document.getElementById('form1').con_eff_date.value = ""
    document.getElementById('form1').pos_ref_no.value = ""
    document.getElementById('form1').ord_place_by.value = ""
    ...
    document.getElementById('form1').card_no.value = "";
    /*
    document.getElementById('form1').card_no1.value = ""
    document.getElementById('form1').card_no2.value = ""
    document.getElementById('form1').card_no3.value = ""
    document.getElementById('form1').card_no4.value = ""
    */
    document.getElementById('form1').m_card_exp_month.value = ""
    document.getElementById('form1').m_card_exp_year.value = ""

    document.getElementById('form1').m_card_no.value = "";
    /*
    document.getElementById('form1').m_card_no1.value = ""
    document.getElementById('form1').m_card_no2.value = ""
    document.getElementById('form1').m_card_no3.value = ""
    document.getElementById('form1').m_card_no4.value = ""
    */
    document.getElementById('form1').extra_d_charge.value = ""

    document.getElementById('form1').d_address.value = ""
    /*
    document.getElementById('form1').d_type.value = ""
    document.getElementById('form1').d_room.value = ""
    document.getElementById('form1').d_floor.value = ""
    document.getElementById('form1').d_blk.value = ""
    document.getElementById('form1').d_build.value = ""
    document.getElementById('form1').d_street.value = ""
    document.getElementById('form1').d_district.value = ""
    /*
    document.getElementById('form1').d_region_0.checked = false
    document.getElementById('form1').d_region_1.checked = false
    document.getElementById('form1').d_region_2.checked = false
    document.getElementById('form1').d_region_3.checked = false
    */
    document.getElementById('form1').d_time.value = ""
    document.getElementById('form1').extra_d_charge.value = ""
    document.getElementById('form1').contact_person.value = ""
...
function chk_save(ThisForm) {
    ...
    var AccessoryCodeObj = document.getElementById('accessory_code');
    var AccessoryImeiObj = document.getElementById('accessory_imei');
    var HsModelObj = document.getElementById('hs_model');
    var AccessoryDescDrpObj = document.getElementById('accessory_desc1');
    var AmountObj = document.getElementById('amount');
    ...
    var S_premium2Obj = document.getElementById('s_premium2');
    var D_AddressObj = document.getElementById('d_address');
    ...
    if (bFlag) {
        try {
            if ((!ActionRequiredObj.checked && !ActionRequired2Obj.checked) && (document.getElementById('form1').go_wireless.value != "NO" && document.getElementById('form1').go_wireless.value != "") && (document.getElementById('form1').gift_code.value == "" || AccessoryCodeObj.value == "") && AccessoryImeiObj.value == "") {
    ...
    if (bFlag) {
        try {
            if ((!ActionRequiredObj.checked && !ActionRequired2Obj.checked) && HsModelObj.value != "" && D_AddressObj.value == "") {
                alert("Please Enter Delivery Address!");
                if (D_AddressObj.style.display != "none" && D_AddressObj.disabled == false) {
                    //D_DistrictObj.focus();
                }
                event.returnValue = false;
                document.getElementById('form1').submit2.disabled = false;
    ...
    if (bFlag) {
        try {
            if ((!ActionRequiredObj.checked && !ActionRequired2Obj.checked) && HsModelObj.value != "" && document.getElementById('pay_method').value == "CREDIT CARD INSTALLMENT" && document.getElementById('bank_code').value != "" && !vaild_amount()) {
                alert("CREDIT CARD INFORMATION ERROR!");
                event.returnValue = false;
                document.getElementById('form1').submit2.disabled = false;
                bFlag = false;
            }
    ...
    if (bFlag) {
        try {
            // check if that is SIM/IPHONE program
            if ($("#program").val() == "IPHONE REBATE PLAN" || $("#program").val() == "STAFF OFFER (IPHONE REBATE)" || $("#program").val() == "IPAD SIM ONLY OFFER" || $("#program").val() == "MOBILE LITE (SIM ONLY)" || $("#program").val() == "MOBILE LITE (HS OFFER)" || $("#program").val() == "STAFF OFFER (IPHONE CONCIERGE SER)" || $("#program").val() == "IPHONE CONCIERGE SERVICE" || $("#program").val() == "MOBILEONE T3 RETENTION") {
                /*
                if ($("#sim_item_number").val() == '') {
                MobileRetentionOrderAddModify.check_sim_number_for_js($("#sim_item_name1").val(), $("#sim_item_code").val(), $("#sim_item_number").val(), callback_check_sim_number_for_js);
                } else {
                MobileRetentionOrderAddModify.check_sim_number_for_js($("#sim_item_name1").val(), $("#sim_item_code").val(), $("#sim_item_number").val(), callback_check_sim_number_for_js);
                }
                */
    ...
    if (event.returnValue != false && bFlag) {
        if (confirm("Are you sure you want to Save?") == false) {
            ...
            document.getElementById('form1').submit2.disabled = true;
            document.getElementById('form1').action = "MobileRetentionOrderAddModifyImplement.aspx";
