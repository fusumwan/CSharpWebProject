...
function LoadChkGW() {
    ...
    if (document.getElementById('load_go_wireless') != undefined) document.getElementById("load_go_wireless").style.display = "inline";
    if (document.getElementById('org_mrt') != undefined) document.getElementById("org_mrt").readOnly = true;
}

function NoLoadChkGW() {
    if (document.getElementById('load_go_wireless') != undefined) document.getElementById("load_go_wireless").style.display = "none";
    if (document.getElementById('org_mrt') != undefined) document.getElementById("org_mrt").readOnly = false;
}
...
function c_all_opt() {
    ...
    if (document.getElementById('m_rebate_amount') != undefined) document.getElementById('form1').m_rebate_amount.value = ""
    if (document.getElementById('rebate_amount') != undefined) document.getElementById('form1').rebate_amount.value = ""
    if (document.getElementById('rebate_amount') != undefined) document.getElementById('form1').r_offer.value = ""
    if (document.getElementById('extra_rebate_amount') != undefined) document.getElementById('form1').extra_rebate_amount.value = ""
    if (document.getElementById('extra_rebate') != undefined) document.getElementById('form1').extra_rebate.value = ""
    if (document.getElementById('cancel_renew_0') != undefined) document.getElementById('form1').cancel_renew_0.checked = false
    if (document.getElementById('cancel_renew_1') != undefined) document.getElementById('form1').cancel_renew_1.checked = false
...
function load_hl() {
    if (document.getElementById('form1').d_date_Day_ID != undefined) {
        document.getElementById('form1').d_date_Day_ID.style.background = "#DDDDDD";
        document.getElementById('form1').d_date_Day_ID.disabled = true
    }

    if (document.getElementById('form1').d_date_Month != undefined) {
        document.getElementById('form1').d_date_Month.style.background = "#DDDDDD";
        document.getElementById('form1').d_date_Month.disabled = true
    }

    if (document.getElementById('form1').d_date_Year_ID != undefined) {
        document.getElementById('form1').d_date_Year_ID.style.background = "#DDDDDD";
        document.getElementById('form1').d_date_Year_ID.disabled = true
    }

    if (document.getElementById('form1').con_eff_date != undefined) {
        temp_con_eff_date = document.getElementById('form1').con_eff_date.value;
    }
}
...
function chk_save(ThisForm) {
    ...
    var GiftImei3Obj = document.getElementById('gift_imei3');
    var GiftImei4Obj = document.getElementById('gift_imei4');
    var AccessoryDescObj = document.getElementById('accessory_desc');
    ...
    var ChangePaymentTypeObj = document.getElementById('change_payment_type');
    ...
    if (bFlag) {
        try {
            if ((!ActionRequiredObj.checked && !ActionRequired2Obj.checked) && HsModelObj.value != "" && !document.getElementById('form1').d_region_0.checked && !document.getElementById('form1').d_region_1.checked && !document.getElementById('form1').d_region_2.checked && !document.getElementById('form1').d_region_3.checked) {
    ...
    if (bFlag) {
        try {
            if (ProgramObj.value != "GO WIRLESS" && HsModelObj.value == "" && (AccessoryImeiObj.value != "" || GiftImeiObj.value != "" || GiftImei2Obj.value != "" || GiftImei3Obj.value != "" || GiftImei4Obj.value != "")) {
                alert("Please release free gift or accessory IMEI!");
                event.returnValue = false;
                document.getElementById('form1').submit2.disabled = false;
                bFlag = false;
            }
    ...
    if (bFlag) {
        ...
        if ($("#program").val() == "IPHONE REBATE PLAN" || $("#program").val() == "STAFF OFFER (IPHONE REBATE)" || $("#program").val() == "IPAD SIM ONLY OFFER" || $("#program").val() == "MOBILE LITE (SIM ONLY)" || $("#program").val() == "MOBILE LITE (HS OFFER)"
|| $("#program").val() == "STAFF OFFER (IPHONE CONCIERGE SER)" || $("#program").val() == "IPHONE CONCIERGE SERVICE" || $("#program").val() == "MOBILEONE T3 RETENTION") {

            if ($("#sim_item_name1").val() != '' && $("#sim_item_code").val() == '') {
...
function third_party() {
    if (document.getElementById('remarks2EDF') != undefined) {
        if (document.getElementById('form1').third_party_credit_card[0].checked == true) {
            if (document.getElementById('third_party_id_type') != undefined) document.getElementById('form1').third_party_id_type.disabled = false;
            if (document.getElementById('third_party_hkid') != undefined) document.getElementById('form1').third_party_hkid.disabled = false;
            if (document.getElementById('third_party_hkid2') != undefined) document.getElementById('form1').third_party_hkid2.disabled = false;

            if (document.getElementById('third_party_id_type') != undefined) document.getElementById('form1').third_party_id_type.style.background = "#FFFFbb";
            if (document.getElementById('third_party_hkid') != undefined) document.getElementById('form1').third_party_hkid.style.background = "#FFFFbb";
            if (document.getElementById('third_party_hkid2') != undefined) document.getElementById('form1').third_party_hkid2.style.background = "#FFFFbb";
        }
        else {
            if (document.getElementById('third_party_id_type') != undefined) document.getElementById('form1').third_party_id_type.disabled = true;
            if (document.getElementById('third_party_hkid') != undefined) document.getElementById('form1').third_party_hkid.disabled = true;
            if (document.getElementById('third_party_hkid2') != undefined) document.getElementById('form1').third_party_hkid2.disabled = true;

            if (document.getElementById('third_party_id_type') != undefined) document.getElementById('form1').third_party_id_type.value = "";
            if (document.getElementById('third_party_hkid') != undefined) document.getElementById('form1').third_party_hkid.value = "";
            if (document.getElementById('third_party_hkid2') != undefined) document.getElementById('form1').third_party_hkid2.value = "";

            if (document.getElementById('third_party_id_type') != undefined) document.getElementById('form1').third_party_id_type.style.background = "#DDDDDD";
            if (document.getElementById('third_party_hkid') != undefined) document.getElementById('form1').third_party_hkid.style.background = "#DDDDDD";
            if (document.getElementById('third_party_hkid2') != undefined) document.getElementById('form1').third_party_hkid2.style.background = "#DDDDDD";
        }
    }
}
...
function ShowTable(tablename, tabname) {
    ...
    if (document.getElementById(tabname) != undefined) document.getElementById(tabname).style.color = "#FF0000";
