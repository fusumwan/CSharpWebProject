...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderIssueRestrictionRepository : MobileOrderIssueRestrictionRepositoryBase
    {
        public MobileOrderIssueRestrictionRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderIssueRestrictionRepository()
        {
        }
    }
}
