...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderMigrateRuleRepository : MobileOrderMigrateRuleRepositoryBase
    {
        public MobileOrderMigrateRuleRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderMigrateRuleRepository()
        {
        }
    }
}
