...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderMNPDetailRevisionRepository : MobileOrderMNPDetailRevisionRepositoryBase
    {
        public MobileOrderMNPDetailRevisionRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderMNPDetailRevisionRepository()
        {
        }
    }
}
