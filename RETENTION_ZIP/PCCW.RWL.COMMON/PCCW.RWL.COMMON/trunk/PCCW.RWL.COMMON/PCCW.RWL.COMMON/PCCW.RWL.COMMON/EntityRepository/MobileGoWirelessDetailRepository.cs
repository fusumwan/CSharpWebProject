...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileGoWirelessDetailRepository : MobileGoWirelessDetailRepositoryBase
    {
        public MobileGoWirelessDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileGoWirelessDetailRepository()
        {
        }
    }
}
