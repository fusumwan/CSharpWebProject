...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class CallListUploadMrtNoRepository : CallListUploadMrtNoRepositoryBase
    {
        public CallListUploadMrtNoRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~CallListUploadMrtNoRepository()
        {
        }
    }
}
