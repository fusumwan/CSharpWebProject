...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportStyleRepository : MobileOrderReportStyleRepositoryBase
    {
        public MobileOrderReportStyleRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportStyleRepository()
        {
        }
    }
}
