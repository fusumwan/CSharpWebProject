...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportDetailRepository : MobileOrderReportDetailRepositoryBase
    {
        public MobileOrderReportDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportDetailRepository()
        {
        }
    }
}
