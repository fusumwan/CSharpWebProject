...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class EventLetterDetailRepository : EventLetterDetailRepositoryBase
    {
        public EventLetterDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~EventLetterDetailRepository()
        {
        }
    }
}
