...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportTypeRepository : MobileOrderReportTypeRepositoryBase
    {
        public MobileOrderReportTypeRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportTypeRepository()
        {
        }
    }
}
