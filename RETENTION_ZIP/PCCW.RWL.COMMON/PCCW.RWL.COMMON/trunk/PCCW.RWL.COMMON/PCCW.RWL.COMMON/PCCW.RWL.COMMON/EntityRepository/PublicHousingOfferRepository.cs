...
namespace PCCW.RWL.CORE
{
    ...
    /// </summary>
    public class PublicHousingOfferRepository : PublicHousingOfferRepositoryBase
    {
        public PublicHousingOfferRepository(MSSQLConnect x_oDB)
            : base(x_oDB)
        {
            //
