...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class BusinessVasDefaultSetRepository : BusinessVasDefaultSetRepositoryBase
    {
        public BusinessVasDefaultSetRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~BusinessVasDefaultSetRepository()
        {
        }
    }
}
