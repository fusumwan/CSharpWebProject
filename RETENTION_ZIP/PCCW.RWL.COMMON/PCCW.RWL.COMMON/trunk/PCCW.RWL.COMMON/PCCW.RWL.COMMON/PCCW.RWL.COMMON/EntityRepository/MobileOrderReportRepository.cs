...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportRepository : MobileOrderReportRepositoryBase
    {
        public MobileOrderReportRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportRepository()
        {
        }
    }
}
