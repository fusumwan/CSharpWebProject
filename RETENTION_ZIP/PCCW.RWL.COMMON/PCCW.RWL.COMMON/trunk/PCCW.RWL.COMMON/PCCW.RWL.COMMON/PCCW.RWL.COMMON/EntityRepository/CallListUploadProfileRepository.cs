...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class CallListUploadProfileRepository : CallListUploadProfileRepositoryBase
    {
        public CallListUploadProfileRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~CallListUploadProfileRepository()
        {
        }
    }
}
