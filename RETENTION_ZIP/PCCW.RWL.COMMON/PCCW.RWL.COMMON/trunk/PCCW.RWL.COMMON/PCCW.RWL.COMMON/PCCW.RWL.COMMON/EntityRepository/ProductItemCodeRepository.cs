...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class ProductItemCodeRepository : ProductItemCodeRepositoryBase
    {
        public ProductItemCodeRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~ProductItemCodeRepository()
        {
        }
    }
}
