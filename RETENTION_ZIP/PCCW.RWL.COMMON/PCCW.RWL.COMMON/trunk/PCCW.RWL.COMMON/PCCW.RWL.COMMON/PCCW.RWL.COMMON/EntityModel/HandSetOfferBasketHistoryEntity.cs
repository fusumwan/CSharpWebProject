...
///-- Description:	<Description,Table :[HandSetOfferBasketHistory],Object Base layer>
...
namespace PCCW.RWL.CORE{
    ...
    /// <summary>
    /// Summary description for table [HandSetOfferBasketHistory] Object Base layer
    /// </summary>
    
    [global::System.Data.Linq.Mapping.Table(Name = Configurator.MSSQLTablePrefix+"HandSetOfferBasketHistory")]
    public class HandSetOfferBasketHistoryEntity: global::System.IDisposable ,global::NEURON.ENTITY.FRAMEWORK.IEntity<MSSQLConnect>{
        ...
        private HandSetOfferBasketHistoryInfo n_oTableSet = HandSetOfferBasketHistoryInfoDLL.CreateInfoInstanceObject();
        ...
        public class Para{
            ...
            public const string HandSetOfferBasketHistory_table_name="HandSetOfferBasketHistory";
            public static string TableName() { return HandSetOfferBasketHistory_table_name; }
        }
        #endregion Parameter String
        
        #region Constructor
        public HandSetOfferBasketHistoryEntity(){
            Init();
        }
        public HandSetOfferBasketHistoryEntity(MSSQLConnect x_oDB){
            n_oDB=x_oDB;
            Init();
        }
        
        public HandSetOfferBasketHistoryEntity(MSSQLConnect x_oDB,global::System.Nullable<int> x_iMid){
            n_oDB=x_oDB;
            this.Load(x_iMid);
            Init();
        }
        
        ~HandSetOfferBasketHistoryEntity(){
            this.Release();
        }
        #endregion
        ...
        public bool Load(global::System.Nullable<int> x_iMid){
            ...
            using(global::System.Data.SqlClient.SqlConnection _oConn = n_oDB.GetConnection()){
                ...
                try
                {
                    ...
                    {
                        n_bFound = true;
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_REC_NO"])) {n_iRec_no = (global::System.Nullable<int>)_oData["HANDSETOFFERBASKETHISTORY_REC_NO"];}else{n_iRec_no=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_MID"])) {n_iMid = (global::System.Nullable<int>)_oData["HANDSETOFFERBASKETHISTORY_MID"];}else{n_iMid=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_R_OFFER"])) {n_sR_offer = (string)_oData["HANDSETOFFERBASKETHISTORY_R_OFFER"];}else{n_sR_offer=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_EXTRA_REBATE_AMOUNT"])) {n_sExtra_rebate_amount = (string)_oData["HANDSETOFFERBASKETHISTORY_EXTRA_REBATE_AMOUNT"];}else{n_sExtra_rebate_amount=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_CDATE"])) {n_dCdate = (global::System.Nullable<DateTime>)_oData["HANDSETOFFERBASKETHISTORY_CDATE"];}else{n_dCdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_AMOUNT"])) {n_sAmount = (string)_oData["HANDSETOFFERBASKETHISTORY_AMOUNT"];}else{n_sAmount=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_CID"])) {n_sCid = (string)_oData["HANDSETOFFERBASKETHISTORY_CID"];}else{n_sCid=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_DID"])) {n_sDid = (string)_oData["HANDSETOFFERBASKETHISTORY_DID"];}else{n_sDid=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_SDATE"])) {n_dSdate = (global::System.Nullable<DateTime>)_oData["HANDSETOFFERBASKETHISTORY_SDATE"];}else{n_dSdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_PAYMENT"])) {n_sPayment = (string)_oData["HANDSETOFFERBASKETHISTORY_PAYMENT"];}else{n_sPayment=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_RETENTION_TYPE"])) {n_sRetention_type = (string)_oData["HANDSETOFFERBASKETHISTORY_RETENTION_TYPE"];}else{n_sRetention_type=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_EDATE"])) {n_dEdate = (global::System.Nullable<DateTime>)_oData["HANDSETOFFERBASKETHISTORY_EDATE"];}else{n_dEdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_CON_PER"])) {n_sCon_per = (string)_oData["HANDSETOFFERBASKETHISTORY_CON_PER"];}else{n_sCon_per=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_DDATE"])) {n_dDdate = (global::System.Nullable<DateTime>)_oData["HANDSETOFFERBASKETHISTORY_DDATE"];}else{n_dDdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_NORMAL_REBATE_TYPE"])) {n_sNormal_rebate_type = (string)_oData["HANDSETOFFERBASKETHISTORY_NORMAL_REBATE_TYPE"];}else{n_sNormal_rebate_type=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_PREMIUM"])) {n_sPremium = (string)_oData["HANDSETOFFERBASKETHISTORY_PREMIUM"];}else{n_sPremium=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_EXTRA_REBATE"])) {n_sExtra_rebate = (string)_oData["HANDSETOFFERBASKETHISTORY_EXTRA_REBATE"];}else{n_sExtra_rebate=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_REBATE_GP"])) {n_sRebate_gp = (string)_oData["HANDSETOFFERBASKETHISTORY_REBATE_GP"];}else{n_sRebate_gp=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_NORMAL_REBATE"])) {n_bNormal_rebate = (global::System.Nullable<bool>)_oData["HANDSETOFFERBASKETHISTORY_NORMAL_REBATE"];}else{n_bNormal_rebate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_HS_MODEL"])) {n_sHs_model = (string)_oData["HANDSETOFFERBASKETHISTORY_HS_MODEL"];}else{n_sHs_model=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_OFFER_TYPE_ID"])) {n_iOffer_type_id = (global::System.Nullable<int>)_oData["HANDSETOFFERBASKETHISTORY_OFFER_TYPE_ID"];}else{n_iOffer_type_id=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_ACTIVE"])) {n_bActive = (global::System.Nullable<bool>)_oData["HANDSETOFFERBASKETHISTORY_ACTIVE"];}else{n_bActive=null;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_REBATE_AMOUNT"])) {n_sRebate_amount = (string)_oData["HANDSETOFFERBASKETHISTORY_REBATE_AMOUNT"];}else{n_sRebate_amount=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_PLAN_FEE"])) {n_sPlan_fee = (string)_oData["HANDSETOFFERBASKETHISTORY_PLAN_FEE"];}else{n_sPlan_fee=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_ITEM_CODE"])) {n_sItem_code = (string)_oData["HANDSETOFFERBASKETHISTORY_ITEM_CODE"];}else{n_sItem_code=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["HANDSETOFFERBASKETHISTORY_ISSUE_TYPE"])) {n_sIssue_type = (string)_oData["HANDSETOFFERBASKETHISTORY_ISSUE_TYPE"];}else{n_sIssue_type=global::System.String.Empty;}
                    }
                    _oData.Close();
                    _oData.Dispose();
                }
        ...
        public object GetRepositoryObject(object x_oObj)
        {
            ...
            if (x_oObj.GetType().IsSubclassOf(typeof(HandSetOfferBasketHistoryEntity)) || (x_oObj is HandSetOfferBasketHistoryEntity)) return HandSetOfferBasketHistoryRepository.Instance();
            return null;
        }
        ...
        #region GetTableSet
        public HandSetOfferBasketHistoryInfo GetTableSet(){ return n_oTableSet; }
        #endregion GetTableSet
        
        
        #region SetTableSet
        public void SetTableSet(HandSetOfferBasketHistoryInfo value){ n_oTableSet=value; }
        ...
        public bool EqualID(HandSetOfferBasketHistory x_oObj)
        {
        ...
        public bool Equals(HandSetOfferBasketHistory x_oObj)
        {
            if (x_oObj == null) return false;
        ...
        public bool Save()
        {
            ...
            string _sQuery = "UPDATE  [HandSetOfferBasketHistory]  SET  [rec_no]=@rec_no,[r_offer]=@r_offer,[extra_rebate_amount]=@extra_rebate_amount,[cdate]=@cdate,[amount]=@amount,[cid]=@cid,[did]=@did,[sdate]=@sdate,[payment]=@payment,[retention_type]=@retention_type,[edate]=@edate,[con_per]=@con_per,[ddate]=@ddate,[normal_rebate_type]=@normal_rebate_type,[premium]=@premium,[extra_rebate]=@extra_rebate,[rebate_gp]=@rebate_gp,[normal_rebate]=@normal_rebate,[hs_model]=@hs_model,[offer_type_id]=@offer_type_id,[active]=@active,[rebate_amount]=@rebate_amount,[plan_fee]=@plan_fee,[item_code]=@item_code,[issue_type]=@issue_type  WHERE [HandSetOfferBasketHistory].[mid]=@mid";
            if (!"".Equals(Configurator.MSSQLTablePrefix)) { _sQuery = _sQuery.Replace("[HandSetOfferBasketHistory]","["+ Configurator.MSSQLTablePrefix + "HandSetOfferBasketHistory]"); }
            ...
            if(n_sRetention_type==null){  _oCmd.Parameters.Add("@retention_type", global::System.Data.SqlDbType.NChar,10).Value = DBNull.Value; }else{  _oCmd.Parameters.Add("@retention_type", global::System.Data.SqlDbType.NChar,10).Value=n_sRetention_type; }
        ...
        /// <summary>
        /// Summary description for table [HandSetOfferBasketHistory] Delete Record
        /// </summary>
        ...
        /// <summary>
        /// Summary description for table [HandSetOfferBasketHistory] Object Base Clone
        /// </summary>
        
        public HandSetOfferBasketHistory DeepClone()
        {
            HandSetOfferBasketHistory _oHandSetOfferBasketHistory_Clone = new HandSetOfferBasketHistory();
            _oHandSetOfferBasketHistory_Clone.rec_no = this.n_iRec_no;
            _oHandSetOfferBasketHistory_Clone.mid = this.n_iMid;
            _oHandSetOfferBasketHistory_Clone.r_offer = this.n_sR_offer;
            _oHandSetOfferBasketHistory_Clone.extra_rebate_amount = this.n_sExtra_rebate_amount;
            _oHandSetOfferBasketHistory_Clone.cdate = this.n_dCdate;
            _oHandSetOfferBasketHistory_Clone.amount = this.n_sAmount;
            _oHandSetOfferBasketHistory_Clone.cid = this.n_sCid;
            _oHandSetOfferBasketHistory_Clone.did = this.n_sDid;
            _oHandSetOfferBasketHistory_Clone.sdate = this.n_dSdate;
            _oHandSetOfferBasketHistory_Clone.payment = this.n_sPayment;
            _oHandSetOfferBasketHistory_Clone.retention_type = this.n_sRetention_type;
            _oHandSetOfferBasketHistory_Clone.edate = this.n_dEdate;
            _oHandSetOfferBasketHistory_Clone.con_per = this.n_sCon_per;
            _oHandSetOfferBasketHistory_Clone.ddate = this.n_dDdate;
            _oHandSetOfferBasketHistory_Clone.normal_rebate_type = this.n_sNormal_rebate_type;
            _oHandSetOfferBasketHistory_Clone.premium = this.n_sPremium;
            _oHandSetOfferBasketHistory_Clone.extra_rebate = this.n_sExtra_rebate;
            _oHandSetOfferBasketHistory_Clone.rebate_gp = this.n_sRebate_gp;
            _oHandSetOfferBasketHistory_Clone.normal_rebate = this.n_bNormal_rebate;
            _oHandSetOfferBasketHistory_Clone.hs_model = this.n_sHs_model;
            _oHandSetOfferBasketHistory_Clone.offer_type_id = this.n_iOffer_type_id;
            _oHandSetOfferBasketHistory_Clone.active = this.n_bActive;
            _oHandSetOfferBasketHistory_Clone.rebate_amount = this.n_sRebate_amount;
            _oHandSetOfferBasketHistory_Clone.plan_fee = this.n_sPlan_fee;
            _oHandSetOfferBasketHistory_Clone.item_code = this.n_sItem_code;
            _oHandSetOfferBasketHistory_Clone.issue_type = this.n_sIssue_type;
            _oHandSetOfferBasketHistory_Clone.SetFound(this.n_bFound);
            _oHandSetOfferBasketHistory_Clone.SetDB(this.n_oDB);
            _oHandSetOfferBasketHistory_Clone.SetRow(this.n_oRow);
            _oHandSetOfferBasketHistory_Clone.SetTbl(this.n_oTbl);
            _oHandSetOfferBasketHistory_Clone.SetTableSet(this.n_oTableSet);
            
            return _oHandSetOfferBasketHistory_Clone;
        }
        #endregion
        ...
        public void Release(){
            ...
            n_oTbl = null;
            n_oRow = null;
            n_oTableSet = HandSetOfferBasketHistoryInfoDLL.CreateInfoInstanceObject();
        }
        #endregion
    }
}
