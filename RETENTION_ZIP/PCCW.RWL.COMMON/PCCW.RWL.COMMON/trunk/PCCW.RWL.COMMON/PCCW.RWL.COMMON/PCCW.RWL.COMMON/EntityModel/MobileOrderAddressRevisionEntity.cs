...
namespace PCCW.RWL.CORE{
    ...
    [global::System.Data.Linq.Mapping.Table(Name = Configurator.MSSQLTablePrefix+"MobileOrderAddressRevision")]
    public class MobileOrderAddressRevisionEntity: global::System.IDisposable ,global::NEURON.ENTITY.FRAMEWORK.IEntity<MSSQLConnect>{
        ...
        private MobileOrderAddressRevisionInfo n_oTableSet = MobileOrderAddressRevisionInfoDLL.CreateInfoInstanceObject();
        ...
        public class Para{
            ...
            public const string MobileOrderAddressRevision_table_name="MobileOrderAddressRevision";
            public static string TableName() { return MobileOrderAddressRevision_table_name; }
        }
        #endregion Parameter String
        
        #region Constructor
        public MobileOrderAddressRevisionEntity(){
            Init();
        }
        public MobileOrderAddressRevisionEntity(MSSQLConnect x_oDB){
            n_oDB=x_oDB;
            Init();
        }
        
        public MobileOrderAddressRevisionEntity(MSSQLConnect x_oDB,global::System.Nullable<long> x_lMid){
            n_oDB=x_oDB;
            this.Load(x_lMid);
            Init();
        }
        
        ~MobileOrderAddressRevisionEntity(){
            this.Release();
        }
        #endregion
        ...
        public bool Load(global::System.Nullable<long> x_lMid){
            ...
            using(global::System.Data.SqlClient.SqlConnection _oConn = n_oDB.GetConnection()){
                ...
                try
                {
                    ...
                    {
                        n_bFound = true;
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_BUILD"])) {n_sD_build = (string)_oData["MOBILEORDERADDRESSREVISION_D_BUILD"];}else{n_sD_build=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_STREET"])) {n_sD_street = (string)_oData["MOBILEORDERADDRESSREVISION_D_STREET"];}else{n_sD_street=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_DISTRICT"])) {n_sD_district = (string)_oData["MOBILEORDERADDRESSREVISION_D_DISTRICT"];}else{n_sD_district=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_REGION"])) {n_sD_region = (string)_oData["MOBILEORDERADDRESSREVISION_D_REGION"];}else{n_sD_region=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_FLOOR"])) {n_sD_floor = (string)_oData["MOBILEORDERADDRESSREVISION_D_FLOOR"];}else{n_sD_floor=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_ROOM"])) {n_sD_room = (string)_oData["MOBILEORDERADDRESSREVISION_D_ROOM"];}else{n_sD_room=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_ORDER_ID"])) {n_iOrder_id = (global::System.Nullable<int>)_oData["MOBILEORDERADDRESSREVISION_ORDER_ID"];}else{n_iOrder_id=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_ADDRESS_TYPE"])) {n_sAddress_type = (string)_oData["MOBILEORDERADDRESSREVISION_ADDRESS_TYPE"];}else{n_sAddress_type=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_TYPE"])) {n_sD_type = (string)_oData["MOBILEORDERADDRESSREVISION_D_TYPE"];}else{n_sD_type=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_ADDRESS_ID"])) {n_lAddress_id = (global::System.Nullable<long>)_oData["MOBILEORDERADDRESSREVISION_ADDRESS_ID"];}else{n_lAddress_id=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_MID"])) {n_lMid = (global::System.Nullable<long>)_oData["MOBILEORDERADDRESSREVISION_MID"];}else{n_lMid=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERADDRESSREVISION_D_BLK"])) {n_sD_blk = (string)_oData["MOBILEORDERADDRESSREVISION_D_BLK"];}else{n_sD_blk=global::System.String.Empty;}
                    }
                    _oData.Close();
                    _oData.Dispose();
                }
        ...
        public object GetRepositoryObject(object x_oObj)
        {
            ...
            if (x_oObj.GetType().IsSubclassOf(typeof(MobileOrderAddressRevisionEntity)) || (x_oObj is MobileOrderAddressRevisionEntity)) return MobileOrderAddressRevisionRepository.Instance();
            return null;
        }
        ...
        #region GetTableSet
        public MobileOrderAddressRevisionInfo GetTableSet(){ return n_oTableSet; }
        #endregion GetTableSet
        
        
        #region SetTableSet
        public void SetTableSet(MobileOrderAddressRevisionInfo value){ n_oTableSet=value; }
        ...
        public bool EqualID(MobileOrderAddressRevision x_oObj)
        {
        ...
        public bool Equals(MobileOrderAddressRevision x_oObj)
        {
            if (x_oObj == null) return false;
        ...
        public bool Save()
        {
            ...
            string _sQuery = "UPDATE  [MobileOrderAddressRevision]  SET  [d_build]=@d_build,[d_street]=@d_street,[d_district]=@d_district,[d_region]=@d_region,[d_floor]=@d_floor,[d_room]=@d_room,[order_id]=@order_id,[address_type]=@address_type,[d_type]=@d_type,[address_id]=@address_id,[d_blk]=@d_blk  WHERE [MobileOrderAddressRevision].[mid]=@mid";
            if (!"".Equals(Configurator.MSSQLTablePrefix)) { _sQuery = _sQuery.Replace("[MobileOrderAddressRevision]","["+ Configurator.MSSQLTablePrefix + "MobileOrderAddressRevision]"); }
        ...
        /// <summary>
        /// Summary description for table [MobileOrderAddressRevision] Delete Record
        /// </summary>
        ...
        /// <summary>
        /// Summary description for table [MobileOrderAddressRevision] Object Base Clone
        /// </summary>
        
        public MobileOrderAddressRevision DeepClone()
        {
            MobileOrderAddressRevision _oMobileOrderAddressRevision_Clone = new MobileOrderAddressRevision();
            _oMobileOrderAddressRevision_Clone.d_build = this.n_sD_build;
            _oMobileOrderAddressRevision_Clone.d_street = this.n_sD_street;
            _oMobileOrderAddressRevision_Clone.d_district = this.n_sD_district;
            _oMobileOrderAddressRevision_Clone.d_region = this.n_sD_region;
            _oMobileOrderAddressRevision_Clone.d_floor = this.n_sD_floor;
            _oMobileOrderAddressRevision_Clone.d_room = this.n_sD_room;
            _oMobileOrderAddressRevision_Clone.order_id = this.n_iOrder_id;
            _oMobileOrderAddressRevision_Clone.address_type = this.n_sAddress_type;
            _oMobileOrderAddressRevision_Clone.d_type = this.n_sD_type;
            _oMobileOrderAddressRevision_Clone.address_id = this.n_lAddress_id;
            _oMobileOrderAddressRevision_Clone.mid = this.n_lMid;
            _oMobileOrderAddressRevision_Clone.d_blk = this.n_sD_blk;
            _oMobileOrderAddressRevision_Clone.SetFound(this.n_bFound);
            _oMobileOrderAddressRevision_Clone.SetDB(this.n_oDB);
            _oMobileOrderAddressRevision_Clone.SetRow(this.n_oRow);
            _oMobileOrderAddressRevision_Clone.SetTbl(this.n_oTbl);
            _oMobileOrderAddressRevision_Clone.SetTableSet(this.n_oTableSet);
            
            return _oMobileOrderAddressRevision_Clone;
        }
        #endregion
        ...
        public void Release(){
            ...
            n_oTbl = null;
            n_oRow = null;
            n_oTableSet = MobileOrderAddressRevisionInfoDLL.CreateInfoInstanceObject();
        }
        #endregion
    }
}
