...
///-- Description:	<Description,Table :[MobileOrderReportDetail], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderReportDetail] Information layer
    /// </summary>
    public abstract class MobileOrderReportDetailInfoDLL{
        ...
        public static MobileOrderReportDetailInfo CreateInfoInstanceObject(){
            return new MobileOrderReportDetailInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderReportDetailInfoDLL(){
            Init();
        }
        ~MobileOrderReportDetailInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderReportDetail.Para.TableName();
            ...
            // [order_status] Field
            _sStrFldName = MobileOrderReportDetail.Para.order_status;
            ...
            // [fallout_reply] Field
            _sStrFldName = MobileOrderReportDetail.Para.fallout_reply;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mflag] Field
            _sStrFldName = MobileOrderReportDetail.Para.mflag;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [email_date] Field
            _sStrFldName = MobileOrderReportDetail.Para.email_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_cnt] Field
            _sStrFldName = MobileOrderReportDetail.Para.retrieve_cnt;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderReportDetail.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_sn] Field
            _sStrFldName = MobileOrderReportDetail.Para.retrieve_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileOrderReportDetail.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = MobileOrderReportDetail.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [eid] Field
            _sStrFldName = MobileOrderReportDetail.Para.eid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [report_id] Field
            _sStrFldName = MobileOrderReportDetail.Para.report_id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [active] Field
            _sStrFldName = MobileOrderReportDetail.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReportDetail.Para.fallout_reason;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReportDetail.Para.fallout_remark;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReportDetail.Para.fallout_main_category;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [report_type] Field
            _sStrFldName = MobileOrderReportDetail.Para.report_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [reactive_sn] Field
            _sStrFldName = MobileOrderReportDetail.Para.reactive_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = MobileOrderReportDetail.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mdate] Field
            _sStrFldName = MobileOrderReportDetail.Para.mdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [reactive_date] Field
            _sStrFldName = MobileOrderReportDetail.Para.reactive_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileOrderReportDetail.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_date] Field
            _sStrFldName = MobileOrderReportDetail.Para.retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetOrder_statusTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.order_status);
        }
        public Field GetFallout_replyTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.fallout_reply);
        }
        public Field GetMflagTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.mflag);
        }
        public Field GetEmail_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.email_date);
        }
        public Field GetRetrieve_cntTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.retrieve_cnt);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.cdate);
        }
        public Field GetRetrieve_snTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.retrieve_sn);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.did);
        }
        public Field GetEidTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.eid);
        }
        public Field GetReport_idTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.report_id);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.active);
        }
        public Field GetFallout_reasonTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.fallout_reason);
        }
        public Field GetFallout_remarkTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.fallout_remark);
        }
        public Field GetFallout_main_categoryTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.fallout_main_category);
        }
        public Field GetReport_typeTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.report_type);
        }
        public Field GetReactive_snTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.reactive_sn);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.ddate);
        }
        public Field GetMdateTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.mdate);
        }
        public Field GetReactive_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.reactive_date);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.order_id);
        }
        public Field GetRetrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportDetail.Para.retrieve_date);
        }
