...
///-- Description:	<Description,Table :[DeliveryLocation], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [DeliveryLocation] Information layer
    /// </summary>
    public abstract class DeliveryLocationInfoDLL{
        ...
        public static DeliveryLocationInfo CreateInfoInstanceObject(){
            return new DeliveryLocationInfo();
        }
        #endregion
        #region Constructor
        
        public DeliveryLocationInfoDLL(){
            Init();
        }
        ~DeliveryLocationInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = DeliveryLocation.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = DeliveryLocation.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = DeliveryLocation.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = DeliveryLocation.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [location] Field
            _sStrFldName = DeliveryLocation.Para.location;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fee] Field
            _sStrFldName = DeliveryLocation.Para.fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [area] Field
            _sStrFldName = DeliveryLocation.Para.area;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = DeliveryLocation.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(DeliveryLocation.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(DeliveryLocation.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(DeliveryLocation.Para.cid);
        }
        public Field GetLocationTable(){
            return n_oTableSet.Fields(DeliveryLocation.Para.location);
        }
        public Field GetFeeTable(){
            return n_oTableSet.Fields(DeliveryLocation.Para.fee);
        }
        public Field GetAreaTable(){
            return n_oTableSet.Fields(DeliveryLocation.Para.area);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(DeliveryLocation.Para.active);
        }
