...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileRetentionOrderAddRuleExceptionListInfoDLL{
        ...
        public static MobileRetentionOrderAddRuleExceptionListInfo CreateInfoInstanceObject(){
            return new MobileRetentionOrderAddRuleExceptionListInfo();
        }
        #endregion
        #region Constructor
        
        public MobileRetentionOrderAddRuleExceptionListInfoDLL(){
            Init();
        }
        ~MobileRetentionOrderAddRuleExceptionListInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileRetentionOrderAddRuleExceptionList.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mrt_no] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [filename] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.filename;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[filename]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "filename";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[filename]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "filename";
            n_oTableSet.Fields(_sStrFldName).AliasName = "filename";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "filename";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [used] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.used;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = MobileRetentionOrderAddRuleExceptionList.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.cid);
        }
        public Field GetMrt_noTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.mrt_no);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.active);
        }
        public Field GetFilenameTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.filename);
        }
        public Field GetUsedTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.used);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.order_id);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.ddate);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(MobileRetentionOrderAddRuleExceptionList.Para.did);
        }
