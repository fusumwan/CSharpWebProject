...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class BusinessTradeExperienceInfoDLL{
        ...
        public static BusinessTradeExperienceInfo CreateInfoInstanceObject(){
            return new BusinessTradeExperienceInfo();
        }
        #endregion
        #region Constructor
        
        public BusinessTradeExperienceInfoDLL(){
            Init();
        }
        ~BusinessTradeExperienceInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = BusinessTradeExperience.Para.TableName();
            ...
            // [rec_no] Field
            _sStrFldName = BusinessTradeExperience.Para.rec_no;
            ...
            // [mid] Field
            _sStrFldName = BusinessTradeExperience.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [channel] Field
            _sStrFldName = BusinessTradeExperience.Para.channel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cdate] Field
            _sStrFldName = BusinessTradeExperience.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bundle_name] Field
            _sStrFldName = BusinessTradeExperience.Para.bundle_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hs_model_name] Field
            _sStrFldName = BusinessTradeExperience.Para.hs_model_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [trade_field] Field
            _sStrFldName = BusinessTradeExperience.Para.trade_field;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = BusinessTradeExperience.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [premium_1] Field
            _sStrFldName = BusinessTradeExperience.Para.premium_1;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sdate] Field
            _sStrFldName = BusinessTradeExperience.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rebate] Field
            _sStrFldName = BusinessTradeExperience.Para.rebate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [premium_2] Field
            _sStrFldName = BusinessTradeExperience.Para.premium_2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = BusinessTradeExperience.Para.retention_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [extra_offer] Field
            _sStrFldName = BusinessTradeExperience.Para.extra_offer;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = BusinessTradeExperience.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [program] Field
            _sStrFldName = BusinessTradeExperience.Para.program;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [con_per] Field
            _sStrFldName = BusinessTradeExperience.Para.con_per;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rate_plan] Field
            _sStrFldName = BusinessTradeExperience.Para.rate_plan;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = BusinessTradeExperience.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = BusinessTradeExperience.Para.normal_rebate_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = BusinessTradeExperience.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [free_mon] Field
            _sStrFldName = BusinessTradeExperience.Para.free_mon;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = BusinessTradeExperience.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cancel_renew] Field
            _sStrFldName = BusinessTradeExperience.Para.cancel_renew;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ob_early] Field
            _sStrFldName = BusinessTradeExperience.Para.ob_early;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [normal_rebate] Field
            _sStrFldName = BusinessTradeExperience.Para.normal_rebate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hs_model] Field
            _sStrFldName = BusinessTradeExperience.Para.hs_model;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [plan_fee] Field
            _sStrFldName = BusinessTradeExperience.Para.plan_fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [po_date] Field
            _sStrFldName = BusinessTradeExperience.Para.po_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [remarks] Field
            _sStrFldName = BusinessTradeExperience.Para.remarks;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [issue_type] Field
            _sStrFldName = BusinessTradeExperience.Para.issue_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetRec_noTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.rec_no);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.mid);
        }
        public Field GetChannelTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.channel);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.cdate);
        }
        public Field GetBundle_nameTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.bundle_name);
        }
        public Field GetHs_model_nameTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.hs_model_name);
        }
        public Field GetTrade_fieldTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.trade_field);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.did);
        }
        public Field GetPremium_1Table(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.premium_1);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.sdate);
        }
        public Field GetRebateTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.rebate);
        }
        public Field GetPremium_2Table(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.premium_2);
        }
        public Field GetRetention_typeTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.retention_type);
        }
        public Field GetExtra_offerTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.extra_offer);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.edate);
        }
        public Field GetProgramTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.program);
        }
        public Field GetCon_perTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.con_per);
        }
        public Field GetRate_planTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.rate_plan);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.ddate);
        }
        public Field GetNormal_rebate_typeTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.normal_rebate_type);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.active);
        }
        public Field GetFree_monTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.free_mon);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.cid);
        }
        public Field GetCancel_renewTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.cancel_renew);
        }
        public Field GetOb_earlyTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.ob_early);
        }
        public Field GetNormal_rebateTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.normal_rebate);
        }
        public Field GetHs_modelTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.hs_model);
        }
        public Field GetPlan_feeTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.plan_fee);
        }
        public Field GetPo_dateTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.po_date);
        }
        public Field GetRemarksTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.remarks);
        }
        public Field GetIssue_typeTable(){
            return n_oTableSet.Fields(BusinessTradeExperience.Para.issue_type);
        }
