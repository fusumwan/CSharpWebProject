...
///-- Description:	<Description,Table :[MobileOrderMigrateRule], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderMigrateRule] Information layer
    /// </summary>
    public abstract class MobileOrderMigrateRuleInfoDLL{
        ...
        public static MobileOrderMigrateRuleInfo CreateInfoInstanceObject(){
            return new MobileOrderMigrateRuleInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderMigrateRuleInfoDLL(){
            Init();
        }
        ~MobileOrderMigrateRuleInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderMigrateRule.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = MobileOrderMigrateRule.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderMigrateRule.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = MobileOrderMigrateRule.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = MobileOrderMigrateRule.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [status] Field
            _sStrFldName = MobileOrderMigrateRule.Para.status;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [type] Field
            _sStrFldName = MobileOrderMigrateRule.Para.type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [chk] Field
            _sStrFldName = MobileOrderMigrateRule.Para.chk;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[chk]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "chk";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[chk]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "chk";
            n_oTableSet.Fields(_sStrFldName).AliasName = "chk";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "chk";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [active] Field
            _sStrFldName = MobileOrderMigrateRule.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [name] Field
            _sStrFldName = MobileOrderMigrateRule.Para.name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sku] Field
            _sStrFldName = MobileOrderMigrateRule.Para.sku;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = MobileOrderMigrateRule.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.did);
        }
        public Field GetStatusTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.status);
        }
        public Field GetTypeTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.type);
        }
        public Field GetChkTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.chk);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.active);
        }
        public Field GetNameTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.name);
        }
        public Field GetSkuTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.sku);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(MobileOrderMigrateRule.Para.ddate);
        }
