...
///-- Description:	<Description,Table :[HandSetOfferType], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [HandSetOfferType] Information layer
    /// </summary>
    public abstract class HandSetOfferTypeInfoDLL{
        ...
        public static HandSetOfferTypeInfo CreateInfoInstanceObject(){
            return new HandSetOfferTypeInfo();
        }
        #endregion
        #region Constructor
        
        public HandSetOfferTypeInfoDLL(){
            Init();
        }
        ~HandSetOfferTypeInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = HandSetOfferType.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = HandSetOfferType.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = HandSetOfferType.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = HandSetOfferType.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = HandSetOfferType.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [expiry_chk] Field
            _sStrFldName = HandSetOfferType.Para.expiry_chk;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[expiry_chk]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "expiry_chk";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[expiry_chk]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "expiry_chk";
            n_oTableSet.Fields(_sStrFldName).AliasName = "expiry_chk";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "expiry_chk";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [active] Field
            _sStrFldName = HandSetOfferType.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [name] Field
            _sStrFldName = HandSetOfferType.Para.name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = HandSetOfferType.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = HandSetOfferType.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sdate] Field
            _sStrFldName = HandSetOfferType.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.did);
        }
        public Field GetExpiry_chkTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.expiry_chk);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.active);
        }
        public Field GetNameTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.name);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.edate);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.ddate);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(HandSetOfferType.Para.sdate);
        }
