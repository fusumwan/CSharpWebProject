...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class CallListUploadMrtNoInfoDLL{
        ...
        public static CallListUploadMrtNoInfo CreateInfoInstanceObject(){
            return new CallListUploadMrtNoInfo();
        }
        #endregion
        #region Constructor
        
        public CallListUploadMrtNoInfoDLL(){
            Init();
        }
        ~CallListUploadMrtNoInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = CallListUploadMrtNo.Para.TableName();
            ...
            // [cdate] Field
            _sStrFldName = CallListUploadMrtNo.Para.cdate;
            ...
            // [mrt_no] Field
            _sStrFldName = CallListUploadMrtNo.Para.mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = CallListUploadMrtNo.Para.call_list_program_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [id] Field
            _sStrFldName = CallListUploadMrtNo.Para.id;
            n_oTableSet.Add(_sStrFldName);
        ...
        public Field GetCdateTable(){
            return n_oTableSet.Fields(CallListUploadMrtNo.Para.cdate);
        }
        public Field GetMrt_noTable(){
            return n_oTableSet.Fields(CallListUploadMrtNo.Para.mrt_no);
        }
        public Field GetCall_list_program_idTable(){
            return n_oTableSet.Fields(CallListUploadMrtNo.Para.call_list_program_id);
        }
        public Field GetIdTable(){
            return n_oTableSet.Fields(CallListUploadMrtNo.Para.id);
        }
