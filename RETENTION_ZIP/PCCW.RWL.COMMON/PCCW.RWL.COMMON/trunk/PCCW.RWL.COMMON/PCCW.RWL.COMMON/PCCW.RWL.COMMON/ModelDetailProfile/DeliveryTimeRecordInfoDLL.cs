...
///-- Description:	<Description,Table :[DeliveryTimeRecord], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE
{

    /// <summary>
    /// Summary description for table [DeliveryTimeRecord] Information layer
    /// </summary>
    public abstract class DeliveryTimeRecordInfoDLL
    {
        ...
        public static DeliveryTimeRecordInfo CreateInfoInstanceObject()
        {
            return new DeliveryTimeRecordInfo();
        }
        #endregion
        #region Constructor

        public DeliveryTimeRecordInfoDLL()
        {
            Init();
        }
        ~DeliveryTimeRecordInfoDLL()
        {
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = DeliveryTimeRecord.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = DeliveryTimeRecord.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = DeliveryTimeRecord.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = DeliveryTimeRecord.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = DeliveryTimeRecord.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [pm8_10] Field
            _sStrFldName = DeliveryTimeRecord.Para.pm8_10;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[pm8_10]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "pm8_10";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[pm8_10]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "pm8_10";
            n_oTableSet.Fields(_sStrFldName).AliasName = "pm8_10";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "pm8_10";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [location] Field
            _sStrFldName = DeliveryTimeRecord.Para.location;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[location]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "location";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[location]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "location";
            n_oTableSet.Fields(_sStrFldName).AliasName = "location";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "location";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [pm7_9] Field
            _sStrFldName = DeliveryTimeRecord.Para.pm7_9;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[pm7_9]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "pm7_9";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[pm7_9]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "pm7_9";
            n_oTableSet.Fields(_sStrFldName).AliasName = "pm7_9";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "pm7_9";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [area] Field
            _sStrFldName = DeliveryTimeRecord.Para.area;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[area]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "area";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[area]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "area";
            n_oTableSet.Fields(_sStrFldName).AliasName = "area";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "area";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [pm6_8] Field
            _sStrFldName = DeliveryTimeRecord.Para.pm6_8;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[pm6_8]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "pm6_8";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[pm6_8]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "pm6_8";
            n_oTableSet.Fields(_sStrFldName).AliasName = "pm6_8";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "pm6_8";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [pm] Field
            _sStrFldName = DeliveryTimeRecord.Para.pm;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[pm]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "pm";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[pm]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "pm";
            n_oTableSet.Fields(_sStrFldName).AliasName = "pm";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "pm";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [am] Field
            _sStrFldName = DeliveryTimeRecord.Para.am;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[am]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "am";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[am]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "am";
            n_oTableSet.Fields(_sStrFldName).AliasName = "am";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "am";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [ddate] Field
            _sStrFldName = DeliveryTimeRecord.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = DeliveryTimeRecord.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [delivery_fee] Field
            _sStrFldName = DeliveryTimeRecord.Para.delivery_fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[delivery_fee]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "delivery_fee";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[delivery_fee]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "delivery_fee";
            n_oTableSet.Fields(_sStrFldName).AliasName = "delivery_fee";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "delivery_fee";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.id);
        }
        public Field GetCdateTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.cdate);
        }
        public Field GetCidTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.cid);
        }
        public Field GetActiveTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.active);
        }
        public Field GetPm8_10Table()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.pm8_10);
        }
        public Field GetLocationTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.location);
        }
        public Field GetPm7_9Table()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.pm7_9);
        }
        public Field GetAreaTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.area);
        }
        public Field GetPm6_8Table()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.pm6_8);
        }
        public Field GetPmTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.pm);
        }
        public Field GetAmTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.am);
        }
        public Field GetDdateTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.ddate);
        }
        public Field GetDidTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.did);
        }
        public Field GetDelivery_feeTable()
        {
            return n_oTableSet.Fields(DeliveryTimeRecord.Para.delivery_fee);
        }
