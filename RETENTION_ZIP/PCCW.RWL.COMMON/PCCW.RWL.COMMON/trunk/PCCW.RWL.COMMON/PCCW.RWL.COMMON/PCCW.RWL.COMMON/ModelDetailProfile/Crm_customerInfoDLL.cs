...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class Crm_customerInfoDLL{
        ...
        public static Crm_customerInfo CreateInfoInstanceObject()
        {
            return new Crm_customerInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = Crm_customer.Para.TableName();
            ...
            // [active] Field
            _sStrFldName = Crm_customer.Para.active;
            ...
            // [cdate] Field
            _sStrFldName = Crm_customer.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = Crm_customer.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = Crm_customer.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cust_type] Field
            _sStrFldName = Crm_customer.Para.cust_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cust_title] Field
            _sStrFldName = Crm_customer.Para.cust_title;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[cust_title]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "cust_title";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[cust_title]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "cust_title";
            n_oTableSet.Fields(_sStrFldName).AliasName = "cust_title";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "cust_title";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [id_type] Field
            _sStrFldName = Crm_customer.Para.id_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [con_email] Field
            _sStrFldName = Crm_customer.Para.con_email;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[con_email]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "con_email";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[con_email]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "con_email";
            n_oTableSet.Fields(_sStrFldName).AliasName = "con_email";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "con_email";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [cust_id] Field
            _sStrFldName = Crm_customer.Para.cust_id;
            n_oTableSet.Add(_sStrFldName);
            ...
            n_oTableSet.Fields(_sStrFldName).FieldName = "[cust_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "cust_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[cust_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "cust_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "cust_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "cust_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            ...
            // [cust_name] Field
            _sStrFldName = Crm_customer.Para.cust_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = Crm_customer.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [tel_night] Field
            _sStrFldName = Crm_customer.Para.tel_night;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[tel_night]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "tel_night";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[tel_night]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "tel_night";
            n_oTableSet.Fields(_sStrFldName).AliasName = "tel_night";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "tel_night";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [tel_day] Field
            _sStrFldName = Crm_customer.Para.tel_day;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[tel_day]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "tel_day";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[tel_day]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "tel_day";
            n_oTableSet.Fields(_sStrFldName).AliasName = "tel_day";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "tel_day";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [fr_cl] Field
            _sStrFldName = Crm_customer.Para.fr_cl;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[fr_cl]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "fr_cl";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[fr_cl]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "fr_cl";
            n_oTableSet.Fields(_sStrFldName).AliasName = "fr_cl";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "fr_cl";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [hkid_br] Field
            _sStrFldName = Crm_customer.Para.hkid_br;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[hkid_br]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "hkid_br";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[hkid_br]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "hkid_br";
            n_oTableSet.Fields(_sStrFldName).AliasName = "hkid_br";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "hkid_br";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        public Field GetActiveTable(){
            return n_oTableSet.Fields(Crm_customer.Para.active);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(Crm_customer.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(Crm_customer.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(Crm_customer.Para.did);
        }
        public Field GetCust_typeTable(){
            return n_oTableSet.Fields(Crm_customer.Para.cust_type);
        }
        public Field GetCust_titleTable(){
            return n_oTableSet.Fields(Crm_customer.Para.cust_title);
        }
        public Field GetId_typeTable(){
            return n_oTableSet.Fields(Crm_customer.Para.id_type);
        }
        public Field GetCon_emailTable(){
            return n_oTableSet.Fields(Crm_customer.Para.con_email);
        }
        public Field GetCust_idTable(){
            return n_oTableSet.Fields(Crm_customer.Para.cust_id);
        }
        public Field GetCust_nameTable(){
            return n_oTableSet.Fields(Crm_customer.Para.cust_name);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(Crm_customer.Para.ddate);
        }
        public Field GetTel_nightTable(){
            return n_oTableSet.Fields(Crm_customer.Para.tel_night);
        }
        public Field GetTel_dayTable(){
            return n_oTableSet.Fields(Crm_customer.Para.tel_day);
        }
        public Field GetFr_clTable(){
            return n_oTableSet.Fields(Crm_customer.Para.fr_cl);
        }
        public Field GetHkid_brTable(){
            return n_oTableSet.Fields(Crm_customer.Para.hkid_br);
        }
