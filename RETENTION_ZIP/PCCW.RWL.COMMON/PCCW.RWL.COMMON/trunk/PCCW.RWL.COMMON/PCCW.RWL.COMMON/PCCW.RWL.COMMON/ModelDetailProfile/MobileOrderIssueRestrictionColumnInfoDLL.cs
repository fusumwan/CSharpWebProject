...
///-- Description:	<Description,Table :[MobileOrderIssueRestrictionColumn], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderIssueRestrictionColumn] Information layer
    /// </summary>
    public abstract class MobileOrderIssueRestrictionColumnInfoDLL{
        ...
        public static MobileOrderIssueRestrictionColumnInfo CreateInfoInstanceObject(){
            return new MobileOrderIssueRestrictionColumnInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderIssueRestrictionColumnInfoDLL(){
            Init();
        }
        ~MobileOrderIssueRestrictionColumnInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderIssueRestrictionColumn.Para.TableName();
            ...
            // [active] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.active;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [restriction_id] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.restriction_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[restriction_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "restriction_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[restriction_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "restriction_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "restriction_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "restriction_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [restriction_column] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.restriction_column;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[restriction_column]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "restriction_column";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[restriction_column]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "restriction_column";
            n_oTableSet.Fields(_sStrFldName).AliasName = "restriction_column";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "restriction_column";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [restriction_value] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.restriction_value;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[restriction_value]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "restriction_value";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[restriction_value]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "restriction_value";
            n_oTableSet.Fields(_sStrFldName).AliasName = "restriction_value";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "restriction_value";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [restriction_table] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.restriction_table;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[restriction_table]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "restriction_table";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[restriction_table]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "restriction_table";
            n_oTableSet.Fields(_sStrFldName).AliasName = "restriction_table";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "restriction_table";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [action_type] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.action_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[action_type]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "action_type";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[action_type]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "action_type";
            n_oTableSet.Fields(_sStrFldName).AliasName = "action_type";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "action_type";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [mid] Field
            _sStrFldName = MobileOrderIssueRestrictionColumn.Para.mid;
            n_oTableSet.Add(_sStrFldName);
        ...
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.active);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.cid);
        }
        public Field GetRestriction_idTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.restriction_id);
        }
        public Field GetRestriction_columnTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.restriction_column);
        }
        public Field GetRestriction_valueTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.restriction_value);
        }
        public Field GetRestriction_tableTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.restriction_table);
        }
        public Field GetAction_typeTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.action_type);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionColumn.Para.mid);
        }
