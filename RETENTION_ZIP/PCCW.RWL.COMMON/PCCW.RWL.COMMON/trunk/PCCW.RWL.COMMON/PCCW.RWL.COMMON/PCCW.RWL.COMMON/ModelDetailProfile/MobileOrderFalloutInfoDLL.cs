...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileOrderFalloutInfoDLL{
        ...
        public static MobileOrderFalloutInfo CreateInfoInstanceObject(){
            return new MobileOrderFalloutInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderFalloutInfoDLL(){
            Init();
        }
        ~MobileOrderFalloutInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderFallout.Para.TableName();
            ...
            // [active] Field
            _sStrFldName = MobileOrderFallout.Para.active;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderFallout.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileOrderFallout.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = MobileOrderFallout.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = MobileOrderFallout.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fo_reason] Field
            _sStrFldName = MobileOrderFallout.Para.fo_reason;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[fo_reason]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "fo_reason";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[fo_reason]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "fo_reason";
            n_oTableSet.Fields(_sStrFldName).AliasName = "fo_reason";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "fo_reason";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [mid] Field
            _sStrFldName = MobileOrderFallout.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [follow_by] Field
            _sStrFldName = MobileOrderFallout.Para.follow_by;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[follow_by]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "follow_by";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[follow_by]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "follow_by";
            n_oTableSet.Fields(_sStrFldName).AliasName = "follow_by";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "follow_by";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.active);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.did);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.ddate);
        }
        public Field GetFo_reasonTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.fo_reason);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.mid);
        }
        public Field GetFollow_byTable(){
            return n_oTableSet.Fields(MobileOrderFallout.Para.follow_by);
        }
