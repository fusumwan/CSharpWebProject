...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class BusinessVasNameRecordInfoDLL{
        ...
        public BusinessVasNameRecordInfoDLL(){
            Init();
        }
        ~BusinessVasNameRecordInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static BusinessVasNameRecordInfo CreateInfoInstanceObject()
        {
            return new BusinessVasNameRecordInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = BusinessVasNameRecord.Para.TableName();
            ...
            // [vas_field] Field
            _sStrFldName = BusinessVasNameRecord.Para.vas_field;
            ...
            // [vas_name] Field
            _sStrFldName = BusinessVasNameRecord.Para.vas_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [id] Field
            _sStrFldName = BusinessVasNameRecord.Para.id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [active] Field
            _sStrFldName = BusinessVasNameRecord.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas_chi_name] Field
            _sStrFldName = BusinessVasNameRecord.Para.vas_chi_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetVas_fieldTable(){
            return n_oTableSet.Fields(BusinessVasNameRecord.Para.vas_field);
        }
        public Field GetVas_nameTable(){
            return n_oTableSet.Fields(BusinessVasNameRecord.Para.vas_name);
        }
        public Field GetIdTable(){
            return n_oTableSet.Fields(BusinessVasNameRecord.Para.id);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(BusinessVasNameRecord.Para.active);
        }
        public Field GetVas_chi_nameTable(){
            return n_oTableSet.Fields(BusinessVasNameRecord.Para.vas_chi_name);
        }
