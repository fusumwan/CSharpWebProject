...
///-- Description:	<Description,Table :[Accessory], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [Accessory] Information layer
    /// </summary>
    public abstract class AccessoryInfoDLL{
        ...
        public static AccessoryInfo CreateInfoInstanceObject()
        {
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = Accessory.Para.TableName();
            ...
            // [active] Field
            _sStrFldName = Accessory.Para.active;
            ...
            // [cdate] Field
            _sStrFldName = Accessory.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = Accessory.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = Accessory.Para.accessory_price;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sdate] Field
            _sStrFldName = Accessory.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = Accessory.Para.accessory_desc;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [last_stock] Field
            _sStrFldName = Accessory.Para.last_stock;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = Accessory.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = Accessory.Para.accessory_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = Accessory.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mid] Field
            _sStrFldName = Accessory.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [did] Field
            _sStrFldName = Accessory.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [quota] Field
            _sStrFldName = Accessory.Para.quota;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetActiveTable(){
            return n_oTableSet.Fields(Accessory.Para.active);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(Accessory.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(Accessory.Para.cid);
        }
        public Field GetAccessory_priceTable(){
            return n_oTableSet.Fields(Accessory.Para.accessory_price);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(Accessory.Para.sdate);
        }
        public Field GetAccessory_descTable(){
            return n_oTableSet.Fields(Accessory.Para.accessory_desc);
        }
        public Field GetLast_stockTable(){
            return n_oTableSet.Fields(Accessory.Para.last_stock);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(Accessory.Para.edate);
        }
        public Field GetAccessory_codeTable(){
            return n_oTableSet.Fields(Accessory.Para.accessory_code);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(Accessory.Para.ddate);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(Accessory.Para.mid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(Accessory.Para.did);
        }
        public Field GetQuotaTable(){
            return n_oTableSet.Fields(Accessory.Para.quota);
        }
