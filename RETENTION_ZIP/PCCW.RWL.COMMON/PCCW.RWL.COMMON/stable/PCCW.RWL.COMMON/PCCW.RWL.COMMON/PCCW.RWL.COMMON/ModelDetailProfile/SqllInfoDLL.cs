...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class SqllInfoDLL{
        ...
        public static SqllInfo CreateInfoInstanceObject(){
            return new SqllInfo();
        }
        #endregion
        #region Constructor
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = Sqll.Para.TableName();
            ...
            // [txt] Field
            _sStrFldName = Sqll.Para.txt;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[txt]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "txt";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[txt]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "txt";
            n_oTableSet.Fields(_sStrFldName).AliasName = "txt";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "txt";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            n_oTableSet.Fields(_sStrFldName).FieldName = "[idx]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "idx";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[idx]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "idx";
            n_oTableSet.Fields(_sStrFldName).AliasName = "idx";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "idx";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
        ...
        public Field GetCdateTable(){
            return n_oTableSet.Fields(Sqll.Para.cdate);
        }
        public Field GetTxtTable(){
            return n_oTableSet.Fields(Sqll.Para.txt);
        }
        public Field GetIpTable(){
            return n_oTableSet.Fields(Sqll.Para.ip);
        }
        public Field GetIdxTable(){
            return n_oTableSet.Fields(Sqll.Para.idx);
        }
