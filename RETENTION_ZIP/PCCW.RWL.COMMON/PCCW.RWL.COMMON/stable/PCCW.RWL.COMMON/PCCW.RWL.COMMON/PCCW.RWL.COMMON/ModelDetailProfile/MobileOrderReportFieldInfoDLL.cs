...
///-- Description:	<Description,Table :[MobileOrderReportField], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderReportField] Information layer
    /// </summary>
    public abstract class MobileOrderReportFieldInfoDLL{
        ...
        public static MobileOrderReportFieldInfo CreateInfoInstanceObject(){
            return new MobileOrderReportFieldInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderReportFieldInfoDLL(){
            Init();
        }
        ~MobileOrderReportFieldInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderReportField.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = MobileOrderReportField.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderReportField.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = MobileOrderReportField.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [field_title] Field
            _sStrFldName = MobileOrderReportField.Para.field_title;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[field_title]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "field_title";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[field_title]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "field_title";
            n_oTableSet.Fields(_sStrFldName).AliasName = "field_title";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "field_title";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [active] Field
            _sStrFldName = MobileOrderReportField.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [report_id] Field
            _sStrFldName = MobileOrderReportField.Para.report_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [field_content_order] Field
            _sStrFldName = MobileOrderReportField.Para.field_content_order;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[field_content_order]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "field_content_order";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[field_content_order]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "field_content_order";
            n_oTableSet.Fields(_sStrFldName).AliasName = "field_content_order";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "field_content_order";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [field_content] Field
            _sStrFldName = MobileOrderReportField.Para.field_content;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[field_content]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "field_content";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[field_content]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "field_content";
            n_oTableSet.Fields(_sStrFldName).AliasName = "field_content";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "field_content";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            n_oTableSet.Fields(_sStrFldName).IsRegister = false;
            n_oTableSet.Fields(_sStrFldName).IsNullable = true;
            n_oTableSet.Fields(_sStrFldName).Size = 1073741823;
            n_oTableSet.Fields(_sStrFldName).SqlDataType = "ntext";
            
            
            // [field_content_name] Field
            _sStrFldName = MobileOrderReportField.Para.field_content_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[field_content_name]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "field_content_name";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[field_content_name]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "field_content_name";
            n_oTableSet.Fields(_sStrFldName).AliasName = "field_content_name";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "field_content_name";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [field_order] Field
            _sStrFldName = MobileOrderReportField.Para.field_order;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[field_order]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "field_order";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[field_order]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "field_order";
            n_oTableSet.Fields(_sStrFldName).AliasName = "field_order";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "field_order";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.cid);
        }
        public Field GetField_titleTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.field_title);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.active);
        }
        public Field GetReport_idTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.report_id);
        }
        public Field GetField_content_orderTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.field_content_order);
        }
        public Field GetField_contentTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.field_content);
        }
        public Field GetField_content_nameTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.field_content_name);
        }
        public Field GetField_orderTable(){
            return n_oTableSet.Fields(MobileOrderReportField.Para.field_order);
        }
