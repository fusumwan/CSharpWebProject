...
///-- Description:	<Description,Table :[MobileOrderAddress], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderAddress] Information layer
    /// </summary>
    public abstract class MobileOrderAddressInfoDLL{
        ...
        public static MobileOrderAddressInfo CreateInfoInstanceObject(){
            return new MobileOrderAddressInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderAddressInfoDLL(){
            Init();
        }
        ~MobileOrderAddressInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderAddress.Para.TableName();
            ...
            // [d_street] Field
            _sStrFldName = MobileOrderAddress.Para.d_street;
            ...
            // [address_id] Field
            _sStrFldName = MobileOrderAddress.Para.address_id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [d_region] Field
            _sStrFldName = MobileOrderAddress.Para.d_region;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_floor] Field
            _sStrFldName = MobileOrderAddress.Para.d_floor;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_build] Field
            _sStrFldName = MobileOrderAddress.Para.d_build;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_room] Field
            _sStrFldName = MobileOrderAddress.Para.d_room;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileOrderAddress.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [address_type] Field
            _sStrFldName = MobileOrderAddress.Para.address_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_type] Field
            _sStrFldName = MobileOrderAddress.Para.d_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_district] Field
            _sStrFldName = MobileOrderAddress.Para.d_district;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_blk] Field
            _sStrFldName = MobileOrderAddress.Para.d_blk;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetD_streetTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_street);
        }
        public Field GetAddress_idTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.address_id);
        }
        public Field GetD_regionTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_region);
        }
        public Field GetD_floorTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_floor);
        }
        public Field GetD_buildTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_build);
        }
        public Field GetD_roomTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_room);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.order_id);
        }
        public Field GetAddress_typeTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.address_type);
        }
        public Field GetD_typeTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_type);
        }
        public Field GetD_districtTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_district);
        }
        public Field GetD_blkTable(){
            return n_oTableSet.Fields(MobileOrderAddress.Para.d_blk);
        }
