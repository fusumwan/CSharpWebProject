...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileManualAssignedHistoryInfoDLL{
        ...
        public static MobileManualAssignedHistoryInfo CreateInfoInstanceObject(){
            return new MobileManualAssignedHistoryInfo();
        }
        #endregion
        #region Constructor
        
        public MobileManualAssignedHistoryInfoDLL(){
            Init();
        }
        ~MobileManualAssignedHistoryInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileManualAssignedHistory.Para.TableName();
            ...
            // [sku] Field
            _sStrFldName = MobileManualAssignedHistory.Para.sku;
            ...
            // [order_id] Field
            _sStrFldName = MobileManualAssignedHistory.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cdate] Field
            _sStrFldName = MobileManualAssignedHistory.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileManualAssignedHistory.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [imei_no] Field
            _sStrFldName = MobileManualAssignedHistory.Para.imei_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [id] Field
            _sStrFldName = MobileManualAssignedHistory.Para.id;
            n_oTableSet.Add(_sStrFldName);
        ...
        public Field GetSkuTable(){
            return n_oTableSet.Fields(MobileManualAssignedHistory.Para.sku);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileManualAssignedHistory.Para.order_id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileManualAssignedHistory.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileManualAssignedHistory.Para.cid);
        }
        public Field GetImei_noTable(){
            return n_oTableSet.Fields(MobileManualAssignedHistory.Para.imei_no);
        }
        public Field GetIdTable(){
            return n_oTableSet.Fields(MobileManualAssignedHistory.Para.id);
        }
