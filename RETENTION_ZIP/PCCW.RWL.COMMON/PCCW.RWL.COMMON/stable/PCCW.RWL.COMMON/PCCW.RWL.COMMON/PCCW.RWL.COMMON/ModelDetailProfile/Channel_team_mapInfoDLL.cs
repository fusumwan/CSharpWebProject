...
///-- Description:	<Description,Table :[CSSDB].[dbo].[channel_team_map], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [CSSDB].[dbo].[channel_team_map] Information layer
    /// </summary>
    public abstract class Channel_team_mapInfoDLL{
        ...
        public Channel_team_mapInfoDLL(){
            Init();
        }
        ~Channel_team_mapInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static Channel_team_mapInfo CreateInfoInstanceObject()
        {
            return new Channel_team_mapInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = Channel_team_map.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = Channel_team_map.Para.id;
            ...
            // [teamcode] Field
            _sStrFldName = Channel_team_map.Para.teamcode;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [channel] Field
            _sStrFldName = Channel_team_map.Para.channel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = Channel_team_map.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(Channel_team_map.Para.id);
        }
        public Field GetTeamcodeTable(){
            return n_oTableSet.Fields(Channel_team_map.Para.teamcode);
        }
        public Field GetChannelTable(){
            return n_oTableSet.Fields(Channel_team_map.Para.channel);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(Channel_team_map.Para.active);
        }
