...
///-- Description:	<Description,Table :[MobileOrderIssueRestriction], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderIssueRestriction] Information layer
    /// </summary>
    public abstract class MobileOrderIssueRestrictionInfoDLL{
        ...
        public static MobileOrderIssueRestrictionInfo CreateInfoInstanceObject(){
            return new MobileOrderIssueRestrictionInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderIssueRestrictionInfoDLL(){
            Init();
        }
        ~MobileOrderIssueRestrictionInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderIssueRestriction.Para.TableName();
            ...
            // [name] Field
            _sStrFldName = MobileOrderIssueRestriction.Para.name;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderIssueRestriction.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileOrderIssueRestriction.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [type] Field
            _sStrFldName = MobileOrderIssueRestriction.Para.type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = MobileOrderIssueRestriction.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderIssueRestriction.Para.restriction_id;
            n_oTableSet.Add(_sStrFldName);
        ...
        public Field GetNameTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestriction.Para.name);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestriction.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestriction.Para.cid);
        }
        public Field GetTypeTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestriction.Para.type);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestriction.Para.active);
        }
        public Field GetRestriction_idTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestriction.Para.restriction_id);
        }
