...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class OfferAutomationInfoDLL{
        ...
        public static OfferAutomationInfo CreateInfoInstanceObject(){
            return new OfferAutomationInfo();
        }
        #endregion
        #region Constructor
        
        public OfferAutomationInfoDLL(){
            Init();
        }
        ~OfferAutomationInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = OfferAutomation.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = OfferAutomation.Para.id;
            ...
            // [offer_name] Field
            _sStrFldName = OfferAutomation.Para.offer_name;
            n_oTableSet.Add(_sStrFldName);
            ...
            n_oTableSet.Fields(_sStrFldName).FieldName = "[offer_name]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "offer_name";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[offer_name]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "offer_name";
            n_oTableSet.Fields(_sStrFldName).AliasName = "offer_name";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "offer_name";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            ...
            _sStrFldName = OfferAutomation.Para.call_list_program_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = OfferAutomation.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [trade_field_id] Field
            _sStrFldName = OfferAutomation.Para.trade_field_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[trade_field_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "trade_field_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[trade_field_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "trade_field_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "trade_field_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "trade_field_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(OfferAutomation.Para.id);
        }
        public Field GetOffer_nameTable(){
            return n_oTableSet.Fields(OfferAutomation.Para.offer_name);
        }
        public Field GetCall_list_program_idTable(){
            return n_oTableSet.Fields(OfferAutomation.Para.call_list_program_id);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(OfferAutomation.Para.active);
        }
        public Field GetTrade_field_idTable(){
            return n_oTableSet.Fields(OfferAutomation.Para.trade_field_id);
        }
