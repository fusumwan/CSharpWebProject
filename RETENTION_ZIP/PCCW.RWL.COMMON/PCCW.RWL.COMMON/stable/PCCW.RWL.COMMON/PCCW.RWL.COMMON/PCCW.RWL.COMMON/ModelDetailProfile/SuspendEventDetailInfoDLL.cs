...
///-- Description:	<Description,Table :[SuspendEventDetail], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [SuspendEventDetail] Information layer
    /// </summary>
    public abstract class SuspendEventDetailInfoDLL{
        ...
        public SuspendEventDetailInfoDLL(){
            Init();
        }
        ~SuspendEventDetailInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static SuspendEventDetailInfo CreateInfoInstanceObject()
        {
            return new SuspendEventDetailInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = SuspendEventDetail.Para.TableName();
            ...
            // [mid] Field
            _sStrFldName = SuspendEventDetail.Para.mid;
            ...
            // [active] Field
            _sStrFldName = SuspendEventDetail.Para.active;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [reasons] Field
            _sStrFldName = SuspendEventDetail.Para.reasons;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetMidTable(){
            return n_oTableSet.Fields(SuspendEventDetail.Para.mid);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(SuspendEventDetail.Para.active);
        }
        public Field GetReasonsTable(){
            return n_oTableSet.Fields(SuspendEventDetail.Para.reasons);
        }
