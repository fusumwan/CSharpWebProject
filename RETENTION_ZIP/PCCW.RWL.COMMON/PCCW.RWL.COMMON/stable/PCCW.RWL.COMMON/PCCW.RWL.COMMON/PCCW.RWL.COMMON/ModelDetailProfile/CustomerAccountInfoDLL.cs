...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class CustomerAccountInfoDLL{
        ...
        public CustomerAccountInfoDLL(){
            Init();
        }
        ~CustomerAccountInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static CustomerAccountInfo CreateInfoInstanceObject()
        {
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = CustomerAccount.Para.TableName();
            ...
            // [remarks] Field
            _sStrFldName = CustomerAccount.Para.remarks;
            ...
            // [id] Field
            _sStrFldName = CustomerAccount.Para.id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cdate] Field
            _sStrFldName = CustomerAccount.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = CustomerAccount.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mrt_no] Field
            _sStrFldName = CustomerAccount.Para.mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = CustomerAccount.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ac_no] Field
            _sStrFldName = CustomerAccount.Para.ac_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = CustomerAccount.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = CustomerAccount.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = CustomerAccount.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetRemarksTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.remarks);
        }
        public Field GetIdTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.cid);
        }
        public Field GetMrt_noTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.mrt_no);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.active);
        }
        public Field GetAc_noTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.ac_no);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.order_id);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.ddate);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(CustomerAccount.Para.did);
        }
