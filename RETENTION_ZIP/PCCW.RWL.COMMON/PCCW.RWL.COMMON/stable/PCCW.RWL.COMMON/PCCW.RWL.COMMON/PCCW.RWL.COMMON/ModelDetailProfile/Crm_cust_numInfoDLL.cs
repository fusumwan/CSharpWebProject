...
///-- Description:	<Description,Table :[crm_cust_num], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [crm_cust_num] Information layer
    /// </summary>
    public abstract class Crm_cust_numInfoDLL{
        ...
        public static Crm_cust_numInfo CreateInfoInstanceObject()
        {
            return new Crm_cust_numInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = Crm_cust_num.Para.TableName();
            ...
            // [active] Field
            _sStrFldName = Crm_cust_num.Para.active;
            ...
            // [cdate] Field
            _sStrFldName = Crm_cust_num.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = Crm_cust_num.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = Crm_cust_num.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cust_num] Field
            _sStrFldName = Crm_cust_num.Para.cust_num;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[cust_num]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "cust_num";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[cust_num]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "cust_num";
            n_oTableSet.Fields(_sStrFldName).AliasName = "cust_num";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "cust_num";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [cust_id] Field
            _sStrFldName = Crm_cust_num.Para.cust_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = Crm_cust_num.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [ddate] Field
            _sStrFldName = Crm_cust_num.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetActiveTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.active);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.did);
        }
        public Field GetCust_numTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.cust_num);
        }
        public Field GetCust_idTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.cust_id);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.order_id);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(Crm_cust_num.Para.ddate);
        }
