...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileOrderReportInfoDLL{
        ...
        public static MobileOrderReportInfo CreateInfoInstanceObject(){
            return new MobileOrderReportInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderReportInfoDLL(){
            Init();
        }
        ~MobileOrderReportInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderReport.Para.TableName();
            ...
            // [order_status] Field
            _sStrFldName = MobileOrderReport.Para.order_status;
            ...
            _sStrFldName = MobileOrderReport.Para.gw_retrieve_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sent_again] Field
            _sStrFldName = MobileOrderReport.Para.sent_again;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mid] Field
            _sStrFldName = MobileOrderReport.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [email_date] Field
            _sStrFldName = MobileOrderReport.Para.email_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_cnt] Field
            _sStrFldName = MobileOrderReport.Para.retrieve_cnt;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReport.Para.fs_sent_again_retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderReport.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_sn] Field
            _sStrFldName = MobileOrderReport.Para.retrieve_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileOrderReport.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = MobileOrderReport.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReport.Para.sent_again_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [idd_vas] Field
            _sStrFldName = MobileOrderReport.Para.idd_vas;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = MobileOrderReport.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReport.Para.fallout_reason;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReport.Para.fallout_remark;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReport.Para.fallout_main_category;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [report_type] Field
            _sStrFldName = MobileOrderReport.Para.report_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fallout_reply] Field
            _sStrFldName = MobileOrderReport.Para.fallout_reply;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [reactive_sn] Field
            _sStrFldName = MobileOrderReport.Para.reactive_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = MobileOrderReport.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ext_place_tel] Field
            _sStrFldName = MobileOrderReport.Para.ext_place_tel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [reactive_date] Field
            _sStrFldName = MobileOrderReport.Para.reactive_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReport.Para.gw_retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileOrderReport.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReport.Para.py_sent_again_retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_date] Field
            _sStrFldName = MobileOrderReport.Para.retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetOrder_statusTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.order_status);
        }
        public Field GetGw_retrieve_snTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.gw_retrieve_sn);
        }
        public Field GetSent_againTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.sent_again);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.mid);
        }
        public Field GetEmail_dateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.email_date);
        }
        public Field GetRetrieve_cntTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.retrieve_cnt);
        }
        public Field GetFs_sent_again_retrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.fs_sent_again_retrieve_date);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.cdate);
        }
        public Field GetRetrieve_snTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.retrieve_sn);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.did);
        }
        public Field GetSent_again_dateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.sent_again_date);
        }
        public Field GetIdd_vasTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.idd_vas);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.active);
        }
        public Field GetFallout_reasonTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.fallout_reason);
        }
        public Field GetFallout_remarkTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.fallout_remark);
        }
        public Field GetFallout_main_categoryTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.fallout_main_category);
        }
        public Field GetReport_typeTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.report_type);
        }
        public Field GetFallout_replyTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.fallout_reply);
        }
        public Field GetReactive_snTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.reactive_sn);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.ddate);
        }
        public Field GetExt_place_telTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.ext_place_tel);
        }
        public Field GetReactive_dateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.reactive_date);
        }
        public Field GetGw_retrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.gw_retrieve_date);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.order_id);
        }
        public Field GetPy_sent_again_retrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.py_sent_again_retrieve_date);
        }
        public Field GetRetrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReport.Para.retrieve_date);
        }
