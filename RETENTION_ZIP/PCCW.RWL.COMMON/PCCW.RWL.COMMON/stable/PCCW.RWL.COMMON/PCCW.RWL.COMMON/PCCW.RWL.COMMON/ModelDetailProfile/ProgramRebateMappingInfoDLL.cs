...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class ProgramRebateMappingInfoDLL{
        ...
        public static ProgramRebateMappingInfo CreateInfoInstanceObject(){
            return new ProgramRebateMappingInfo();
        }
        #endregion
        #region Constructor
        
        public ProgramRebateMappingInfoDLL(){
            Init();
        }
        ~ProgramRebateMappingInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = ProgramRebateMapping.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = ProgramRebateMapping.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = ProgramRebateMapping.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [active] Field
            _sStrFldName = ProgramRebateMapping.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = ProgramRebateMapping.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [program] Field
            _sStrFldName = ProgramRebateMapping.Para.program;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [issue_type] Field
            _sStrFldName = ProgramRebateMapping.Para.issue_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [use_rebate_mapping] Field
            _sStrFldName = ProgramRebateMapping.Para.use_rebate_mapping;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[use_rebate_mapping]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<bool>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "use_rebate_mapping";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[use_rebate_mapping]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "use_rebate_mapping";
            n_oTableSet.Fields(_sStrFldName).AliasName = "use_rebate_mapping";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "use_rebate_mapping";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [sdate] Field
            _sStrFldName = ProgramRebateMapping.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.cdate);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.active);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.edate);
        }
        public Field GetProgramTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.program);
        }
        public Field GetIssue_typeTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.issue_type);
        }
        public Field GetUse_rebate_mappingTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.use_rebate_mapping);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(ProgramRebateMapping.Para.sdate);
        }
