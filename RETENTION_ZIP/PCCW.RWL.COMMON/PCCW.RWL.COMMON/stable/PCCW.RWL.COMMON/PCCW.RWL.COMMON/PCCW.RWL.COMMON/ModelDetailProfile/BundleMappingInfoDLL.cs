...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class BundleMappingInfoDLL{
        ...
        public static BundleMappingInfo CreateInfoInstanceObject(){
            return new BundleMappingInfo();
        }
        #endregion
        #region Constructor
        
        public BundleMappingInfoDLL(){
            Init();
        }
        ~BundleMappingInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = BundleMapping.Para.TableName();
            ...
            // [program] Field
            _sStrFldName = BundleMapping.Para.program;
            ...
            // [cdate] Field
            _sStrFldName = BundleMapping.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bundle_name] Field
            _sStrFldName = BundleMapping.Para.bundle_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = BundleMapping.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = BundleMapping.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retention_rebate] Field
            _sStrFldName = BundleMapping.Para.retention_rebate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[retention_rebate]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "retention_rebate";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[retention_rebate]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "retention_rebate";
            n_oTableSet.Fields(_sStrFldName).AliasName = "retention_rebate";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "retention_rebate";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [edate] Field
            _sStrFldName = BundleMapping.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = BundleMapping.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [normal_rebate] Field
            _sStrFldName = BundleMapping.Para.normal_rebate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = BundleMapping.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = BundleMapping.Para.normal_rebate_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [id] Field
            _sStrFldName = BundleMapping.Para.id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [sdate] Field
            _sStrFldName = BundleMapping.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rate_plan] Field
            _sStrFldName = BundleMapping.Para.rate_plan;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas_field] Field
            _sStrFldName = BundleMapping.Para.vas_field;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hs_model] Field
            _sStrFldName = BundleMapping.Para.hs_model;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [issue_type] Field
            _sStrFldName = BundleMapping.Para.issue_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetProgramTable(){
            return n_oTableSet.Fields(BundleMapping.Para.program);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(BundleMapping.Para.cdate);
        }
        public Field GetBundle_nameTable(){
            return n_oTableSet.Fields(BundleMapping.Para.bundle_name);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(BundleMapping.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(BundleMapping.Para.did);
        }
        public Field GetRetention_rebateTable(){
            return n_oTableSet.Fields(BundleMapping.Para.retention_rebate);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(BundleMapping.Para.edate);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(BundleMapping.Para.active);
        }
        public Field GetNormal_rebateTable(){
            return n_oTableSet.Fields(BundleMapping.Para.normal_rebate);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(BundleMapping.Para.ddate);
        }
        public Field GetNormal_rebate_typeTable(){
            return n_oTableSet.Fields(BundleMapping.Para.normal_rebate_type);
        }
        public Field GetIdTable(){
            return n_oTableSet.Fields(BundleMapping.Para.id);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(BundleMapping.Para.sdate);
        }
        public Field GetRate_planTable(){
            return n_oTableSet.Fields(BundleMapping.Para.rate_plan);
        }
        public Field GetVas_fieldTable(){
            return n_oTableSet.Fields(BundleMapping.Para.vas_field);
        }
        public Field GetHs_modelTable(){
            return n_oTableSet.Fields(BundleMapping.Para.hs_model);
        }
        public Field GetIssue_typeTable(){
            return n_oTableSet.Fields(BundleMapping.Para.issue_type);
        }
