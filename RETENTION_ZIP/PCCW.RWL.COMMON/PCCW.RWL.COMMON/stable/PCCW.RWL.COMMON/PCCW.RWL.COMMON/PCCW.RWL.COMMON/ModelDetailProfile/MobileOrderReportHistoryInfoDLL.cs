...
///-- Description:	<Description,Table :[MobileOrderReportHistory], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderReportHistory] Information layer
    /// </summary>
    public abstract class MobileOrderReportHistoryInfoDLL{
        ...
        public static MobileOrderReportHistoryInfo CreateInfoInstanceObject(){
            return new MobileOrderReportHistoryInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderReportHistoryInfoDLL(){
            Init();
        }
        ~MobileOrderReportHistoryInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderReportHistory.Para.TableName();
            ...
            // [order_status] Field
            _sStrFldName = MobileOrderReportHistory.Para.order_status;
            ...
            // [gw_retrieve_sn] Field
            _sStrFldName = MobileOrderReportHistory.Para.gw_retrieve_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[gw_retrieve_sn]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "gw_retrieve_sn";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[gw_retrieve_sn]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "gw_retrieve_sn";
            n_oTableSet.Fields(_sStrFldName).AliasName = "gw_retrieve_sn";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "gw_retrieve_sn";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [sent_again] Field
            _sStrFldName = MobileOrderReportHistory.Para.sent_again;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[sent_again]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "sent_again";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[sent_again]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "sent_again";
            n_oTableSet.Fields(_sStrFldName).AliasName = "sent_again";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "sent_again";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [mid] Field
            _sStrFldName = MobileOrderReportHistory.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [email_date] Field
            _sStrFldName = MobileOrderReportHistory.Para.email_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_cnt] Field
            _sStrFldName = MobileOrderReportHistory.Para.retrieve_cnt;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fs_sent_again_retrieve_date] Field
            _sStrFldName = MobileOrderReportHistory.Para.fs_sent_again_retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[fs_sent_again_retrieve_date]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<DateTime>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "fs_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[fs_sent_again_retrieve_date]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "fs_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).AliasName = "fs_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "fs_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderReportHistory.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_sn] Field
            _sStrFldName = MobileOrderReportHistory.Para.retrieve_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileOrderReportHistory.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = MobileOrderReportHistory.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sent_again_date] Field
            _sStrFldName = MobileOrderReportHistory.Para.sent_again_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[sent_again_date]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<DateTime>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "sent_again_date";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[sent_again_date]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "sent_again_date";
            n_oTableSet.Fields(_sStrFldName).AliasName = "sent_again_date";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "sent_again_date";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [idd_vas] Field
            _sStrFldName = MobileOrderReportHistory.Para.idd_vas;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[idd_vas]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "idd_vas";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[idd_vas]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "idd_vas";
            n_oTableSet.Fields(_sStrFldName).AliasName = "idd_vas";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "idd_vas";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [active] Field
            _sStrFldName = MobileOrderReportHistory.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReportHistory.Para.fallout_reason;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReportHistory.Para.fallout_remark;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderReportHistory.Para.fallout_main_category;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [report_type] Field
            _sStrFldName = MobileOrderReportHistory.Para.report_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fallout_reply] Field
            _sStrFldName = MobileOrderReportHistory.Para.fallout_reply;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [reactive_sn] Field
            _sStrFldName = MobileOrderReportHistory.Para.reactive_sn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = MobileOrderReportHistory.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ext_place_tel] Field
            _sStrFldName = MobileOrderReportHistory.Para.ext_place_tel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [reactive_date] Field
            _sStrFldName = MobileOrderReportHistory.Para.reactive_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gw_retrieve_date] Field
            _sStrFldName = MobileOrderReportHistory.Para.gw_retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[gw_retrieve_date]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<DateTime>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "gw_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[gw_retrieve_date]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "gw_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).AliasName = "gw_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "gw_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [rec_no] Field
            _sStrFldName = MobileOrderReportHistory.Para.rec_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileOrderReportHistory.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [py_sent_again_retrieve_date] Field
            _sStrFldName = MobileOrderReportHistory.Para.py_sent_again_retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[py_sent_again_retrieve_date]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<DateTime>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "py_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[py_sent_again_retrieve_date]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "py_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).AliasName = "py_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "py_sent_again_retrieve_date";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [retrieve_date] Field
            _sStrFldName = MobileOrderReportHistory.Para.retrieve_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetOrder_statusTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.order_status);
        }
        public Field GetGw_retrieve_snTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.gw_retrieve_sn);
        }
        public Field GetSent_againTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.sent_again);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.mid);
        }
        public Field GetEmail_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.email_date);
        }
        public Field GetRetrieve_cntTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.retrieve_cnt);
        }
        public Field GetFs_sent_again_retrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.fs_sent_again_retrieve_date);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.cdate);
        }
        public Field GetRetrieve_snTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.retrieve_sn);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.did);
        }
        public Field GetSent_again_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.sent_again_date);
        }
        public Field GetIdd_vasTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.idd_vas);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.active);
        }
        public Field GetFallout_reasonTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.fallout_reason);
        }
        public Field GetFallout_remarkTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.fallout_remark);
        }
        public Field GetFallout_main_categoryTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.fallout_main_category);
        }
        public Field GetReport_typeTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.report_type);
        }
        public Field GetFallout_replyTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.fallout_reply);
        }
        public Field GetReactive_snTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.reactive_sn);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.ddate);
        }
        public Field GetExt_place_telTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.ext_place_tel);
        }
        public Field GetReactive_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.reactive_date);
        }
        public Field GetGw_retrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.gw_retrieve_date);
        }
        public Field GetRec_noTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.rec_no);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.order_id);
        }
        public Field GetPy_sent_again_retrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.py_sent_again_retrieve_date);
        }
        public Field GetRetrieve_dateTable(){
            return n_oTableSet.Fields(MobileOrderReportHistory.Para.retrieve_date);
        }
