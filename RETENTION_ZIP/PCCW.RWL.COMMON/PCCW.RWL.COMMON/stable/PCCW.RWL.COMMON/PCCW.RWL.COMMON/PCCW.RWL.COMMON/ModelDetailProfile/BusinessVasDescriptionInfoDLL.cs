...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class BusinessVasDescriptionInfoDLL{
        ...
        public BusinessVasDescriptionInfoDLL(){
            Init();
        }
        ~BusinessVasDescriptionInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static BusinessVasDescriptionInfo CreateInfoInstanceObject()
        {
            return new BusinessVasDescriptionInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = BusinessVasDescription.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = BusinessVasDescription.Para.id;
            ...
            // [fee] Field
            _sStrFldName = BusinessVasDescription.Para.fee;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [vas_desc] Field
            _sStrFldName = BusinessVasDescription.Para.vas_desc;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = BusinessVasDescription.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas] Field
            _sStrFldName = BusinessVasDescription.Para.vas;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[vas]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "vas";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[vas]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "vas";
            n_oTableSet.Fields(_sStrFldName).AliasName = "vas";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "vas";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(BusinessVasDescription.Para.id);
        }
        public Field GetFeeTable(){
            return n_oTableSet.Fields(BusinessVasDescription.Para.fee);
        }
        public Field GetVas_descTable(){
            return n_oTableSet.Fields(BusinessVasDescription.Para.vas_desc);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(BusinessVasDescription.Para.active);
        }
        public Field GetVasTable(){
            return n_oTableSet.Fields(BusinessVasDescription.Para.vas);
        }
