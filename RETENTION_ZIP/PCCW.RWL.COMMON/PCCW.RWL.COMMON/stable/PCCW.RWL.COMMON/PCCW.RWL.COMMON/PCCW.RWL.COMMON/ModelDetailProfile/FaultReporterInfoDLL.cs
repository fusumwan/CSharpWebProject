...
///-- Description:	<Description,Table :[FaultReporter], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [FaultReporter] Information layer
    /// </summary>
    public abstract class FaultReporterInfoDLL{
        ...
        public static FaultReporterInfo CreateInfoInstanceObject(){
            return new FaultReporterInfo();
        }
        #endregion
        #region Constructor
        
        public FaultReporterInfoDLL(){
            Init();
        }
        ~FaultReporterInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = FaultReporter.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = FaultReporter.Para.id;
            ...
            // [name] Field
            _sStrFldName = FaultReporter.Para.name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            ...
            // [cdate] Field
            _sStrFldName = FaultReporter.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = FaultReporter.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [email] Field
            _sStrFldName = FaultReporter.Para.email;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[email]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "email";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[email]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "email";
            n_oTableSet.Fields(_sStrFldName).AliasName = "email";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "email";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [active] Field
            _sStrFldName = FaultReporter.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = FaultReporter.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(FaultReporter.Para.id);
        }
        public Field GetNameTable(){
            return n_oTableSet.Fields(FaultReporter.Para.name);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(FaultReporter.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(FaultReporter.Para.cid);
        }
        public Field GetEmailTable(){
            return n_oTableSet.Fields(FaultReporter.Para.email);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(FaultReporter.Para.active);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(FaultReporter.Para.edate);
        }
