...
///-- Description:	<Description,Table :[DeliveryTime], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [DeliveryTime] Information layer
    /// </summary>
    public abstract class DeliveryTimeInfoDLL{
        ...
        public static DeliveryTimeInfo CreateInfoInstanceObject(){
            return new DeliveryTimeInfo();
        }
        #endregion
        #region Constructor
        
        public DeliveryTimeInfoDLL(){
            Init();
        }
        ~DeliveryTimeInfoDLL(){
            this.Release();
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = DeliveryTime.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = DeliveryTime.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = DeliveryTime.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = DeliveryTime.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [location] Field
            _sStrFldName = DeliveryTime.Para.location;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = DeliveryTime.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [period] Field
            _sStrFldName = DeliveryTime.Para.period;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(DeliveryTime.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(DeliveryTime.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(DeliveryTime.Para.cid);
        }
        public Field GetLocationTable(){
            return n_oTableSet.Fields(DeliveryTime.Para.location);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(DeliveryTime.Para.active);
        }
        public Field GetPeriodTable(){
            return n_oTableSet.Fields(DeliveryTime.Para.period);
        }
