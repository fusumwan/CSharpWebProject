...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileOrderIssueRestrictionProfileInfoDLL{
        ...
        public static MobileOrderIssueRestrictionProfileInfo CreateInfoInstanceObject(){
            return new MobileOrderIssueRestrictionProfileInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderIssueRestrictionProfileInfoDLL(){
            Init();
        }
        ~MobileOrderIssueRestrictionProfileInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderIssueRestrictionProfile.Para.TableName();
            ...
            // [mid] Field
            _sStrFldName = MobileOrderIssueRestrictionProfile.Para.mid;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderIssueRestrictionProfile.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [mrt_no] Field
            _sStrFldName = MobileOrderIssueRestrictionProfile.Para.mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileOrderIssueRestrictionProfile.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = MobileOrderIssueRestrictionProfile.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderIssueRestrictionProfile.Para.restriction_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetMidTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionProfile.Para.mid);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionProfile.Para.cdate);
        }
        public Field GetMrt_noTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionProfile.Para.mrt_no);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionProfile.Para.cid);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionProfile.Para.active);
        }
        public Field GetRestriction_idTable(){
            return n_oTableSet.Fields(MobileOrderIssueRestrictionProfile.Para.restriction_id);
        }
