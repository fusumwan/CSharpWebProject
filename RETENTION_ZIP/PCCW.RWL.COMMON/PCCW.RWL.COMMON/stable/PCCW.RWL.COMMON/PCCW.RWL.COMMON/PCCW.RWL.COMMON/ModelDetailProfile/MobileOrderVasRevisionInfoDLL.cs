...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileOrderVasRevisionInfoDLL{
        ...
        public static MobileOrderVasRevisionInfo CreateInfoInstanceObject(){
            return new MobileOrderVasRevisionInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderVasRevisionInfoDLL(){
            Init();
        }
        ~MobileOrderVasRevisionInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderVasRevision.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = MobileOrderVasRevision.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderVasRevision.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [active] Field
            _sStrFldName = MobileOrderVasRevision.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas_field] Field
            _sStrFldName = MobileOrderVasRevision.Para.vas_field;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas_id] Field
            _sStrFldName = MobileOrderVasRevision.Para.vas_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[vas_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "vas_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[vas_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "vas_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "vas_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "vas_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [his_order_id] Field
            _sStrFldName = MobileOrderVasRevision.Para.his_order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[his_order_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "his_order_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[his_order_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "his_order_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "his_order_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "his_order_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [order_id] Field
            _sStrFldName = MobileOrderVasRevision.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fee] Field
            _sStrFldName = MobileOrderVasRevision.Para.fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[fee]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "fee";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[fee]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "fee";
            n_oTableSet.Fields(_sStrFldName).AliasName = "fee";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "fee";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [vas_value] Field
            _sStrFldName = MobileOrderVasRevision.Para.vas_value;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [multi_id] Field
            _sStrFldName = MobileOrderVasRevision.Para.multi_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[multi_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "multi_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[multi_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "multi_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "multi_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "multi_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.cdate);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.active);
        }
        public Field GetVas_fieldTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.vas_field);
        }
        public Field GetVas_idTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.vas_id);
        }
        public Field GetHis_order_idTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.his_order_id);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.order_id);
        }
        public Field GetFeeTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.fee);
        }
        public Field GetVas_valueTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.vas_value);
        }
        public Field GetMulti_idTable(){
            return n_oTableSet.Fields(MobileOrderVasRevision.Para.multi_id);
        }
