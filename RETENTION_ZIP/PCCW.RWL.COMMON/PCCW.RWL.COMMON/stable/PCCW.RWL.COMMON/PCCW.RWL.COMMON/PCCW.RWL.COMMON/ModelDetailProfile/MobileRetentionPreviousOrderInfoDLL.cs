...
///-- Description:	<Description,Table :[MobileRetentionPreviousOrder], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileRetentionPreviousOrder] Information layer
    /// </summary>
    public abstract class MobileRetentionPreviousOrderInfoDLL{
        ...
        public static MobileRetentionPreviousOrderInfo CreateInfoInstanceObject(){
            return new MobileRetentionPreviousOrderInfo();
        }
        #endregion
        #region Constructor
        
        public MobileRetentionPreviousOrderInfoDLL(){
            Init();
        }
        ~MobileRetentionPreviousOrderInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileRetentionPreviousOrder.Para.TableName();
            ...
            // [gift_imei] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_imei;
            ...
            // [s_premium4] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.s_premium4;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_desc4] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_desc4;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.accessory_desc;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.action_required;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [registered_address_his_id] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.registered_address_his_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[registered_address_his_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<long>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "registered_address_his_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[registered_address_his_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "registered_address_his_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "registered_address_his_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "registered_address_his_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [vas_eff_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.vas_eff_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_bank_account_bank_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.special_handling_dummy_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_card_exp_year;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [remarks2PY] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.remarks2PY;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [trade_field] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.trade_field;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ord_place_tel] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ord_place_tel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.ord_place_id_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cooling_offer] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cooling_offer;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rec_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.rec_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_handset_offer_rebate_schedule;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.change_payment_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [date_of_birth] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.date_of_birth;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.contact_person;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.extra_d_charge;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [tl_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.tl_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fast_start] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.fast_start;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sp_ref_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.sp_ref_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.exist_cust_plan;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ord_place_rel] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ord_place_rel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mrt_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [imei_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.imei_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.existing_smart_phone_model;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_code3] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_code3;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bank_code] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.bank_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [pos_ref_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.pos_ref_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bill_cut_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.bill_cut_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_imei3] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_imei3;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [exist_plan] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.exist_plan;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [waive] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.waive;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [program] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.program;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.first_month_fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [r_offer] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.r_offer;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ftg_tenure] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ftg_tenure;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [con_per] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.con_per;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_code4] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_code4;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.easywatch_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sms_mrt] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.sms_mrt;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [tpy_his_id] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.tpy_his_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[tpy_his_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<long>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "tpy_his_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[tpy_his_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "tpy_his_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "tpy_his_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "tpy_his_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_payment_method;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [remarks2EDF] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.remarks2EDF;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_desc3] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_desc3;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_imei4] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_imei4;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [old_ord_id] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.old_ord_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_bank_account_hkid2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.d_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_desc] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_desc;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [salesmancode] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.salesmancode;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [pool] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.pool;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cn_mrt_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cn_mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.accessory_imei;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.third_party_credit_card;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [card_ref_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.card_ref_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cooling_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cooling_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.special_approval;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_existing_contract_edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.accessory_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bill_medium] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.bill_medium;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [s_premium] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.s_premium;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ref_staff_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ref_staff_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.accessory_price;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_card_exp_month;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.installment_period;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [m_card_type] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_card_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.easywatch_ord_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [normal_rebate] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.normal_rebate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_rebate_amount;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_card_holder2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.bill_medium_email;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [s_premium1] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.s_premium1;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.card_exp_month;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ob_program_id] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ob_program_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sku] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.sku;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.ref_salesmancode;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.go_wireless_package_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.third_party_hkid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_existing_pccw_customer;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_address] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.d_address;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_registered_mobile_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_existing_customer_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.normal_rebate_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_desc2] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_desc2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_bank_account_branch_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [remarks] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.remarks;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [accept] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.accept;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.delivery_exchange;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_code2] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_code2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.prepayment_waive;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.existing_smart_phone_imei;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mnp_his_id] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.mnp_his_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[mnp_his_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<long>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "mnp_his_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[mnp_his_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "mnp_his_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "mnp_his_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "mnp_his_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [cust_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cust_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cust_type] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cust_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_sponsorships_amount;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.bill_medium_waive;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.delivery_exchange_location;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.hs_offer_type_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [org_fee] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.org_fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rebate] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.rebate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [upgrade_type] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [go_wireless] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.go_wireless;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [extra_rebate] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.extra_rebate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [plan_eff] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.plan_eff;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.extra_rebate_amount;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [card_exp_year] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.card_exp_year;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_existing_contract_sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.ord_place_hkid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.register_address;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gender] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gender;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [lob_ac] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.lob_ac;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sim_mrt_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.sim_mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.redemption_notice_option;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.delivery_collection_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [action_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.action_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.third_party_id_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [org_ftg] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.org_ftg;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_service_tenure;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_payment_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [contact_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.contact_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [org_mrt] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.org_mrt;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sim_item_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.sim_item_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [pay_method] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.pay_method;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hs_model] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.hs_model;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_code] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_bank_account_hkid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [extra_offer] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.extra_offer;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_bank_account_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.first_month_license_fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [retrieve_cnt] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.retrieve_cnt;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [s_premium2] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.s_premium2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_bank_account_id_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [card_type] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.card_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [next_bill] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.next_bill;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.pcd_paid_go_wireless;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_rebate_calculation;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ext_place_tel] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ext_place_tel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [m_3rd_hkid] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_3rd_hkid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.retention_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bill_address_his_id] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.bill_address_his_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[bill_address_his_id]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<long>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "bill_address_his_id";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[bill_address_his_id]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "bill_address_his_id";
            n_oTableSet.Fields(_sStrFldName).AliasName = "bill_address_his_id";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "bill_address_his_id";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [aig_gift] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.aig_gift;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cust_staff_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cust_staff_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [family_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.family_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cdate] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.status_by_cs_admin;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.sim_item_number;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vip_case] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.vip_case;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [given_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.given_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [log_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.log_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [extn] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.extn;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [d_time] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.d_time;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bank_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.bank_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.delivery_exchange_option;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.upgrade_service_account_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.action_of_rate_plan_effective;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [m_card_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_card_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.existing_contract_end_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [con_eff_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.con_eff_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [m_3rd_hkid2] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_3rd_hkid2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [amount] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.amount;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [id_type] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.id_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rate_plan] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.rate_plan;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [channel] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.channel;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.action_eff_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [issue_type] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.issue_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [free_mon] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.free_mon;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [plan_eff_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.plan_eff_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [del_remark] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.del_remark;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [teamcode] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.teamcode;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [staff_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.staff_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edf_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.edf_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ord_place_by] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ord_place_by;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cancel_renew] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.cancel_renew;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.preferred_languages;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hkid] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.hkid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [card_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.card_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ac_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.ac_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bill_cut_num] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.bill_cut_num;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [premium] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.premium;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [m_3rd_id_type] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_3rd_id_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [gift_imei2] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.gift_imei2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [reasons] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.reasons;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [language] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.language;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rebate_amount] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.rebate_amount;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [lob] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.lob;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.m_3rd_contact_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [staff_no] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.staff_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [s_premium3] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.s_premium3;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sp_d_date] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.sp_d_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bundle_name] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.bundle_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.accessory_waive;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sim_item_code] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.sim_item_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileRetentionPreviousOrder.Para.monthly_bank_account_holder;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [card_holder] Field
            _sStrFldName = MobileRetentionPreviousOrder.Para.card_holder;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetGift_imeiTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_imei);
        }
        public Field GetS_premium4Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.s_premium4);
        }
        public Field GetGift_desc4Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_desc4);
        }
        public Field GetAccessory_descTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.accessory_desc);
        }
        public Field GetAction_requiredTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.action_required);
        }
        public Field GetRegistered_address_his_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.registered_address_his_id);
        }
        public Field GetVas_eff_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.vas_eff_date);
        }
        public Field GetMonthly_bank_account_bank_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_bank_account_bank_code);
        }
        public Field GetSpecial_handling_dummy_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.special_handling_dummy_code);
        }
        public Field GetM_card_exp_yearTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_card_exp_year);
        }
        public Field GetRemarks2PYTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.remarks2PY);
        }
        public Field GetTrade_fieldTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.trade_field);
        }
        public Field GetOrd_place_telTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ord_place_tel);
        }
        public Field GetOrd_place_id_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ord_place_id_type);
        }
        public Field GetCooling_offerTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cooling_offer);
        }
        public Field GetRec_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.rec_no);
        }
        public Field GetUpgrade_handset_offer_rebate_scheduleTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_handset_offer_rebate_schedule);
        }
        public Field GetChange_payment_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.change_payment_type);
        }
        public Field GetDate_of_birthTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.date_of_birth);
        }
        public Field GetContact_personTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.contact_person);
        }
        public Field GetExtra_d_chargeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.extra_d_charge);
        }
        public Field GetTl_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.tl_name);
        }
        public Field GetFast_startTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.fast_start);
        }
        public Field GetSp_ref_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sp_ref_no);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.edate);
        }
        public Field GetExist_cust_planTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.exist_cust_plan);
        }
        public Field GetOrd_place_relTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ord_place_rel);
        }
        public Field GetMrt_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.mrt_no);
        }
        public Field GetImei_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.imei_no);
        }
        public Field GetExisting_smart_phone_modelTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.existing_smart_phone_model);
        }
        public Field GetGift_code3Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_code3);
        }
        public Field GetBank_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bank_code);
        }
        public Field GetPos_ref_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.pos_ref_no);
        }
        public Field GetBill_cut_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bill_cut_date);
        }
        public Field GetGift_imei3Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_imei3);
        }
        public Field GetExist_planTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.exist_plan);
        }
        public Field GetWaiveTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.waive);
        }
        public Field GetProgramTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.program);
        }
        public Field GetFirst_month_feeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.first_month_fee);
        }
        public Field GetR_offerTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.r_offer);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.did);
        }
        public Field GetFtg_tenureTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ftg_tenure);
        }
        public Field GetCon_perTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.con_per);
        }
        public Field GetGift_code4Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_code4);
        }
        public Field GetEasywatch_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.easywatch_type);
        }
        public Field GetSms_mrtTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sms_mrt);
        }
        public Field GetTpy_his_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.tpy_his_id);
        }
        public Field GetMonthly_payment_methodTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_payment_method);
        }
        public Field GetRemarks2EDFTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.remarks2EDF);
        }
        public Field GetGift_desc3Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_desc3);
        }
        public Field GetGift_imei4Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_imei4);
        }
        public Field GetOld_ord_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.old_ord_id);
        }
        public Field GetMonthly_bank_account_hkid2Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_bank_account_hkid2);
        }
        public Field GetD_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.d_date);
        }
        public Field GetGift_descTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_desc);
        }
        public Field GetSalesmancodeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.salesmancode);
        }
        public Field GetPoolTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.pool);
        }
        public Field GetCn_mrt_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cn_mrt_no);
        }
        public Field GetAccessory_imeiTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.accessory_imei);
        }
        public Field GetThird_party_credit_cardTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.third_party_credit_card);
        }
        public Field GetCard_ref_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.card_ref_no);
        }
        public Field GetCooling_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cooling_date);
        }
        public Field GetSpecial_approvalTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.special_approval);
        }
        public Field GetUpgrade_existing_contract_edateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_existing_contract_edate);
        }
        public Field GetAccessory_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.accessory_code);
        }
        public Field GetBill_mediumTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bill_medium);
        }
        public Field GetS_premiumTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.s_premium);
        }
        public Field GetRef_staff_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ref_staff_no);
        }
        public Field GetAccessory_priceTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.accessory_price);
        }
        public Field GetM_card_exp_monthTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_card_exp_month);
        }
        public Field GetInstallment_periodTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.installment_period);
        }
        public Field GetM_card_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_card_type);
        }
        public Field GetEasywatch_ord_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.easywatch_ord_id);
        }
        public Field GetNormal_rebateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.normal_rebate);
        }
        public Field GetM_rebate_amountTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_rebate_amount);
        }
        public Field GetM_card_holder2Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_card_holder2);
        }
        public Field GetBill_medium_emailTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bill_medium_email);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.active);
        }
        public Field GetS_premium1Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.s_premium1);
        }
        public Field GetCard_exp_monthTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.card_exp_month);
        }
        public Field GetOb_program_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ob_program_id);
        }
        public Field GetSkuTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sku);
        }
        public Field GetRef_salesmancodeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ref_salesmancode);
        }
        public Field GetGo_wireless_package_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.go_wireless_package_code);
        }
        public Field GetThird_party_hkidTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.third_party_hkid);
        }
        public Field GetUpgrade_existing_pccw_customerTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_existing_pccw_customer);
        }
        public Field GetD_addressTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.d_address);
        }
        public Field GetUpgrade_registered_mobile_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_registered_mobile_no);
        }
        public Field GetUpgrade_existing_customer_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_existing_customer_type);
        }
        public Field GetNormal_rebate_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.normal_rebate_type);
        }
        public Field GetGift_desc2Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_desc2);
        }
        public Field GetMonthly_bank_account_branch_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_bank_account_branch_code);
        }
        public Field GetRemarksTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.remarks);
        }
        public Field GetAcceptTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.accept);
        }
        public Field GetDelivery_exchangeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.delivery_exchange);
        }
        public Field GetGift_code2Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_code2);
        }
        public Field GetPrepayment_waiveTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.prepayment_waive);
        }
        public Field GetExisting_smart_phone_imeiTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.existing_smart_phone_imei);
        }
        public Field GetMnp_his_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.mnp_his_id);
        }
        public Field GetCust_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cust_name);
        }
        public Field GetCust_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cust_type);
        }
        public Field GetUpgrade_sponsorships_amountTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_sponsorships_amount);
        }
        public Field GetBill_medium_waiveTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bill_medium_waive);
        }
        public Field GetDelivery_exchange_locationTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.delivery_exchange_location);
        }
        public Field GetHs_offer_type_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.hs_offer_type_id);
        }
        public Field GetOrg_feeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.org_fee);
        }
        public Field GetRebateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.rebate);
        }
        public Field GetUpgrade_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_type);
        }
        public Field GetGo_wirelessTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.go_wireless);
        }
        public Field GetExtra_rebateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.extra_rebate);
        }
        public Field GetPlan_effTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.plan_eff);
        }
        public Field GetExtra_rebate_amountTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.extra_rebate_amount);
        }
        public Field GetCard_exp_yearTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.card_exp_year);
        }
        public Field GetUpgrade_existing_contract_sdateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_existing_contract_sdate);
        }
        public Field GetOrd_place_hkidTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ord_place_hkid);
        }
        public Field GetRegister_addressTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.register_address);
        }
        public Field GetGenderTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gender);
        }
        public Field GetLob_acTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.lob_ac);
        }
        public Field GetSim_mrt_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sim_mrt_no);
        }
        public Field GetRedemption_notice_optionTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.redemption_notice_option);
        }
        public Field GetDelivery_collection_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.delivery_collection_type);
        }
        public Field GetAction_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.action_date);
        }
        public Field GetThird_party_id_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.third_party_id_type);
        }
        public Field GetOrg_ftgTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.org_ftg);
        }
        public Field GetUpgrade_service_tenureTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_service_tenure);
        }
        public Field GetMonthly_payment_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_payment_type);
        }
        public Field GetContact_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.contact_no);
        }
        public Field GetOrg_mrtTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.org_mrt);
        }
        public Field GetSim_item_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sim_item_name);
        }
        public Field GetPay_methodTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.pay_method);
        }
        public Field GetHs_modelTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.hs_model);
        }
        public Field GetGift_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_code);
        }
        public Field GetMonthly_bank_account_hkidTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_bank_account_hkid);
        }
        public Field GetExtra_offerTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.extra_offer);
        }
        public Field GetMonthly_bank_account_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_bank_account_no);
        }
        public Field GetFirst_month_license_feeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.first_month_license_fee);
        }
        public Field GetRetrieve_cntTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.retrieve_cnt);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ddate);
        }
        public Field GetS_premium2Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.s_premium2);
        }
        public Field GetMonthly_bank_account_id_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_bank_account_id_type);
        }
        public Field GetCard_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.card_type);
        }
        public Field GetNext_billTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.next_bill);
        }
        public Field GetPcd_paid_go_wirelessTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.pcd_paid_go_wireless);
        }
        public Field GetUpgrade_rebate_calculationTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_rebate_calculation);
        }
        public Field GetExt_place_telTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ext_place_tel);
        }
        public Field GetM_3rd_hkidTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_3rd_hkid);
        }
        public Field GetRetention_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.retention_type);
        }
        public Field GetBill_address_his_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bill_address_his_id);
        }
        public Field GetAig_giftTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.aig_gift);
        }
        public Field GetCust_staff_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cust_staff_no);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.order_id);
        }
        public Field GetFamily_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.family_name);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cdate);
        }
        public Field GetStatus_by_cs_adminTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.status_by_cs_admin);
        }
        public Field GetSim_item_numberTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sim_item_number);
        }
        public Field GetVip_caseTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.vip_case);
        }
        public Field GetGiven_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.given_name);
        }
        public Field GetLog_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.log_date);
        }
        public Field GetExtnTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.extn);
        }
        public Field GetD_timeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.d_time);
        }
        public Field GetBank_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bank_name);
        }
        public Field GetDelivery_exchange_optionTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.delivery_exchange_option);
        }
        public Field GetUpgrade_service_account_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.upgrade_service_account_no);
        }
        public Field GetAction_of_rate_plan_effectiveTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.action_of_rate_plan_effective);
        }
        public Field GetM_card_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_card_no);
        }
        public Field GetExisting_contract_end_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.existing_contract_end_date);
        }
        public Field GetCon_eff_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.con_eff_date);
        }
        public Field GetM_3rd_hkid2Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_3rd_hkid2);
        }
        public Field GetAmountTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.amount);
        }
        public Field GetId_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.id_type);
        }
        public Field GetRate_planTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.rate_plan);
        }
        public Field GetChannelTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.channel);
        }
        public Field GetAction_eff_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.action_eff_date);
        }
        public Field GetIssue_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.issue_type);
        }
        public Field GetFree_monTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.free_mon);
        }
        public Field GetPlan_eff_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.plan_eff_date);
        }
        public Field GetDel_remarkTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.del_remark);
        }
        public Field GetTeamcodeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.teamcode);
        }
        public Field GetStaff_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.staff_name);
        }
        public Field GetEdf_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.edf_no);
        }
        public Field GetOrd_place_byTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ord_place_by);
        }
        public Field GetCancel_renewTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.cancel_renew);
        }
        public Field GetPreferred_languagesTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.preferred_languages);
        }
        public Field GetHkidTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.hkid);
        }
        public Field GetCard_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.card_no);
        }
        public Field GetAc_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.ac_no);
        }
        public Field GetBill_cut_numTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bill_cut_num);
        }
        public Field GetPremiumTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.premium);
        }
        public Field GetM_3rd_id_typeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_3rd_id_type);
        }
        public Field GetGift_imei2Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.gift_imei2);
        }
        public Field GetReasonsTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.reasons);
        }
        public Field GetLanguageTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.language);
        }
        public Field GetRebate_amountTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.rebate_amount);
        }
        public Field GetLobTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.lob);
        }
        public Field GetM_3rd_contact_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.m_3rd_contact_no);
        }
        public Field GetStaff_noTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.staff_no);
        }
        public Field GetS_premium3Table(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.s_premium3);
        }
        public Field GetSp_d_dateTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sp_d_date);
        }
        public Field GetBundle_nameTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.bundle_name);
        }
        public Field GetAccessory_waiveTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.accessory_waive);
        }
        public Field GetSim_item_codeTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.sim_item_code);
        }
        public Field GetMonthly_bank_account_holderTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.monthly_bank_account_holder);
        }
        public Field GetCard_holderTable(){
            return n_oTableSet.Fields(MobileRetentionPreviousOrder.Para.card_holder);
        }
