...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class EDFErrorCaseInfoDLL{
        ...
        public static EDFErrorCaseInfo CreateInfoInstanceObject(){
            return new EDFErrorCaseInfo();
        }
        #endregion
        #region Constructor
        
        public EDFErrorCaseInfoDLL(){
            Init();
        }
        ~EDFErrorCaseInfoDLL(){
            this.Release();
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = EDFErrorCase.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = EDFErrorCase.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = EDFErrorCase.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = EDFErrorCase.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mrt_no] Field
            _sStrFldName = EDFErrorCase.Para.mrt_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [status] Field
            _sStrFldName = EDFErrorCase.Para.status;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = EDFErrorCase.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [remark] Field
            _sStrFldName = EDFErrorCase.Para.remark;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [imei_status] Field
            _sStrFldName = EDFErrorCase.Para.imei_status;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[imei_status]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "imei_status";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[imei_status]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "imei_status";
            n_oTableSet.Fields(_sStrFldName).AliasName = "imei_status";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "imei_status";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [imei_no] Field
            _sStrFldName = EDFErrorCase.Para.imei_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [imei_remark] Field
            _sStrFldName = EDFErrorCase.Para.imei_remark;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[imei_remark]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "imei_remark";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[imei_remark]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "imei_remark";
            n_oTableSet.Fields(_sStrFldName).AliasName = "imei_remark";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "imei_remark";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [edf_no] Field
            _sStrFldName = EDFErrorCase.Para.edf_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = EDFErrorCase.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = EDFErrorCase.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = EDFErrorCase.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [error_msg] Field
            _sStrFldName = EDFErrorCase.Para.error_msg;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[error_msg]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "error_msg";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[error_msg]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "error_msg";
            n_oTableSet.Fields(_sStrFldName).AliasName = "error_msg";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "error_msg";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.cid);
        }
        public Field GetMrt_noTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.mrt_no);
        }
        public Field GetStatusTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.status);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.active);
        }
        public Field GetRemarkTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.remark);
        }
        public Field GetImei_statusTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.imei_status);
        }
        public Field GetImei_noTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.imei_no);
        }
        public Field GetImei_remarkTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.imei_remark);
        }
        public Field GetEdf_noTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.edf_no);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.order_id);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.did);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.ddate);
        }
        public Field GetError_msgTable(){
            return n_oTableSet.Fields(EDFErrorCase.Para.error_msg);
        }
