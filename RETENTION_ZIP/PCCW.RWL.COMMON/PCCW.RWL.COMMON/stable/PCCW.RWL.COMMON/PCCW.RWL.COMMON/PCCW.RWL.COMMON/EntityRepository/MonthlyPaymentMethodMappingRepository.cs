...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MonthlyPaymentMethodMappingRepository : MonthlyPaymentMethodMappingRepositoryBase
    {
        public MonthlyPaymentMethodMappingRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MonthlyPaymentMethodMappingRepository()
        {
        }
    }
}
