...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportRetrieveDetailRepository : MobileOrderReportRetrieveDetailRepositoryBase
    {
        public MobileOrderReportRetrieveDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportRetrieveDetailRepository()
        {
        }
    }
}
