...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class ProfileTeamDetailRepository : ProfileTeamDetailRepositoryBase
    {
        public ProfileTeamDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~ProfileTeamDetailRepository()
        {
        }
    }
}
