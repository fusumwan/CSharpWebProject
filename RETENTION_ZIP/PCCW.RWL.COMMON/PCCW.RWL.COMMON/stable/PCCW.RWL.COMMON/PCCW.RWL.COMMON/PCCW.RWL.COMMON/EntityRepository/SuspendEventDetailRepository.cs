...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class SuspendEventDetailRepository : SuspendEventDetailRepositoryBase
    {
        public SuspendEventDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~SuspendEventDetailRepository()
        {
        }
    }
}
