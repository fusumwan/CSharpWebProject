...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderFalloutRepository : MobileOrderFalloutRepositoryBase
    {
        public MobileOrderFalloutRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderFalloutRepository()
        {
        }
    }
}
