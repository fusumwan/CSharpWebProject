...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class HandSetOfferedBasketRepository : HandSetOfferedBasketRepositoryBase
    {
        public HandSetOfferedBasketRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~HandSetOfferedBasketRepository()
        {
        }
    }
}
