...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class RetentionProgramKeyRepository : RetentionProgramKeyRepositoryBase
    {
        public RetentionProgramKeyRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~RetentionProgramKeyRepository()
        {
        }
    }
}
