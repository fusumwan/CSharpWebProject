...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportHistoryRepository : MobileOrderReportHistoryRepositoryBase
    {
        public MobileOrderReportHistoryRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportHistoryRepository()
        {
        }
    }
}
