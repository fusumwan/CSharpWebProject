...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderVasRepository : MobileOrderVasRepositoryBase
    {
        public MobileOrderVasRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderVasRepository()
        {
        }
    }
}
