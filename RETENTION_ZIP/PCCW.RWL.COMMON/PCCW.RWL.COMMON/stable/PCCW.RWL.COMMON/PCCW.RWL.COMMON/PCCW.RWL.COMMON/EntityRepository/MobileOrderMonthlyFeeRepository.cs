...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderMonthlyFeeRepository : MobileOrderMonthlyFeeRepositoryBase
    {
        public MobileOrderMonthlyFeeRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderMonthlyFeeRepository()
        {
        }
    }
}
