...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class ProgramRebateMappingRepository : ProgramRebateMappingRepositoryBase
    {
        public ProgramRebateMappingRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~ProgramRebateMappingRepository()
        {
        }
    }
}
