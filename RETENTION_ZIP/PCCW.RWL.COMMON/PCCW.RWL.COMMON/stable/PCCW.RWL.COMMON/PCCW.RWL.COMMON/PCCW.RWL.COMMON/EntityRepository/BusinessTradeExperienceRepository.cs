...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class BusinessTradeExperienceRepository : BusinessTradeExperienceRepositoryBase
    {
        public BusinessTradeExperienceRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~BusinessTradeExperienceRepository()
        {
        }
    }
}
