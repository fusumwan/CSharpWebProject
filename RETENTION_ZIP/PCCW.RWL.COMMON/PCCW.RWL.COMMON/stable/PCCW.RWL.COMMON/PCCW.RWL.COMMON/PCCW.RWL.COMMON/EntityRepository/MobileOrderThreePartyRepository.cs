...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderThreePartyRepository : MobileOrderThreePartyRepositoryBase
    {
        public MobileOrderThreePartyRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderThreePartyRepository()
        {
        }
    }
}
