...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class DOAProfileRecordRepository : DOAProfileRecordRepositoryBase
    {
        public DOAProfileRecordRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~DOAProfileRecordRepository()
        {
        }
    }
}
