...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderSyncSearchRepository : MobileOrderSyncSearchRepositoryBase
    {
        public MobileOrderSyncSearchRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderSyncSearchRepository()
        {
        }
    }
}
