...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileManualAssignedHistoryRepository : MobileManualAssignedHistoryRepositoryBase
    {
        public MobileManualAssignedHistoryRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileManualAssignedHistoryRepository()
        {
        }
    }
}
