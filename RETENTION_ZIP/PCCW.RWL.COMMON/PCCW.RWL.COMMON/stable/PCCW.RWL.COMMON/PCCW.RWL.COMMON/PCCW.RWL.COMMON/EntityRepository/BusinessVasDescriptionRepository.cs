...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class BusinessVasDescriptionRepository : BusinessVasDescriptionRepositoryBase
    {
        public BusinessVasDescriptionRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~BusinessVasDescriptionRepository()
        {
        }
    }
}
