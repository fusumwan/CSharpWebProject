...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class SpecialPremiumRepository : SpecialPremiumRepositoryBase
    {
        public SpecialPremiumRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~SpecialPremiumRepository()
        {
        }
    }
}
