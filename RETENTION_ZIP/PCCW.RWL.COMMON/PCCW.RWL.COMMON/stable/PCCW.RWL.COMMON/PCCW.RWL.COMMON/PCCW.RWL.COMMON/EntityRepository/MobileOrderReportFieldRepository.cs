...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportFieldRepository : MobileOrderReportFieldRepositoryBase
    {
        public MobileOrderReportFieldRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportFieldRepository()
        {
        }
    }
}
