...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class TariffFeeScheduleRepository : TariffFeeScheduleRepositoryBase
    {
        public TariffFeeScheduleRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~TariffFeeScheduleRepository()
        {
        }
    }
}
