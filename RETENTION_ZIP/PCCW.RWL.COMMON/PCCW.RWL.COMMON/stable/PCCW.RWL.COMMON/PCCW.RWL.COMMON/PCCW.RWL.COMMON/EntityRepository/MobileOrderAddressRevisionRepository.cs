...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderAddressRevisionRepository : MobileOrderAddressRevisionRepositoryBase
    {
        public MobileOrderAddressRevisionRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderAddressRevisionRepository()
        {
        }
    }
}
