...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class HandSetOfferTypeRepository : HandSetOfferTypeRepositoryBase
    {
        public HandSetOfferTypeRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~HandSetOfferTypeRepository()
        {
        }
    }
}
