...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderMNPDetailRepository : MobileOrderMNPDetailRepositoryBase
    {
        public MobileOrderMNPDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderMNPDetailRepository()
        {
        }
    }
}
