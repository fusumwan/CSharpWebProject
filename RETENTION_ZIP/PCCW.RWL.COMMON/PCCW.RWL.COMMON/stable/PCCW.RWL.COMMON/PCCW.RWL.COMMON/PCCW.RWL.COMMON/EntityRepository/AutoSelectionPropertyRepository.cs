...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class AutoSelectionPropertyRepository : AutoSelectionPropertyRepositoryBase
    {
        public AutoSelectionPropertyRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~AutoSelectionPropertyRepository()
        {
        }
    }
}
