...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class BusinessActionDefaultSetRepository : BusinessActionDefaultSetRepositoryBase
    {
        public BusinessActionDefaultSetRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~BusinessActionDefaultSetRepository()
        {
        }
    }
}
