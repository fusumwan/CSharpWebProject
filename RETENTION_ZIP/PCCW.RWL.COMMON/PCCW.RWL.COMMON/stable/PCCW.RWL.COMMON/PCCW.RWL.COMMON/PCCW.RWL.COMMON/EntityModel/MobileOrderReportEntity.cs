...
namespace PCCW.RWL.CORE{
    ...
    [global::System.Data.Linq.Mapping.Table(Name = Configurator.MSSQLTablePrefix+"MobileOrderReport")]
    public class MobileOrderReportEntity: global::System.IDisposable ,global::NEURON.ENTITY.FRAMEWORK.IEntity<MSSQLConnect>{
        ...
        private MobileOrderReportInfo n_oTableSet = MobileOrderReportInfoDLL.CreateInfoInstanceObject();
        ...
        public class Para{
            ...
            public const string MobileOrderReport_table_name="MobileOrderReport";
            public static string TableName() { return MobileOrderReport_table_name; }
        }
        #endregion Parameter String
        
        #region Constructor
        public MobileOrderReportEntity(){
            Init();
        }
        public MobileOrderReportEntity(MSSQLConnect x_oDB){
            n_oDB=x_oDB;
            Init();
        }
        
        public MobileOrderReportEntity(MSSQLConnect x_oDB,global::System.Nullable<int> x_iMid){
            n_oDB=x_oDB;
            this.Load(x_iMid);
            Init();
        }
        
        ~MobileOrderReportEntity(){
            this.Release();
        }
        #endregion
        ...
        public bool Load(global::System.Nullable<int> x_iMid){
            ...
            using(global::System.Data.SqlClient.SqlConnection _oConn = n_oDB.GetConnection()){
                ...
                try
                {
                    ...
                    {
                        n_bFound = true;
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_ORDER_STATUS"])) {n_sOrder_status = (string)_oData["MOBILEORDERREPORT_ORDER_STATUS"];}else{n_sOrder_status=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_GW_RETRIEVE_SN"])) {n_sGw_retrieve_sn = (string)_oData["MOBILEORDERREPORT_GW_RETRIEVE_SN"];}else{n_sGw_retrieve_sn=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_SENT_AGAIN"])) {n_iSent_again = (global::System.Nullable<int>)_oData["MOBILEORDERREPORT_SENT_AGAIN"];}else{n_iSent_again=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_MID"])) {n_iMid = (global::System.Nullable<int>)_oData["MOBILEORDERREPORT_MID"];}else{n_iMid=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_EMAIL_DATE"])) {n_dEmail_date = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_EMAIL_DATE"];}else{n_dEmail_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_RETRIEVE_CNT"])) {n_iRetrieve_cnt = (global::System.Nullable<int>)_oData["MOBILEORDERREPORT_RETRIEVE_CNT"];}else{n_iRetrieve_cnt=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_FS_SENT_AGAIN_RETRIEVE_DATE"])) {n_dFs_sent_again_retrieve_date = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_FS_SENT_AGAIN_RETRIEVE_DATE"];}else{n_dFs_sent_again_retrieve_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_CDATE"])) {n_dCdate = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_CDATE"];}else{n_dCdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_RETRIEVE_SN"])) {n_sRetrieve_sn = (string)_oData["MOBILEORDERREPORT_RETRIEVE_SN"];}else{n_sRetrieve_sn=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_CID"])) {n_sCid = (string)_oData["MOBILEORDERREPORT_CID"];}else{n_sCid=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_DID"])) {n_sDid = (string)_oData["MOBILEORDERREPORT_DID"];}else{n_sDid=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_SENT_AGAIN_DATE"])) {n_dSent_again_date = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_SENT_AGAIN_DATE"];}else{n_dSent_again_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_IDD_VAS"])) {n_sIdd_vas = (string)_oData["MOBILEORDERREPORT_IDD_VAS"];}else{n_sIdd_vas=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_ACTIVE"])) {n_bActive = (global::System.Nullable<bool>)_oData["MOBILEORDERREPORT_ACTIVE"];}else{n_bActive=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_FALLOUT_REASON"])) {n_sFallout_reason = (string)_oData["MOBILEORDERREPORT_FALLOUT_REASON"];}else{n_sFallout_reason=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_FALLOUT_REMARK"])) {n_sFallout_remark = (string)_oData["MOBILEORDERREPORT_FALLOUT_REMARK"];}else{n_sFallout_remark=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_FALLOUT_MAIN_CATEGORY"])) {n_sFallout_main_category = (string)_oData["MOBILEORDERREPORT_FALLOUT_MAIN_CATEGORY"];}else{n_sFallout_main_category=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_GW_RETRIEVE_DATE"])) {n_dGw_retrieve_date = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_GW_RETRIEVE_DATE"];}else{n_dGw_retrieve_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_REPORT_TYPE"])) {n_sReport_type = (string)_oData["MOBILEORDERREPORT_REPORT_TYPE"];}else{n_sReport_type=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_REACTIVE_SN"])) {n_sReactive_sn = (string)_oData["MOBILEORDERREPORT_REACTIVE_SN"];}else{n_sReactive_sn=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_DDATE"])) {n_dDdate = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_DDATE"];}else{n_dDdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_EXT_PLACE_TEL"])) {n_sExt_place_tel = (string)_oData["MOBILEORDERREPORT_EXT_PLACE_TEL"];}else{n_sExt_place_tel=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_REACTIVE_DATE"])) {n_dReactive_date = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_REACTIVE_DATE"];}else{n_dReactive_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_ORDER_ID"])) {n_iOrder_id = (global::System.Nullable<int>)_oData["MOBILEORDERREPORT_ORDER_ID"];}else{n_iOrder_id=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_RETRIEVE_DATE"])) {n_dRetrieve_date = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_RETRIEVE_DATE"];}else{n_dRetrieve_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_PY_SENT_AGAIN_RETRIEVE_DATE"])) {n_dPy_sent_again_retrieve_date = (global::System.Nullable<DateTime>)_oData["MOBILEORDERREPORT_PY_SENT_AGAIN_RETRIEVE_DATE"];}else{n_dPy_sent_again_retrieve_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["MOBILEORDERREPORT_FALLOUT_REPLY"])) {n_sFallout_reply = (string)_oData["MOBILEORDERREPORT_FALLOUT_REPLY"];}else{n_sFallout_reply=global::System.String.Empty;}
                    }
                    _oData.Close();
                    _oData.Dispose();
                }
        ...
        public object GetRepositoryObject(object x_oObj)
        {
            ...
            if (x_oObj.GetType().IsSubclassOf(typeof(MobileOrderReportEntity)) || (x_oObj is MobileOrderReportEntity)) return MobileOrderReportRepository.Instance();
            return null;
        }
        ...
        #region GetTableSet
        public MobileOrderReportInfo GetTableSet(){ return n_oTableSet; }
        #endregion GetTableSet
        
        
        #region SetTableSet
        public void SetTableSet(MobileOrderReportInfo value){ n_oTableSet=value; }
        ...
        public bool EqualID(MobileOrderReport x_oObj)
        {
        ...
        public bool Equals(MobileOrderReport x_oObj)
        {
            if (x_oObj == null) return false;
        ...
        public bool Save()
        {
            ...
            string _sQuery = "UPDATE  [MobileOrderReport]  SET  [order_status]=@order_status,[gw_retrieve_sn]=@gw_retrieve_sn,[sent_again]=@sent_again,[email_date]=@email_date,[retrieve_cnt]=@retrieve_cnt,[fs_sent_again_retrieve_date]=@fs_sent_again_retrieve_date,[cdate]=@cdate,[retrieve_sn]=@retrieve_sn,[cid]=@cid,[did]=@did,[sent_again_date]=@sent_again_date,[idd_vas]=@idd_vas,[active]=@active,[fallout_reason]=@fallout_reason,[fallout_remark]=@fallout_remark,[fallout_main_category]=@fallout_main_category,[gw_retrieve_date]=@gw_retrieve_date,[report_type]=@report_type,[reactive_sn]=@reactive_sn,[ddate]=@ddate,[ext_place_tel]=@ext_place_tel,[reactive_date]=@reactive_date,[order_id]=@order_id,[retrieve_date]=@retrieve_date,[py_sent_again_retrieve_date]=@py_sent_again_retrieve_date,[fallout_reply]=@fallout_reply  WHERE [MobileOrderReport].[mid]=@mid";
            if (!"".Equals(Configurator.MSSQLTablePrefix)) { _sQuery = _sQuery.Replace("[MobileOrderReport]","["+ Configurator.MSSQLTablePrefix + "MobileOrderReport]"); }
            ...
            if(n_sFallout_reason==null){  _oCmd.Parameters.Add("@fallout_reason", global::System.Data.SqlDbType.NVarChar,250).Value = DBNull.Value; }else{  _oCmd.Parameters.Add("@fallout_reason", global::System.Data.SqlDbType.NVarChar,250).Value=n_sFallout_reason; }
        ...
        /// <summary>
        /// Summary description for table [MobileOrderReport] Delete Record
        /// </summary>
        ...
        /// <summary>
        /// Summary description for table [MobileOrderReport] Object Base Clone
        /// </summary>
        
        public MobileOrderReport DeepClone()
        {
            MobileOrderReport _oMobileOrderReport_Clone = new MobileOrderReport();
            _oMobileOrderReport_Clone.order_status = this.n_sOrder_status;
            _oMobileOrderReport_Clone.gw_retrieve_sn = this.n_sGw_retrieve_sn;
            _oMobileOrderReport_Clone.sent_again = this.n_iSent_again;
            _oMobileOrderReport_Clone.mid = this.n_iMid;
            _oMobileOrderReport_Clone.email_date = this.n_dEmail_date;
            _oMobileOrderReport_Clone.retrieve_cnt = this.n_iRetrieve_cnt;
            _oMobileOrderReport_Clone.fs_sent_again_retrieve_date = this.n_dFs_sent_again_retrieve_date;
            _oMobileOrderReport_Clone.cdate = this.n_dCdate;
            _oMobileOrderReport_Clone.retrieve_sn = this.n_sRetrieve_sn;
            _oMobileOrderReport_Clone.cid = this.n_sCid;
            _oMobileOrderReport_Clone.did = this.n_sDid;
            _oMobileOrderReport_Clone.sent_again_date = this.n_dSent_again_date;
            _oMobileOrderReport_Clone.idd_vas = this.n_sIdd_vas;
            _oMobileOrderReport_Clone.active = this.n_bActive;
            _oMobileOrderReport_Clone.fallout_reason = this.n_sFallout_reason;
            _oMobileOrderReport_Clone.fallout_remark = this.n_sFallout_remark;
            _oMobileOrderReport_Clone.fallout_main_category = this.n_sFallout_main_category;
            _oMobileOrderReport_Clone.gw_retrieve_date = this.n_dGw_retrieve_date;
            _oMobileOrderReport_Clone.report_type = this.n_sReport_type;
            _oMobileOrderReport_Clone.reactive_sn = this.n_sReactive_sn;
            _oMobileOrderReport_Clone.ddate = this.n_dDdate;
            _oMobileOrderReport_Clone.ext_place_tel = this.n_sExt_place_tel;
            _oMobileOrderReport_Clone.reactive_date = this.n_dReactive_date;
            _oMobileOrderReport_Clone.order_id = this.n_iOrder_id;
            _oMobileOrderReport_Clone.retrieve_date = this.n_dRetrieve_date;
            _oMobileOrderReport_Clone.py_sent_again_retrieve_date = this.n_dPy_sent_again_retrieve_date;
            _oMobileOrderReport_Clone.fallout_reply = this.n_sFallout_reply;
            _oMobileOrderReport_Clone.SetFound(this.n_bFound);
            _oMobileOrderReport_Clone.SetDB(this.n_oDB);
            _oMobileOrderReport_Clone.SetRow(this.n_oRow);
            _oMobileOrderReport_Clone.SetTbl(this.n_oTbl);
            _oMobileOrderReport_Clone.SetTableSet(this.n_oTableSet);
            
            return _oMobileOrderReport_Clone;
        }
        #endregion
        ...
        public void Release(){
            ...
            n_oTbl = null;
            n_oRow = null;
            n_oTableSet = MobileOrderReportInfoDLL.CreateInfoInstanceObject();
        }
        #endregion
    }
}
