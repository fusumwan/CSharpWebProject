...
namespace PCCW.RWL.CORE{
    ...
    [global::System.Data.Linq.Mapping.Table(Name = Configurator.MSSQLTablePrefix+"BusinessTradeExperience")]
    public class BusinessTradeExperienceEntity: global::System.IDisposable ,global::NEURON.ENTITY.FRAMEWORK.IEntity<MSSQLConnect>{
        ...
        private BusinessTradeExperienceInfo n_oTableSet = BusinessTradeExperienceInfoDLL.CreateInfoInstanceObject();
        ...
        public class Para{
            ...
            public const string BusinessTradeExperience_table_name="BusinessTradeExperience";
            public static string TableName() { return BusinessTradeExperience_table_name; }
        }
        #endregion Parameter String
        
        #region Constructor
        public BusinessTradeExperienceEntity(){
            Init();
        }
        public BusinessTradeExperienceEntity(MSSQLConnect x_oDB){
            n_oDB=x_oDB;
            Init();
        }
        
        public BusinessTradeExperienceEntity(MSSQLConnect x_oDB,global::System.Nullable<int> x_iMid){
            n_oDB=x_oDB;
            this.Load(x_iMid);
            Init();
        }
        
        ~BusinessTradeExperienceEntity(){
            this.Release();
        }
        #endregion
        ...
        public bool Load(global::System.Nullable<int> x_iMid){
            ...
            using(global::System.Data.SqlClient.SqlConnection _oConn = n_oDB.GetConnection()){
                ...
                try
                {
                    ...
                    {
                        n_bFound = true;
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_REC_NO"])) {n_iRec_no = (global::System.Nullable<int>)_oData["BUSINESSTRADEEXPERIENCE_REC_NO"];}else{n_iRec_no=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_MID"])) {n_iMid = (global::System.Nullable<int>)_oData["BUSINESSTRADEEXPERIENCE_MID"];}else{n_iMid=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_CHANNEL"])) {n_sChannel = (string)_oData["BUSINESSTRADEEXPERIENCE_CHANNEL"];}else{n_sChannel=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_CDATE"])) {n_dCdate = (global::System.Nullable<DateTime>)_oData["BUSINESSTRADEEXPERIENCE_CDATE"];}else{n_dCdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_BUNDLE_NAME"])) {n_sBundle_name = (string)_oData["BUSINESSTRADEEXPERIENCE_BUNDLE_NAME"];}else{n_sBundle_name=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_HS_MODEL_NAME"])) {n_sHs_model_name = (string)_oData["BUSINESSTRADEEXPERIENCE_HS_MODEL_NAME"];}else{n_sHs_model_name=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_TRADE_FIELD"])) {n_sTrade_field = (string)_oData["BUSINESSTRADEEXPERIENCE_TRADE_FIELD"];}else{n_sTrade_field=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_DID"])) {n_sDid = (string)_oData["BUSINESSTRADEEXPERIENCE_DID"];}else{n_sDid=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_PREMIUM_1"])) {n_sPremium_1 = (string)_oData["BUSINESSTRADEEXPERIENCE_PREMIUM_1"];}else{n_sPremium_1=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_SDATE"])) {n_dSdate = (global::System.Nullable<DateTime>)_oData["BUSINESSTRADEEXPERIENCE_SDATE"];}else{n_dSdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_REBATE"])) {n_sRebate = (string)_oData["BUSINESSTRADEEXPERIENCE_REBATE"];}else{n_sRebate=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_PREMIUM_2"])) {n_sPremium_2 = (string)_oData["BUSINESSTRADEEXPERIENCE_PREMIUM_2"];}else{n_sPremium_2=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_PO_DATE"])) {n_dPo_date = (global::System.Nullable<DateTime>)_oData["BUSINESSTRADEEXPERIENCE_PO_DATE"];}else{n_dPo_date=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_RETENTION_TYPE"])) {n_sRetention_type = (string)_oData["BUSINESSTRADEEXPERIENCE_RETENTION_TYPE"];}else{n_sRetention_type=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_EXTRA_OFFER"])) {n_sExtra_offer = (string)_oData["BUSINESSTRADEEXPERIENCE_EXTRA_OFFER"];}else{n_sExtra_offer=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_EDATE"])) {n_dEdate = (global::System.Nullable<DateTime>)_oData["BUSINESSTRADEEXPERIENCE_EDATE"];}else{n_dEdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_PROGRAM"])) {n_sProgram = (string)_oData["BUSINESSTRADEEXPERIENCE_PROGRAM"];}else{n_sProgram=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_OB_EARLY"])) {n_sOb_early = (string)_oData["BUSINESSTRADEEXPERIENCE_OB_EARLY"];}else{n_sOb_early=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_CON_PER"])) {n_sCon_per = (string)_oData["BUSINESSTRADEEXPERIENCE_CON_PER"];}else{n_sCon_per=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_DDATE"])) {n_dDdate = (global::System.Nullable<DateTime>)_oData["BUSINESSTRADEEXPERIENCE_DDATE"];}else{n_dDdate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_NORMAL_REBATE_TYPE"])) {n_sNormal_rebate_type = (string)_oData["BUSINESSTRADEEXPERIENCE_NORMAL_REBATE_TYPE"];}else{n_sNormal_rebate_type=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_ACTIVE"])) {n_bActive = (global::System.Nullable<bool>)_oData["BUSINESSTRADEEXPERIENCE_ACTIVE"];}else{n_bActive=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_FREE_MON"])) {n_sFree_mon = (string)_oData["BUSINESSTRADEEXPERIENCE_FREE_MON"];}else{n_sFree_mon=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_CID"])) {n_sCid = (string)_oData["BUSINESSTRADEEXPERIENCE_CID"];}else{n_sCid=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_CANCEL_RENEW"])) {n_bCancel_renew = (global::System.Nullable<bool>)_oData["BUSINESSTRADEEXPERIENCE_CANCEL_RENEW"];}else{n_bCancel_renew=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_RATE_PLAN"])) {n_sRate_plan = (string)_oData["BUSINESSTRADEEXPERIENCE_RATE_PLAN"];}else{n_sRate_plan=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_NORMAL_REBATE"])) {n_bNormal_rebate = (global::System.Nullable<bool>)_oData["BUSINESSTRADEEXPERIENCE_NORMAL_REBATE"];}else{n_bNormal_rebate=null;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_HS_MODEL"])) {n_sHs_model = (string)_oData["BUSINESSTRADEEXPERIENCE_HS_MODEL"];}else{n_sHs_model=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_PLAN_FEE"])) {n_sPlan_fee = (string)_oData["BUSINESSTRADEEXPERIENCE_PLAN_FEE"];}else{n_sPlan_fee=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_REMARKS"])) {n_sRemarks = (string)_oData["BUSINESSTRADEEXPERIENCE_REMARKS"];}else{n_sRemarks=global::System.String.Empty;}
                        if (!global::System.Convert.IsDBNull(_oData["BUSINESSTRADEEXPERIENCE_ISSUE_TYPE"])) {n_sIssue_type = (string)_oData["BUSINESSTRADEEXPERIENCE_ISSUE_TYPE"];}else{n_sIssue_type=global::System.String.Empty;}
                    }
                    _oData.Close();
                    _oData.Dispose();
                }
        ...
        public object GetRepositoryObject(object x_oObj)
        {
            ...
            if (x_oObj.GetType().IsSubclassOf(typeof(BusinessTradeExperienceEntity)) || (x_oObj is BusinessTradeExperienceEntity)) return BusinessTradeExperienceRepository.Instance();
            return null;
        }
        ...
        #region GetTableSet
        public BusinessTradeExperienceInfo GetTableSet(){ return n_oTableSet; }
        #endregion GetTableSet
        
        
        #region SetTableSet
        public void SetTableSet(BusinessTradeExperienceInfo value){ n_oTableSet=value; }
        ...
        public bool EqualID(BusinessTradeExperience x_oObj)
        {
        ...
        public bool Equals(BusinessTradeExperience x_oObj)
        {
            if (x_oObj == null) return false;
        ...
        public bool Save()
        {
            ...
            string _sQuery = "UPDATE  [BusinessTradeExperience]  SET  [rec_no]=@rec_no,[channel]=@channel,[cdate]=@cdate,[bundle_name]=@bundle_name,[hs_model_name]=@hs_model_name,[trade_field]=@trade_field,[did]=@did,[premium_1]=@premium_1,[sdate]=@sdate,[rebate]=@rebate,[premium_2]=@premium_2,[po_date]=@po_date,[retention_type]=@retention_type,[extra_offer]=@extra_offer,[edate]=@edate,[program]=@program,[ob_early]=@ob_early,[con_per]=@con_per,[ddate]=@ddate,[normal_rebate_type]=@normal_rebate_type,[active]=@active,[free_mon]=@free_mon,[cid]=@cid,[cancel_renew]=@cancel_renew,[rate_plan]=@rate_plan,[normal_rebate]=@normal_rebate,[hs_model]=@hs_model,[plan_fee]=@plan_fee,[remarks]=@remarks,[issue_type]=@issue_type  WHERE [BusinessTradeExperience].[mid]=@mid";
            if (!"".Equals(Configurator.MSSQLTablePrefix)) { _sQuery = _sQuery.Replace("[BusinessTradeExperience]","["+ Configurator.MSSQLTablePrefix + "BusinessTradeExperience]"); }
            ...
            if(n_sPremium_1==null){  _oCmd.Parameters.Add("@premium_1", global::System.Data.SqlDbType.VarChar,250).Value = DBNull.Value; }else{  _oCmd.Parameters.Add("@premium_1", global::System.Data.SqlDbType.VarChar,250).Value=n_sPremium_1; }
            ...
            if(n_sPremium_2==null){  _oCmd.Parameters.Add("@premium_2", global::System.Data.SqlDbType.VarChar,250).Value = DBNull.Value; }else{  _oCmd.Parameters.Add("@premium_2", global::System.Data.SqlDbType.VarChar,250).Value=n_sPremium_2; }
        ...
        /// <summary>
        /// Summary description for table [BusinessTradeExperience] Delete Record
        /// </summary>
        ...
        /// <summary>
        /// Summary description for table [BusinessTradeExperience] Object Base Clone
        /// </summary>
        
        public BusinessTradeExperience DeepClone()
        {
            BusinessTradeExperience _oBusinessTradeExperience_Clone = new BusinessTradeExperience();
            _oBusinessTradeExperience_Clone.rec_no = this.n_iRec_no;
            _oBusinessTradeExperience_Clone.mid = this.n_iMid;
            _oBusinessTradeExperience_Clone.channel = this.n_sChannel;
            _oBusinessTradeExperience_Clone.cdate = this.n_dCdate;
            _oBusinessTradeExperience_Clone.bundle_name = this.n_sBundle_name;
            _oBusinessTradeExperience_Clone.hs_model_name = this.n_sHs_model_name;
            _oBusinessTradeExperience_Clone.trade_field = this.n_sTrade_field;
            _oBusinessTradeExperience_Clone.did = this.n_sDid;
            _oBusinessTradeExperience_Clone.premium_1 = this.n_sPremium_1;
            _oBusinessTradeExperience_Clone.sdate = this.n_dSdate;
            _oBusinessTradeExperience_Clone.rebate = this.n_sRebate;
            _oBusinessTradeExperience_Clone.premium_2 = this.n_sPremium_2;
            _oBusinessTradeExperience_Clone.po_date = this.n_dPo_date;
            _oBusinessTradeExperience_Clone.retention_type = this.n_sRetention_type;
            _oBusinessTradeExperience_Clone.extra_offer = this.n_sExtra_offer;
            _oBusinessTradeExperience_Clone.edate = this.n_dEdate;
            _oBusinessTradeExperience_Clone.program = this.n_sProgram;
            _oBusinessTradeExperience_Clone.ob_early = this.n_sOb_early;
            _oBusinessTradeExperience_Clone.con_per = this.n_sCon_per;
            _oBusinessTradeExperience_Clone.ddate = this.n_dDdate;
            _oBusinessTradeExperience_Clone.normal_rebate_type = this.n_sNormal_rebate_type;
            _oBusinessTradeExperience_Clone.active = this.n_bActive;
            _oBusinessTradeExperience_Clone.free_mon = this.n_sFree_mon;
            _oBusinessTradeExperience_Clone.cid = this.n_sCid;
            _oBusinessTradeExperience_Clone.cancel_renew = this.n_bCancel_renew;
            _oBusinessTradeExperience_Clone.rate_plan = this.n_sRate_plan;
            _oBusinessTradeExperience_Clone.normal_rebate = this.n_bNormal_rebate;
            _oBusinessTradeExperience_Clone.hs_model = this.n_sHs_model;
            _oBusinessTradeExperience_Clone.plan_fee = this.n_sPlan_fee;
            _oBusinessTradeExperience_Clone.remarks = this.n_sRemarks;
            _oBusinessTradeExperience_Clone.issue_type = this.n_sIssue_type;
            _oBusinessTradeExperience_Clone.SetFound(this.n_bFound);
            _oBusinessTradeExperience_Clone.SetDB(this.n_oDB);
            _oBusinessTradeExperience_Clone.SetRow(this.n_oRow);
            _oBusinessTradeExperience_Clone.SetTbl(this.n_oTbl);
            _oBusinessTradeExperience_Clone.SetTableSet(this.n_oTableSet);
            
            return _oBusinessTradeExperience_Clone;
        }
        #endregion
        ...
        public void Release(){
            ...
            n_oTbl = null;
            n_oRow = null;
            n_oTableSet = BusinessTradeExperienceInfoDLL.CreateInfoInstanceObject();
        }
        #endregion
    }
}
