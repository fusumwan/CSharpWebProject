...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderThreePartyRevisionRepository : MobileOrderThreePartyRevisionRepositoryBase
    {
        public MobileOrderThreePartyRevisionRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderThreePartyRevisionRepository()
        {
        }
    }
}
