...
///-- Description:	<Description,Table :[ProfileTeamRecord], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [ProfileTeamRecord] Information layer
    /// </summary>
    public abstract class ProfileTeamRecordInfoDLL{
        ...
        public static ProfileTeamRecordInfo CreateInfoInstanceObject(){
            return new ProfileTeamRecordInfo();
        }
        #endregion
        #region Constructor
        
        public ProfileTeamRecordInfoDLL(){
            Init();
        }
        ~ProfileTeamRecordInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = ProfileTeamRecord.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = ProfileTeamRecord.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = ProfileTeamRecord.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = ProfileTeamRecord.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = ProfileTeamRecord.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = ProfileTeamRecord.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [remark] Field
            _sStrFldName = ProfileTeamRecord.Para.remark;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = ProfileTeamRecord.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [salesman_code] Field
            _sStrFldName = ProfileTeamRecord.Para.salesman_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [staff_no] Field
            _sStrFldName = ProfileTeamRecord.Para.staff_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = ProfileTeamRecord.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [sdate] Field
            _sStrFldName = ProfileTeamRecord.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.did);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.active);
        }
        public Field GetRemarkTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.remark);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.edate);
        }
        public Field GetSalesman_codeTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.salesman_code);
        }
        public Field GetStaff_noTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.staff_no);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.ddate);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(ProfileTeamRecord.Para.sdate);
        }
