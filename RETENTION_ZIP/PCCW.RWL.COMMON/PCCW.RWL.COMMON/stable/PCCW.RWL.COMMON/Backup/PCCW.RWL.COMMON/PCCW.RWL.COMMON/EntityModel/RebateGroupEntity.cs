...
namespace PCCW.RWL.CORE
{
    ...
    [global::System.Data.Linq.Mapping.Table(Name = Configurator.MSSQLTablePrefix + "RebateGroup")]
    public class RebateGroupEntity : global::System.IDisposable, global::NEURON.ENTITY.FRAMEWORK.IEntity<MSSQLConnect>
    {
        ...
        protected string n_sGp = string.Empty;
        #region gp
        [System.Data.Linq.Mapping.Column(Name = "[gp]", Storage = "n_sGp")]
        public string gp
        {
            get
            {
        ...
        private RebateGroupInfo n_oTableSet = new RebateGroupInfo();
        ...
        public class Para
        {
            ...
            public const string RebateGroup_table_name = Configurator.MSSQLTablePrefix + "RebateGroup";
            public static string TableName() { return RebateGroup_table_name; }
        }
        #endregion Parameter String

        #region Constructor
        public RebateGroupEntity()
        {
            Init();
        }
        public RebateGroupEntity(MSSQLConnect x_oDB)
        {
            n_oDB = x_oDB;
            Init();
        }

        public RebateGroupEntity(MSSQLConnect x_oDB, System.Nullable<int> x_iMid)
        {
            n_oDB = x_oDB;
            this.Load(x_iMid);
            Init();
        ...
        public bool Load(global::System.Nullable<int> x_iMid)
        {
            ...
            using (global::System.Data.SqlClient.SqlConnection _oConn = n_oDB.GetConnection())
            {
                ...
                try
                {
                    ...
                    {
                        n_bFound = true;
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_ACTIVE"])) { n_bActive = (global::System.Nullable<bool>)_oData["REBATEGROUP_ACTIVE"]; } else { n_bActive = null; }
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_CDATE"])) { n_dCdate = (global::System.Nullable<DateTime>)_oData["REBATEGROUP_CDATE"]; } else { n_dCdate = null; }
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_CID"])) { n_sCid = (string)_oData["REBATEGROUP_CID"]; } else { n_sCid = string.Empty; }
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_DID"])) { n_sDid = (string)_oData["REBATEGROUP_DID"]; } else { n_sDid = string.Empty; }
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_PROGRAM"])) { n_sProgram = (string)_oData["REBATEGROUP_PROGRAM"]; } else { n_sProgram = string.Empty; }
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_DDATE"])) { n_dDdate = (global::System.Nullable<DateTime>)_oData["REBATEGROUP_DDATE"]; } else { n_dDdate = null; }
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_GP"])) { n_sGp = (string)_oData["REBATEGROUP_GP"]; } else { n_sGp = string.Empty; }
                        if (!global::System.Convert.IsDBNull(_oData["REBATEGROUP_MID"])) { n_iMid = (global::System.Nullable<int>)_oData["REBATEGROUP_MID"]; } else { n_iMid = null; }
                    }
                    _oData.Close();
                    _oData.Dispose();
                }
        ...
        public bool Vaild(bool x_bInsert)
        {
            ...
            if (n_sGp == null && !(n_oTableSet.Fields(Para.gp).IsNullable)) return false;
            if (!x_bInsert)
            {
        ...
        {
            if ((x_oObj is RebateGroup) || (x_oObj is RebateGroupEntity)) return RebateGroupRepository.Instance();
            return null;
        }
        ...
        #region GetTableSet
        public RebateGroupInfo GetTableSet() { return n_oTableSet; }
        #endregion GetTableSet


        #region SetTableSet
        public void SetTableSet(RebateGroupInfo value) { n_oTableSet = value; }
        ...
        public bool SetGp(string value)
        {
            this.gp = value;
            return true;
        }
        ...
        public Field GetGpTable()
        {
            return n_oTableSet.Fields(Para.gp);
        }
        ...
        public bool EqualID(RebateGroup x_oObj)
        {
        ...
        public bool Equals(RebateGroup x_oObj)
        {
            if (x_oObj == null) return false;
            ...
            if (!this.n_sGp.Equals(x_oObj.gp)) { return false; }
        ...
        public bool Save()
        {
            ...
            string _sQuery = "UPDATE  [RebateGroup]  SET  [active]=@active,[cdate]=@cdate,[cid]=@cid,[did]=@did,[program]=@program,[ddate]=@ddate,[gp]=@gp  WHERE [RebateGroup].[mid]=@mid";
            if (!"".Equals(Configurator.MSSQLTablePrefix)) { _sQuery = _sQuery.Replace("[RebateGroup]", "[" + Configurator.MSSQLTablePrefix + "RebateGroup]"); }
            ...
            if (n_sProgram == null) { _oCmd.Parameters.Add("@program", global::System.Data.SqlDbType.NVarChar, 100).Value = global::System.DBNull.Value; } else { _oCmd.Parameters.Add("@program", global::System.Data.SqlDbType.NVarChar, 100).Value = n_sProgram; }
            ...
            if (n_sGp == null) { _oCmd.Parameters.Add("@gp", global::System.Data.SqlDbType.NVarChar, 20).Value = global::System.DBNull.Value; } else { _oCmd.Parameters.Add("@gp", global::System.Data.SqlDbType.NVarChar, 20).Value = n_sGp; }
        ...
        /// <summary>
        /// Summary description for table [RebateGroup] Delete Record
        /// </summary>
        ...
        /// <summary>
        /// Summary description for table [RebateGroup] Object Base Clone
        /// </summary>

        public RebateGroup DeepClone()
        {
            RebateGroup _oRebateGroup_Clone = (RebateGroup)RebateGroupRepository.CreateEntityInstanceObject();
            _oRebateGroup_Clone.active = this.n_bActive;
            _oRebateGroup_Clone.cdate = this.n_dCdate;
            _oRebateGroup_Clone.cid = this.n_sCid;
            _oRebateGroup_Clone.did = this.n_sDid;
            _oRebateGroup_Clone.program = this.n_sProgram;
            _oRebateGroup_Clone.ddate = this.n_dDdate;
            _oRebateGroup_Clone.gp = this.n_sGp;
            _oRebateGroup_Clone.mid = this.n_iMid;
            _oRebateGroup_Clone.SetFound(this.n_bFound);
            _oRebateGroup_Clone.SetDB(this.n_oDB);
            _oRebateGroup_Clone.SetRow(this.n_oRow);
            _oRebateGroup_Clone.SetTbl(this.n_oTbl);
            _oRebateGroup_Clone.SetTableSet(this.n_oTableSet);

            return _oRebateGroup_Clone;
        }
        #endregion
        ...
        public void Release()
        {
            ...
            n_oTbl = null;
            n_oRow = null;
            n_oTableSet = new RebateGroupInfo();
        }
        #endregion
    }
}
