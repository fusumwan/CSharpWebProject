...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileOrderMNPDetailInfoDLL{
        ...
        public static MobileOrderMNPDetailInfo CreateInfoInstanceObject(){
            return new MobileOrderMNPDetailInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderMNPDetailInfoDLL(){
            Init();
        }
        ~MobileOrderMNPDetailInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderMNPDetail.Para.TableName();
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.service_activation_time;
            ...
            // [ticker_number] Field
            _sStrFldName = MobileOrderMNPDetail.Para.ticker_number;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [id_type] Field
            _sStrFldName = MobileOrderMNPDetail.Para.id_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.transfer_idd_roaming_deposit;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [company_name] Field
            _sStrFldName = MobileOrderMNPDetail.Para.company_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.service_activation_date;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mnp_id] Field
            _sStrFldName = MobileOrderMNPDetail.Para.mnp_id;
            n_oTableSet.Add(_sStrFldName);
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.transfer_others_deposit;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hkid] Field
            _sStrFldName = MobileOrderMNPDetail.Para.hkid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.transfer_to_3g;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.transfer_idd_deposit;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.transfer_no_add_proof_deposit;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileOrderMNPDetail.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.registered_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            _sStrFldName = MobileOrderMNPDetail.Para.transfer_no_hk_id_holder_deposit;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetService_activation_timeTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.service_activation_time);
        }
        public Field GetTicker_numberTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.ticker_number);
        }
        public Field GetId_typeTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.id_type);
        }
        public Field GetTransfer_idd_roaming_depositTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.transfer_idd_roaming_deposit);
        }
        public Field GetCompany_nameTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.company_name);
        }
        public Field GetService_activation_dateTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.service_activation_date);
        }
        public Field GetMnp_idTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.mnp_id);
        }
        public Field GetTransfer_others_depositTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.transfer_others_deposit);
        }
        public Field GetHkidTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.hkid);
        }
        public Field GetTransfer_to_3gTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.transfer_to_3g);
        }
        public Field GetTransfer_idd_depositTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.transfer_idd_deposit);
        }
        public Field GetTransfer_no_add_proof_depositTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.transfer_no_add_proof_deposit);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.order_id);
        }
        public Field GetRegistered_nameTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.registered_name);
        }
        public Field GetTransfer_no_hk_id_holder_depositTable(){
            return n_oTableSet.Fields(MobileOrderMNPDetail.Para.transfer_no_hk_id_holder_deposit);
        }
