...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class EventMsgDetailInfoDLL{
        ...
        public EventMsgDetailInfoDLL(){
            Init();
        }
        ~EventMsgDetailInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static EventMsgDetailInfo CreateInfoInstanceObject()
        {
            return new EventMsgDetailInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = EventMsgDetail.Para.TableName();
            ...
            // [cdate] Field
            _sStrFldName = EventMsgDetail.Para.cdate;
            ...
            // [active] Field
            _sStrFldName = EventMsgDetail.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [access_right] Field
            _sStrFldName = EventMsgDetail.Para.access_right;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[access_right]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "access_right";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[access_right]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "access_right";
            n_oTableSet.Fields(_sStrFldName).AliasName = "access_right";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "access_right";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [cid] Field
            _sStrFldName = EventMsgDetail.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = EventMsgDetail.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [message] Field
            _sStrFldName = EventMsgDetail.Para.message;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[message]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "message";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[message]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "message";
            n_oTableSet.Fields(_sStrFldName).AliasName = "message";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "message";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [edate] Field
            _sStrFldName = EventMsgDetail.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [subject] Field
            _sStrFldName = EventMsgDetail.Para.subject;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[subject]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "subject";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[subject]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "subject";
            n_oTableSet.Fields(_sStrFldName).AliasName = "subject";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "subject";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [ddate] Field
            _sStrFldName = EventMsgDetail.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mid] Field
            _sStrFldName = EventMsgDetail.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [sdate] Field
            _sStrFldName = EventMsgDetail.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetCdateTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.cdate);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.active);
        }
        public Field GetAccess_rightTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.access_right);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.did);
        }
        public Field GetMessageTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.message);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.edate);
        }
        public Field GetSubjectTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.subject);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.ddate);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.mid);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(EventMsgDetail.Para.sdate);
        }
