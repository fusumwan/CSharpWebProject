...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class MobileOrderReportDetailHistoryRepository : MobileOrderReportDetailHistoryRepositoryBase
    {
        public MobileOrderReportDetailHistoryRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~MobileOrderReportDetailHistoryRepository()
        {
        }
    }
}
