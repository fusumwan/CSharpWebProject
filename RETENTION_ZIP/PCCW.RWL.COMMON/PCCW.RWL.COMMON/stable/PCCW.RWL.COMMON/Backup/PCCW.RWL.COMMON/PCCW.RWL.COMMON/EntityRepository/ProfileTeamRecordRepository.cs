...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class ProfileTeamRecordRepository : ProfileTeamRecordRepositoryBase
    {
        public ProfileTeamRecordRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~ProfileTeamRecordRepository()
        {
        }
    }
}
