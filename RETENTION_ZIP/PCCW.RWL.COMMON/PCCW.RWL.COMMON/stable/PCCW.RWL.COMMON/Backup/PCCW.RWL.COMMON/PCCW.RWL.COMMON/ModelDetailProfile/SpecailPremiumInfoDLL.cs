...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class SpecialPremiumInfoDLL{
        ...
        public SpecialPremiumInfoDLL(){
            Init();
        }
        ~SpecialPremiumInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static SpecialPremiumInfo CreateInfoInstanceObject()
        {
            return new SpecialPremiumInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = SpecialPremium.Para.TableName();
            ...
            // [active] Field
            _sStrFldName = SpecialPremium.Para.active;
            ...
            // [cdate] Field
            _sStrFldName = SpecialPremium.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = SpecialPremium.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = SpecialPremium.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [con_per] Field
            _sStrFldName = SpecialPremium.Para.con_per;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [rate_plan] Field
            _sStrFldName = SpecialPremium.Para.rate_plan;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = SpecialPremium.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mid] Field
            _sStrFldName = SpecialPremium.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [s_premium] Field
            _sStrFldName = SpecialPremium.Para.s_premium;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetActiveTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.active);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.did);
        }
        public Field GetCon_perTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.con_per);
        }
        public Field GetRate_planTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.rate_plan);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.ddate);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.mid);
        }
        public Field GetS_premiumTable(){
            return n_oTableSet.Fields(SpecialPremium.Para.s_premium);
        }
