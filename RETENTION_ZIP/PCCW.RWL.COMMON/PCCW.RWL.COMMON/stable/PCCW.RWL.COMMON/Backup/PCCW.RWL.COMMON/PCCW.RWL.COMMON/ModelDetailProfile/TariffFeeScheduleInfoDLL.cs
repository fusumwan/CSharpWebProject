...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class TariffFeeScheduleInfoDLL{
        ...
        public TariffFeeScheduleInfoDLL(){
            Init();
        }
        ~TariffFeeScheduleInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static TariffFeeScheduleInfo CreateInfoInstanceObject()
        {
            return new TariffFeeScheduleInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = TariffFeeSchedule.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = TariffFeeSchedule.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = TariffFeeSchedule.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cid] Field
            _sStrFldName = TariffFeeSchedule.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = TariffFeeSchedule.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [program] Field
            _sStrFldName = TariffFeeSchedule.Para.program;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = TariffFeeSchedule.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [org_fee] Field
            _sStrFldName = TariffFeeSchedule.Para.org_fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = TariffFeeSchedule.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fee] Field
            _sStrFldName = TariffFeeSchedule.Para.fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.cid);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.active);
        }
        public Field GetProgramTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.program);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.ddate);
        }
        public Field GetOrg_feeTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.org_fee);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.did);
        }
        public Field GetFeeTable(){
            return n_oTableSet.Fields(TariffFeeSchedule.Para.fee);
        }
