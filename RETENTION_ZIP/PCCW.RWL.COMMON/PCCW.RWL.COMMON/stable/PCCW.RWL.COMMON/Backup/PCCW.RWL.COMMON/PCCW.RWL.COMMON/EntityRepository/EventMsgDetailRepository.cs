...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class EventMsgDetailRepository : EventMsgDetailRepositoryBase
    {
        public EventMsgDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~EventMsgDetailRepository()
        {
        }
    }
}
