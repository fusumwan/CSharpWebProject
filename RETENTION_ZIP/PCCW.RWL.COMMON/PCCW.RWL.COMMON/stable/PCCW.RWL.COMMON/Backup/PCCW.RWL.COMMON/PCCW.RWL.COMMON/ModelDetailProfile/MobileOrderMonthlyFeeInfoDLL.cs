...
///-- Description:	<Description,Table :[MobileOrderMonthlyFee], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileOrderMonthlyFee] Information layer
    /// </summary>
    public abstract class MobileOrderMonthlyFeeInfoDLL{
        ...
        public MobileOrderMonthlyFeeInfoDLL(){
            Init();
        }
        ~MobileOrderMonthlyFeeInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static MobileOrderMonthlyFeeInfo CreateInfoInstanceObject()
        {
            return new MobileOrderMonthlyFeeInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderMonthlyFee.Para.TableName();
            ...
            // [mid] Field
            _sStrFldName = MobileOrderMonthlyFee.Para.mid;
            ...
            // [mon] Field
            _sStrFldName = MobileOrderMonthlyFee.Para.mon;
            n_oTableSet.Add(_sStrFldName);
            ...
            n_oTableSet.Fields(_sStrFldName).FieldName = "[mon]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "System.Nullable<int>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "mon";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[mon]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "mon";
            n_oTableSet.Fields(_sStrFldName).AliasName = "mon";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "mon";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            ...
            // [fee] Field
            _sStrFldName = MobileOrderMonthlyFee.Para.fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = MobileOrderMonthlyFee.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [free_mon] Field
            _sStrFldName = MobileOrderMonthlyFee.Para.free_mon;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetMidTable(){
            return n_oTableSet.Fields(MobileOrderMonthlyFee.Para.mid);
        }
        public Field GetMonTable(){
            return n_oTableSet.Fields(MobileOrderMonthlyFee.Para.mon);
        }
        public Field GetFeeTable(){
            return n_oTableSet.Fields(MobileOrderMonthlyFee.Para.fee);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderMonthlyFee.Para.active);
        }
        public Field GetFree_monTable(){
            return n_oTableSet.Fields(MobileOrderMonthlyFee.Para.free_mon);
        }
