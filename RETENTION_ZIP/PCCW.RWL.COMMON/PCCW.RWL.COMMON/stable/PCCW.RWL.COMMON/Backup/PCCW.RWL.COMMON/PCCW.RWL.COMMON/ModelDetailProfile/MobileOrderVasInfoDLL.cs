...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class MobileOrderVasInfoDLL{
        ...
        public static MobileOrderVasInfo CreateInfoInstanceObject(){
            return new MobileOrderVasInfo();
        }
        #endregion
        #region Constructor
        
        public MobileOrderVasInfoDLL(){
            Init();
        }
        ~MobileOrderVasInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileOrderVas.Para.TableName();
            ...
            // [id] Field
            _sStrFldName = MobileOrderVas.Para.id;
            ...
            // [cdate] Field
            _sStrFldName = MobileOrderVas.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [active] Field
            _sStrFldName = MobileOrderVas.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas_field] Field
            _sStrFldName = MobileOrderVas.Para.vas_field;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas_id] Field
            _sStrFldName = MobileOrderVas.Para.vas_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [order_id] Field
            _sStrFldName = MobileOrderVas.Para.order_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [fee] Field
            _sStrFldName = MobileOrderVas.Para.fee;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas_value] Field
            _sStrFldName = MobileOrderVas.Para.vas_value;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [multi_id] Field
            _sStrFldName = MobileOrderVas.Para.multi_id;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetIdTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.id);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.cdate);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.active);
        }
        public Field GetVas_fieldTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.vas_field);
        }
        public Field GetVas_idTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.vas_id);
        }
        public Field GetOrder_idTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.order_id);
        }
        public Field GetFeeTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.fee);
        }
        public Field GetVas_valueTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.vas_value);
        }
        public Field GetMulti_idTable(){
            return n_oTableSet.Fields(MobileOrderVas.Para.multi_id);
        }
