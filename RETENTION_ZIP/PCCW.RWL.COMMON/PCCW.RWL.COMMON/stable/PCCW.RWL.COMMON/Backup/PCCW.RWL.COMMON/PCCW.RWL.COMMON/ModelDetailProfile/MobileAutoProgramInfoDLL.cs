...
///-- Description:	<Description,Table :[MobileAutoProgram], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [MobileAutoProgram] Information layer
    /// </summary>
    public abstract class MobileAutoProgramInfoDLL{
        ...
        public static MobileAutoProgramInfo CreateInfoInstanceObject(){
            return new MobileAutoProgramInfo();
        }
        #endregion
        #region Constructor
        
        public MobileAutoProgramInfoDLL(){
            Init();
        }
        ~MobileAutoProgramInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = MobileAutoProgram.Para.TableName();
            ...
            // [rdate] Field
            _sStrFldName = MobileAutoProgram.Para.rdate;
            ...
            n_oTableSet.Fields(_sStrFldName).FieldName = "[rdate]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<DateTime>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "rdate";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[rdate]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "rdate";
            n_oTableSet.Fields(_sStrFldName).AliasName = "rdate";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "rdate";
            ...
            // [auto_name] Field
            _sStrFldName = MobileAutoProgram.Para.auto_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[auto_name]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "auto_name";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[auto_name]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "auto_name";
            n_oTableSet.Fields(_sStrFldName).AliasName = "auto_name";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "auto_name";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [id] Field
            _sStrFldName = MobileAutoProgram.Para.id;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [guid] Field
            _sStrFldName = MobileAutoProgram.Para.guid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[guid]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "global::System.Nullable<Guid>";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "guid";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[guid]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "guid";
            n_oTableSet.Fields(_sStrFldName).AliasName = "guid";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "guid";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [active] Field
            _sStrFldName = MobileAutoProgram.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetRdateTable(){
            return n_oTableSet.Fields(MobileAutoProgram.Para.rdate);
        }
        public Field GetAuto_nameTable(){
            return n_oTableSet.Fields(MobileAutoProgram.Para.auto_name);
        }
        public Field GetIdTable(){
            return n_oTableSet.Fields(MobileAutoProgram.Para.id);
        }
        public Field GetGuidTable(){
            return n_oTableSet.Fields(MobileAutoProgram.Para.guid);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(MobileAutoProgram.Para.active);
        }
