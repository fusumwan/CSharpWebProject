...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class ProfileTeamRecordHistoryRepository : ProfileTeamRecordHistoryRepositoryBase
    {
        public ProfileTeamRecordHistoryRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~ProfileTeamRecordHistoryRepository()
        {
        }
    }
}
