...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class HandSetOfferBasketHistoryRepository : HandSetOfferBasketHistoryRepositoryBase
    {
        public HandSetOfferBasketHistoryRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~HandSetOfferBasketHistoryRepository()
        {
        }
    }
}
