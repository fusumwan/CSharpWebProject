...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class ProfileTeamDetailInfoDLL{
        ...
        public ProfileTeamDetailInfoDLL(){
            Init();
        }
        ~ProfileTeamDetailInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static ProfileTeamDetailInfo CreateInfoInstanceObject()
        {
            return new ProfileTeamDetailInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = ProfileTeamDetail.Para.TableName();
            ...
            // [mid] Field
            _sStrFldName = ProfileTeamDetail.Para.mid;
            ...
            // [teamcode] Field
            _sStrFldName = ProfileTeamDetail.Para.teamcode;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [active] Field
            _sStrFldName = ProfileTeamDetail.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [salesmancode] Field
            _sStrFldName = ProfileTeamDetail.Para.salesmancode;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [staff_no] Field
            _sStrFldName = ProfileTeamDetail.Para.staff_no;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetMidTable(){
            return n_oTableSet.Fields(ProfileTeamDetail.Para.mid);
        }
        public Field GetTeamcodeTable(){
            return n_oTableSet.Fields(ProfileTeamDetail.Para.teamcode);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(ProfileTeamDetail.Para.active);
        }
        public Field GetSalesmancodeTable(){
            return n_oTableSet.Fields(ProfileTeamDetail.Para.salesmancode);
        }
        public Field GetStaff_noTable(){
            return n_oTableSet.Fields(ProfileTeamDetail.Para.staff_no);
        }
