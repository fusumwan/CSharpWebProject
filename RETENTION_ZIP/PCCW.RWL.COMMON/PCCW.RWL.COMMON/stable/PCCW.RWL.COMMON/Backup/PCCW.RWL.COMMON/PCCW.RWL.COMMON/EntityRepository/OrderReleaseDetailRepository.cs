...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class OrderReleaseDetailRepository : OrderReleaseDetailRepositoryBase
    {
        public OrderReleaseDetailRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~OrderReleaseDetailRepository()
        {
        }
    }
}
