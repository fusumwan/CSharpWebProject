...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public abstract class BusinessVasDefaultSetInfoDLL{
        ...
        public static BusinessVasDefaultSetInfo CreateInfoInstanceObject(){
            return new BusinessVasDefaultSetInfo();
        }
        #endregion
        #region Constructor
        
        public BusinessVasDefaultSetInfoDLL(){
            Init();
        }
        ~BusinessVasDefaultSetInfoDLL(){
            this.Release();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = BusinessVasDefaultSet.Para.TableName();
            ...
            // [display2] Field
            _sStrFldName = BusinessVasDefaultSet.Para.display2;
            ...
            // [mid] Field
            _sStrFldName = BusinessVasDefaultSet.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [cdate] Field
            _sStrFldName = BusinessVasDefaultSet.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [bundle_name] Field
            _sStrFldName = BusinessVasDefaultSet.Para.bundle_name;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [value2] Field
            _sStrFldName = BusinessVasDefaultSet.Para.value2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[value2]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "value2";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[value2]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "value2";
            n_oTableSet.Fields(_sStrFldName).AliasName = "value2";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "value2";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [cid] Field
            _sStrFldName = BusinessVasDefaultSet.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [value1] Field
            _sStrFldName = BusinessVasDefaultSet.Para.value1;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[value1]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "value1";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[value1]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "value1";
            n_oTableSet.Fields(_sStrFldName).AliasName = "value1";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "value1";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [program] Field
            _sStrFldName = BusinessVasDefaultSet.Para.program;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = BusinessVasDefaultSet.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [active] Field
            _sStrFldName = BusinessVasDefaultSet.Para.active;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [trade_field] Field
            _sStrFldName = BusinessVasDefaultSet.Para.trade_field;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [con_per] Field
            _sStrFldName = BusinessVasDefaultSet.Para.con_per;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [display1] Field
            _sStrFldName = BusinessVasDefaultSet.Para.display1;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [enabled2] Field
            _sStrFldName = BusinessVasDefaultSet.Para.enabled2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas2] Field
            _sStrFldName = BusinessVasDefaultSet.Para.vas2;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[vas2]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "vas2";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[vas2]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "vas2";
            n_oTableSet.Fields(_sStrFldName).AliasName = "vas2";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "vas2";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [rate_plan] Field
            _sStrFldName = BusinessVasDefaultSet.Para.rate_plan;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [enabled1] Field
            _sStrFldName = BusinessVasDefaultSet.Para.enabled1;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hs_model] Field
            _sStrFldName = BusinessVasDefaultSet.Para.hs_model;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [vas1] Field
            _sStrFldName = BusinessVasDefaultSet.Para.vas1;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            n_oTableSet.Fields(_sStrFldName).IsUniqueKey = false;
            n_oTableSet.Fields(_sStrFldName).FieldName = "[vas1]";
            n_oTableSet.Fields(_sStrFldName).FieldType = "string";
            n_oTableSet.Fields(_sStrFldName).FieldVar = "vas1";
            n_oTableSet.Fields(_sStrFldName).FieldUploadPath = "";
            n_oTableSet.Fields(_sStrFldName).SortName = "[vas1]";
            n_oTableSet.Fields(_sStrFldName).SortParm = "vas1";
            n_oTableSet.Fields(_sStrFldName).AliasName = "vas1";
            n_oTableSet.Fields(_sStrFldName).ParameterName = "vas1";
            n_oTableSet.Fields(_sStrFldName).QuoteStart = "";
            n_oTableSet.Fields(_sStrFldName).QuoteEnd = "";
            n_oTableSet.Fields(_sStrFldName).IsList = true;
            n_oTableSet.Fields(_sStrFldName).IsView = true;
            ...
            // [issue_type] Field
            _sStrFldName = BusinessVasDefaultSet.Para.issue_type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetDisplay2Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.display2);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.mid);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.cdate);
        }
        public Field GetBundle_nameTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.bundle_name);
        }
        public Field GetValue2Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.value2);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.cid);
        }
        public Field GetValue1Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.value1);
        }
        public Field GetProgramTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.program);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.edate);
        }
        public Field GetActiveTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.active);
        }
        public Field GetTrade_fieldTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.trade_field);
        }
        public Field GetCon_perTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.con_per);
        }
        public Field GetDisplay1Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.display1);
        }
        public Field GetEnabled2Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.enabled2);
        }
        public Field GetVas2Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.vas2);
        }
        public Field GetRate_planTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.rate_plan);
        }
        public Field GetEnabled1Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.enabled1);
        }
        public Field GetHs_modelTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.hs_model);
        }
        public Field GetVas1Table(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.vas1);
        }
        public Field GetIssue_typeTable(){
            return n_oTableSet.Fields(BusinessVasDefaultSet.Para.issue_type);
        }
