...
///-- Description:	<Description,Table :[ProductItemCode], Information layer>
///-- =============================================
namespace PCCW.RWL.CORE{
    
    /// <summary>
    /// Summary description for table [ProductItemCode] Information layer
    /// </summary>
    public abstract class ProductItemCodeInfoDLL{
        ...
        public ProductItemCodeInfoDLL(){
            Init();
        }
        ~ProductItemCodeInfoDLL(){
            this.Release();
        }
        #endregion

        #region Create Instance Object
        public static ProductItemCodeInfo CreateInfoInstanceObject()
        {
            return new ProductItemCodeInfo();
        }
        #endregion
        ...
        public void Init()
        {
            ...
            string _sStrFldName;
            n_oTableSet.TableName = ProductItemCode.Para.TableName();
            ...
            // [active] Field
            _sStrFldName = ProductItemCode.Para.active;
            ...
            // [cdate] Field
            _sStrFldName = ProductItemCode.Para.cdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [cid] Field
            _sStrFldName = ProductItemCode.Para.cid;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [did] Field
            _sStrFldName = ProductItemCode.Para.did;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [type] Field
            _sStrFldName = ProductItemCode.Para.type;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [hs_model] Field
            _sStrFldName = ProductItemCode.Para.hs_model;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [last_stock] Field
            _sStrFldName = ProductItemCode.Para.last_stock;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [item_code] Field
            _sStrFldName = ProductItemCode.Para.item_code;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [edate] Field
            _sStrFldName = ProductItemCode.Para.edate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [ddate] Field
            _sStrFldName = ProductItemCode.Para.ddate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [mid] Field
            _sStrFldName = ProductItemCode.Para.mid;
            n_oTableSet.Add(_sStrFldName);
            ...
            // [sdate] Field
            _sStrFldName = ProductItemCode.Para.sdate;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
            ...
            // [quota] Field
            _sStrFldName = ProductItemCode.Para.quota;
            n_oTableSet.Add(_sStrFldName);
            n_oTableSet.Fields(_sStrFldName).IsAutoIncrement = false;
            n_oTableSet.Fields(_sStrFldName).IsIdentityKey = false;
            n_oTableSet.Fields(_sStrFldName).IsPrimaryKey = false;
        ...
        public Field GetActiveTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.active);
        }
        public Field GetCdateTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.cdate);
        }
        public Field GetCidTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.cid);
        }
        public Field GetDidTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.did);
        }
        public Field GetTypeTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.type);
        }
        public Field GetHs_modelTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.hs_model);
        }
        public Field GetLast_stockTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.last_stock);
        }
        public Field GetItem_codeTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.item_code);
        }
        public Field GetEdateTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.edate);
        }
        public Field GetDdateTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.ddate);
        }
        public Field GetMidTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.mid);
        }
        public Field GetSdateTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.sdate);
        }
        public Field GetQuotaTable(){
            return n_oTableSet.Fields(ProductItemCode.Para.quota);
        }
