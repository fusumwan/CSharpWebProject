...
namespace PCCW.RWL.CORE{
    ...
    /// </summary>
    public class OfferAutomationRepository : OfferAutomationRepositoryBase
    {
        public OfferAutomationRepository(MSSQLConnect x_oDB) : base(x_oDB)
        {
            //
            // TODO: Add constructor logic here
            //
        }
        ~OfferAutomationRepository()
        {
        }
    }
}
